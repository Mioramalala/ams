...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_pb14').click(function(){
if((document.getElementById("commentaire_Question_pb14").value=="") || (document.getElementById("rad_Question_Oui_pb_14").checked==false && document.getElementById("rad_Question_NA_pb_14").checked==false && document.getElementById("rad_Question_Non_pb_14").checked==false)){
			$('#mess_quest_vide_pb14').show();
			$('#Question_pb_194').hide();
			$('#message_fermeture_question_pb14').hide();
		}
		else{
	...
	$('#valider_Fermeture_Question_pb14').click(function(){
		$('#message_fermeture_question_pb14').hide();
		$('#fancybox_pb').hide();
		openButtObjpb();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_pb14" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_pb14" />
		</td>
	</tr>
</table>
</div>