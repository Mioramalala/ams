...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_pc24').click(function(){	
	if((document.getElementById("commentaire_Question_pc24").value=="") || (document.getElementById("rad_Question_Oui_pc_24").checked==false && document.getElementById("rad_Question_NA_pc_24").checked==false && document.getElementById("rad_Question_Non_pc_24").checked==false)){
			$('#mess_quest_vide_pc24').show();
			$('#message_fermeture_question_pc24').hide();
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:219},
							success:function(){
								$.ajax({
									type:'POST',
	...
	$('#valider_Fermeture_Question_pc24').click(function(){
		$('#message_fermeture_question_pc24').hide();
		$('#fancybox_pc').hide();
		openButtObjpc();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_pc24" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_pc24" />
		</td>
	</tr>
</table>
</div>