...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_pb11').click(function(){
if((document.getElementById("commentaire_Question_pb11").value=="") || (document.getElementById("rad_Question_Oui_pb_11").checked==false && document.getElementById("rad_Question_NA_pb_11").checked==false && document.getElementById("rad_Question_Non_pb_11").checked==false)){
			$('#mess_quest_vide_pb11').show();
			$('#Question_pb_191').hide();
			$('#message_fermeture_question_pb11').hide();
		}
		else{
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:191},
							success:function(){
								$.ajax({
									type:'POST',
	...
	$('#valider_Fermeture_Question_pb11').click(function(){
		$('#message_fermeture_question_pb11').hide();
		$('#fancybox_pb').hide();
		openButtObjpb();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_pb11" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_pb11" />
		</td>
	</tr>
</table>
</div>