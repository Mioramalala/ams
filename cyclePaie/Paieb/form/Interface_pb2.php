...
$(function(){
	...
	$('#Int_pb_Continuer').click(function(){
		...
		$.ajax({
			type:'POST',
			url:'cyclePaie/Paieb/php/aff_quest_fin_b.php',
	...
	$('#Int_pb_Synthese').click(function(){	
		...
		$.ajax({
			type:'POST',
			url:'cyclePaie/Paieb/php/cpt_b.php',
			data:{mission_id:mission_id},
			success:function(e){
				if(e==15){
					$.ajax({
...
<div id="int_pb"><label class="lb_veuillez" id="lb_veuillez_aff_pb"><br />Veuillez répondre aux questions suivantes par OUI, N/A ou NON</label><br />
	...
	<div id="Int_Droite_pb">
		...
		<input type="button" class="bouton" value="Synthese" id="Int_pb_Synthese" /><br />
		<span class="label">
...
<?php include 'cyclePaie/Paieb/form/Interface_f_Synthese.php';?></div>
<!--*******************************************************************************************************-->
...
<div id="mess_quest_vide_pb1"><?php include 'cyclePaie/Paieb/sms/new 12.php'; ?></div>
<!--*******************************************************************************************************-->
