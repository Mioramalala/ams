...
$(function(){
	...
	$('#valider_msg_Annuler_question_pc').click(function(){
		$('#message_Terminer_question_pc').hide();
		$('#Question_pc_'+StPCID).fadeIn(500);
	});
	$('#valider_msg_Terminer_question_pc').click(function(){
		$('#message_Slide_terminer_Question_pc').show();
		$('#message_Terminer_question_pc').hide();
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Annuler" id="valider_msg_Annuler_question_pc">&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Terminer" id="valider_msg_Terminer_question_pc">
		</td>
	</tr>
</table>
</div>