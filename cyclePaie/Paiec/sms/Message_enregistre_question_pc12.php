...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_pc12').click(function(){	
	if((document.getElementById("commentaire_Question_pc12").value=="") || (document.getElementById("rad_Question_Oui_pc_12").checked==false && document.getElementById("rad_Question_NA_pc_12").checked==false && document.getElementById("rad_Question_Non_pc_12").checked==false)){
			$('#mess_quest_vide_pc12').show();
			$('#Question_pc_207').hide();
			$('#message_fermeture_question_pc12').hide();
		}
		else{
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:207},
							success:function(){
								$.ajax({
									type:'POST',
	...
	$('#valider_Fermeture_Question_pc12').click(function(){
		$('#message_fermeture_question_pc12').hide();
		$('#fancybox_pc').hide();
		openButtObjpc();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_pc12" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_pc12" />
		</td>
	</tr>
</table>
</div>