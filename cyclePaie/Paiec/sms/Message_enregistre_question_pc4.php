...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_pc4').click(function(){	
	if((document.getElementById("commentaire_Question_pc4").value=="") || (document.getElementById("rad_Question_Oui_pc_4").checked==false && document.getElementById("rad_Question_NA_pc_4").checked==false && document.getElementById("rad_Question_Non_pc_4").checked==false)){
			$('#mess_quest_vide_pc4').show();
			$('#message_fermeture_question_pc4').hide();
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:199},
							success:function(){
								$.ajax({
									type:'POST',
	...
	$('#valider_Fermeture_Question_pc4').click(function(){
		$('#message_fermeture_question_pc4').hide();
		$('#fancybox_pc').hide();
		openButtObjpc();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_pc4" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_pc4" />
		</td>
	</tr>
</table>
</div>