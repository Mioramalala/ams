...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_pc25').click(function(){	
	if((document.getElementById("commentaire_Question_pc25").value=="") || (document.getElementById("rad_Question_Oui_pc_25").checked==false && document.getElementById("rad_Question_NA_pc_25").checked==false && document.getElementById("rad_Question_Non_f_25").checked==false)){
			$('#mess_quest_vide_pc25').show();
			$('#message_fermeture_question_pc25').hide();
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:220},
							success:function(){
								$.ajax({
									type:'POST',
	...
	$('#valider_Fermeture_Question_pc25').click(function(){
		$('#message_fermeture_question_pc25').hide();
		$('#fancybox_pc').hide();
		openButtObjpc();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_pc25" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_pc25" />
		</td>
	</tr>
</table>
</div>