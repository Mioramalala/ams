...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_pc26').click(function(){	
	if((document.getElementById("commentaire_Question_pc26").value=="") || (document.getElementById("rad_Question_Oui_pc_26").checked==false && document.getElementById("rad_Question_NA_pc_26").checked==false && document.getElementById("rad_Question_Non_pc_26").checked==false)){
			$('#mess_quest_vide_pc26').show();
			$('#Question_pc_221').hide();
			$('#message_fermeture_question_pc26').hide();
		}
		else{
	...
	$('#valider_Fermeture_Question_pc26').click(function(){
		$('#message_fermeture_question_pc26').hide();
		$('#fancybox_pc').hide();
		openButtObjpc();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_pc26" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_pc26" />
		</td>
	</tr>
</table>
</div>