...
$reponse = $bdd->query('SELECT POSTE_CYCLE_ID FROM tab_poste_cle INNER JOIN tab_poste_cycle ON tab_poste_cle.POSTE_CLE_ID=tab_poste_cycle.POSTE_CLE_ID');
...
?>	
		<td class="titre" width="100" align="center">
			<select id="risque_A_sup<?php echo $cpt; ?>" >
				...
				<option value="eleve" <?php if($donnees1['NIVEAU_RISQUE_NOM']=="eleve") echo 'selected'; ?> disabled >Eleve</option>
			</select>
		</td>
<?php
$cpt++;
