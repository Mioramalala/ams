...
?>
<!--*******************************************************************************************-->
<input type="text" value="<?php echo $mission_id;?>" id="tx_miss_ra" style="display:none;"/>
<div id="fond_Superviseur_Affiche">
<table width="100%">
	<tr>
		<td class="titre" id="image_bleu" align="center"><label id="image_Bleu_A"> A. S’assurer que les séparations de fonctions sont suffisantes.</label></td>
	</tr>
</table>
</div>
<!--**************************************Affichage de A.************************************************-->
<!--div id="interface_A_Sup"><?php //include 'cycleAchat/cycle_achat_interface/Interface_A_Superviseur_Affichage.php'; ?></div-->
<div id="interface_ra_Sup"><?php include 'Interface_ra_Superviseur_Affichage.php'; ?></div>
<!--*****************************************************************************************************-->
</body>
</html>