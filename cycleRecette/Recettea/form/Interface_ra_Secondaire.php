...
<body>
<div id="fond_Sous_Titre" class="menu_Titre"><label class="marge_Titre">Evaluation du contrôle des recettes
</label><input type="text" id="txt_mission_id_int_ra" value="<?php echo $mission_id; ?>" style="margin-left:300;width:20px;margin-top:7px;text-align:center;display:none;" readonly /><label class="margin_Code">Code : FC2 </label>
</div>
...
<!--**************************************Affichage de A.************************************************-->
<div id="interface_ra" align="center"><?php include 'Interface_ra.php'; ?></div>
<!--*****************************************************************************************************-->
</div>
</body>
</html>