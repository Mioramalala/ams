...
$(function(){
	...
	$('#Int_rb_Continuer').click(function(){
		...
		$.ajax({
			type:'POST',
			url:'cycleRecette/Recetteb/php/aff_quest_fin_b.php',
	...
	$('#Int_rb_Synthese').click(function(){	
		...
		$.ajax({
			type:'POST',
			url:'cycleRecette/Recetteb/php/cpt_b.php',
			data:{mission_id:mission_id},
			success:function(e){
				if(e==20){
					$.ajax({
...
<div id="int_rb"><label class="lb_veuillez" id="lb_veuillez_aff_rb"><br />Veuillez répondre aux questions suivantes par OUI, N/A ou NON</label><br />
	...
	<div id="Int_Droite_rb">
		...
		<input type="button" class="bouton" value="Synthese" id="Int_rb_Synthese" /><br />
		<span class="label">
...
<div id="dragg_254" >
	<table width="500">
		<tr style="height:10px">
			<td class="td_Titre_Question" align="center">QUESTION N°25/20
				<input type="button" style="width:170px;height:15px;background-color:#ccc" />
				<input type="button" style="width:60px;height:15px;background-color:#efefef" />
			</td>
		</tr>
...
<?php include 'cycleRecette/Recetteb/form/Interface_f_Synthese.php';?></div>
<!--*******************************************************************************************************-->
...
<div id="mess_quest_vide_rb1"><?php include 'cycleRecette/Recetteb/sms/new 12.php'; ?></div>
<!--*******************************************************************************************************-->
