...
if($donnees['OBJECTIF_COMMENTAIRE']!=$commentaire || $donnees['OBJECTIF_QCM']!=$qcm){
	...
	$req='UPDATE tab_objectif SET UTIL_ID="'.$UTIL_ID.'",OBJECTIF_COMMENTAIRE="'.$commentaire.'",OBJECTIF_QCM="'.$qcm.'" WHERE QUESTION_ID='.$question_id.' AND CYCLE_ACHAT_ID=18 AND AND MISSION_ID="'.$mission_id.'"';
