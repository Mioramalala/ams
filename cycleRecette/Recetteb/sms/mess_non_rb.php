...
$(function(){
	...
	$('#valid_non_rb').click(function(){
		$('#mess_vide_recette').hide();
		document.getElementById("validate_ra").disabled=false;
		document.getElementById("validate_rb").disabled=false;
...
<div id="mess_non_vide_rb">
	<table width="500">
		...
		<tr>
			<td align="center">
				<input type="button" value="OK" class="bouton" id="valid_non_rb" />
			</td>
		</tr>
	</table>
</div>