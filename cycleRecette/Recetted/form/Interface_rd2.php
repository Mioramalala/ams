...
$(function(){
	...
	$('#Int_rd_Continuer').click(function(){
		...
		$.ajax({
			type:'POST',
			url:'cycleRecette/Recetted/php/aff_quest_fin_b.php',
	...
	$('#Int_rd_Synthese').click(function(){	
		...
		$.ajax({
			type:'POST',
			url:'cycleRecette/Recetted/php/cpt_b.php',
			data:{mission_id:mission_id},
			success:function(e){
				if(e==9){
					$.ajax({
...
<div id="int_rd"><label class="lb_veuillez" id="lb_veuillez_aff_rd"><br />Veuillez répondre aux questions suivantes par OUI, N/A ou NON</label><br />
	...
	<div id="Int_Droite_rd">
		...
		<input type="button" class="bouton" value="Synthese" id="Int_rd_Synthese" /><br />
		<span class="label">
...
<?php include 'cycleRecette/Recetted/form/Interface_f_Synthese.php';?></div>
<!--*******************************************************************************************************-->
...
<div id="mess_quest_vide_rd1"><?php include 'cycleRecette/Recetted/sms/new 12.php'; ?></div>
<!--*******************************************************************************************************-->
