...
$(document).ready(function() {
	...
	$('#Int_Synthese_rd').draggable();
	$('#Question_rd_264').draggable();
	$('#Question_rd_265').draggable();
	$('#Question_rd_266').draggable();
	$('#Question_rd_267').draggable();
	$('#Question_rd_268').draggable();
	$('#Question_rd_269').draggable();
	$('#Question_rd_270').draggable();
	$('#Question_rd_271').draggable();
	$('#Question_rd_189').draggable();
	$('#Question_rd_190').draggable();
	$('#Question_rd_191').draggable();
	$('#Question_rd_192').draggable();
	$('#Question_rd_193').draggable();
	$('#Question_rd_194').draggable();
	$('#Question_rd_272').draggable();
	// $('#int_conclusion_c_superviseur').draggable();
});
function openButtObjrd(){
...
<!--**************************************Affichage de A.************************************************-->
<div id="interface_rd" align="center"><?php include 'Interface_rd.php'; ?></div>
<!--*****************************************************************************************************-->
</body>
</html>