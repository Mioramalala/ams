...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_imd11').click(function(){	
	if((document.getElementById("commentaire_Question_imd11").value=="") || (document.getElementById("rad_Question_Oui_imd_11").checked==false && document.getElementById("rad_Question_NA_imd_11").checked==false && document.getElementById("rad_Question_Non_imd_11").checked==false)){
			...
			$('#message_fermeture_question_imd11').hide();
		}
		else{
	...
	$('#valider_Fermeture_Question_imd11').click(function(){
		$('#message_fermeture_question_imd11').hide();
		$('#fancybox_imd').hide();
		openButtObjimd();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_imd11" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_imd11" />
		</td>
	</tr>
</table>
</div>