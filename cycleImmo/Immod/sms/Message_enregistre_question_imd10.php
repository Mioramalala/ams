...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_imd10').click(function(){
if((document.getElementById("commentaire_Question_imd10").value=="") || (document.getElementById("rad_Question_Oui_imd_10").checked==false && document.getElementById("rad_Question_NA_imd_10").checked==false && document.getElementById("rad_Question_Non_imd_10").checked==false)){
			...
			$('#Question_imd_').hide();
			$('#message_fermeture_question_imd10').hide();
		}
		else{
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:115},
							success:function(){
								$.ajax({
									type:'POST',
	...
	$('#valider_Fermeture_Question_imd10').click(function(){
		$('#message_fermeture_question_imd10').hide();
		$('#fancybox_imd').hide();
		openButtObjimd();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_imd10" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_imd10" />
		</td>
	</tr>
</table>
</div>