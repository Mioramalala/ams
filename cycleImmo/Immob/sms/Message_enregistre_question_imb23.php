<script>
$(function(){
	//Enregistre du question objectif B23
	$('#enregistrer_Fermeture_Question_imb23').click(function(){
if((document.getElementById("rad_Question_Non_imb_23").checked==true && document.getElementById("commentaire_Question_imb23").value=="") || (document.getElementById("rad_Question_Oui_imb_23").checked==false && document.getElementById("rad_Question_NA_imb_23").checked==false && document.getElementById("rad_Question_Non_imb_23").checked==false)){
			$('#mess_quest_vide_imb23').show();
			$('#Question_imb_92').hide();
			$('#message_fermeture_question_imb23').hide();
		}
		else{
	...
	$('#valider_Fermeture_Question_imb23').click(function(){
		$('#message_fermeture_question_imb23').hide();
		$('#fancybox_imb').hide();
		openButtObjimb();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_imb23" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_imb23" />
		</td>
	</tr>
</table>
</div>