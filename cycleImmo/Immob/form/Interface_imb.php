<?php
	...
	$verif_=$bdd->query("SELECT count(*) as nb FROM tab_conclusion WHERE CYCLE_ACHAT_ID='7' AND MISSION_ID='$mission_id'");
...
<script language="javascript">
	...
	$.ajax({
		...
		success: function (e) {
			...
			// tinay editer:
			//alert('Tinay: Droit cycle' +e);
			$("#Int_imb_Continuer").attr('disabled', result);
			$("#Int_imb_Synthese").attr('disabled', result);
		}
	});
	...
	$(function(){
		...
		$('#Int_imb_Continuer').click(function(){
			//if(cycleObjValide==1) return false;
			mission_id=document.getElementById("txt_mission_id_imb").value;
			$.ajax({
				type:'POST',
				url:'cycleImmo/Immob/php/aff_quest_fin_imb.php',
				...
				success:function(e){
					...
					if(e>92 ){
						...
						//return false;
						$("#Question_imb_92").css("display","inline-block")
					}
					...
					$.ajax({
						type:'POST',
						url:'cycleImmo/Immob/php/getRepContinuer.php',
						data:{mission_id:mission_id, questId:e, cycleId:7},
						success:function(e1){
							eo=""+e1+"";
							doc=eo.split('#');
							cpt=1;
							for(i=70; i<93; i++){ 
								if(i==imb){
									imbId="imb_"+cpt;
									imbIdCom="imb"+cpt;
									afficheReponseQuest(imbId,imbIdCom);
									break;
								}
								cpt++;
							}
		...
		$('#Int_imb_Synthese').click(function() {
			...
			$.ajax({
				...
				success:function(e) {
					eo=""+e+"";
					doc=eo.split('*');
					document.getElementById("rd_Synthese_imb_Faible").checked=false;
					document.getElementById("rd_Synthese_imb_Moyen").checked=false;
					document.getElementById("rd_Synthese_imb_Eleve").checked=false;
	...
	function afficheReponseQuest(imbId,imbIdCom){
...
<div id="int_imb"><label class="lb_veuillez" id="lb_veuillez_aff_imb"><br />Veuillez répondre aux questions suivantes par OUI, N/A ou NON</label><br />
	...
	<div id="Int_Droite_imb">
		...
		<input type="button" class="bouton" value="Synthèse" id="Int_imb_Synthese" /><br />
		<span class="label">
...
<?php include 'cycleImmo/Immob/form/Interface_imb_Synthese.php';?></div>
<!--*******************************************************************************************************-->
...
<div id="mess_quest_vide_imb1"><?php include 'cycleImmo/Immob/sms/Message_question_vide.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_imb2"><?php include 'cycleImmo/Immob/sms/sms_empty/Mess_quest_vide_imb2.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_imb3"><?php include 'cycleImmo/Immob/sms/sms_empty/Mess_quest_vide_imb3.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_imb4"><?php include 'cycleImmo/Immob/sms/sms_empty/Mess_quest_vide_imb4.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_imb5"><?php include 'cycleImmo/Immob/sms/sms_empty/Mess_quest_vide_imb5.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_imb6"><?php include 'cycleImmo/Immob/sms/sms_empty/Mess_quest_vide_imb6.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_imb7"><?php include 'cycleImmo/Immob/sms/sms_empty/Mess_quest_vide_imb7.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_imb8"><?php include 'cycleImmo/Immob/sms/sms_empty/Mess_quest_vide_imb8.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_imb9"><?php include 'cycleImmo/Immob/sms/sms_empty/Mess_quest_vide_imb9.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_imb10"><?php include 'cycleImmo/Immob/sms/sms_empty/Mess_quest_vide_imb10.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_imb11"><?php include 'cycleImmo/Immob/sms/sms_empty/Mess_quest_vide_imb11.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_imb12"><?php include 'cycleImmo/Immob/sms/sms_empty/Mess_quest_vide_imb12.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_imb13"><?php include 'cycleImmo/Immob/sms/sms_empty/Mess_quest_vide_imb13.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_imb14"><?php include 'cycleImmo/Immob/sms/sms_empty/Mess_quest_vide_imb14.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_imb15"><?php include 'cycleImmo/Immob/sms/sms_empty/Mess_quest_vide_imb15.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_imb16"><?php include 'cycleImmo/Immob/sms/sms_empty/Mess_quest_vide_imb16.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_imb17"><?php include 'cycleImmo/Immob/sms/sms_empty/Mess_quest_vide_imb17.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_imb18"><?php include 'cycleImmo/Immob/sms/sms_empty/Mess_quest_vide_imb18.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_imb19"><?php include 'cycleImmo/Immob/sms/sms_empty/Mess_quest_vide_imb19.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_imb20"><?php include 'cycleImmo/Immob/sms/sms_empty/Mess_quest_vide_imb20.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_imb21"><?php include 'cycleImmo/Immob/sms/sms_empty/Mess_quest_vide_imb21.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_imb22"><?php include 'cycleImmo/Immob/sms/sms_empty/Mess_quest_vide_imb22.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_imb23"><?php include 'cycleImmo/Immob/sms/sms_empty/Mess_quest_vide_imb23.php'; ?></div>
<!--*******************************************************************************************************-->

<!--*************************************Message vide resultat b*******************************************-->
<div id="mess_vide_obj_f" style="display:none;"><?php include 'cycleImmo/Immob/sms/mess_vid_aud_imb.php'; ?></div>
<!--*******************************************************************************************************-->
