...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_imc11').click(function(){
if((document.getElementById("commentaire_Question_imc11").value=="") || (document.getElementById("rad_Question_Oui_imc_11").checked==false && document.getElementById("rad_Question_NA_imc_11").checked==false && document.getElementById("rad_Question_Non_imc_11").checked==false)){
			...
			$('#message_fermeture_question_imc11').hide();
		}
		else{
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:103},
							success:function(){
								$.ajax({
									type:'POST',
	...
	$('#valider_Fermeture_Question_imc11').click(function(){
		$('#message_fermeture_question_imc11').hide();
		$('#fancybox_imc').hide();
		openButtObjimc();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_imc11" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_imc11" />
		</td>
	</tr>
</table>
</div>