...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_imc13').click(function(){	
	if((document.getElementById("commentaire_Question_imc13").value=="") || (document.getElementById("rad_Question_Oui_imc_13").checked==false && document.getElementById("rad_Question_NA_imc_13").checked==false && document.getElementById("rad_Question_Non_imc_13").checked==false)){
			...
			$('#message_fermeture_question_imc13').hide();
		}
		else{
	...
	$('#valider_Fermeture_Question_imc13').click(function(){
		$('#message_fermeture_question_imc13').hide();
		$('#fancybox_imc').hide();
		openButtObjimc();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_imc13" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_imc13" />
		</td>
	</tr>
</table>
</div>