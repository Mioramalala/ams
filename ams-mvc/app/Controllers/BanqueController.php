...
class BanqueController extends Controller
{
    ...
    {
        return $this->model->getEntreprise($idMission)->ENTREPRISE_DENOMINATION_SOCIAL;
    }

    public function getMissionInfo($idMission)
    {
        $res = $this->model->getMission($idMission);
        return $res->MISSION_TYPE . " " . $res->MISSION_ANNEE;
    }
