...
class CircularisationModel extends Model
{
    ...
    public function getSolde($idBal)
    {
        $sql = "SELECT BAL_AUX_SOLDE FROM tab_bal_aux WHERE BAL_AUX_ID=$idBal";
        print $sql;
        $result = str_replace(',', '', $this->database->query($sql, true)->BAL_AUX_SOLDE);
        return (double)$result;
    }

    public function getEntreprise($idMission)
    {
