...
$reponse1=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="tresorerie" and RDC_OBJECTIF="B" and MISSION_ID='.$mission_id.' and RDC_RANG=1');
...
<script>
	...
	$(function(){
		...
		$('#revue').click(function(){
			...
			$('#contenue_travail').load("RDC/tresorerie/B_regularite/table_E2.php");
		});
		...
		$('#bt_suivant').click(function(){
			...
			if((reponse1=="non" && commentaire1=="") || reponse1==""){ 
				...
				add_Data(reponse1,commentaire1,'tresorerie','B',1,<?php echo $mission_id; ?>);
...
<table width="100%" height="50" bgcolor="#00698d" style="text-align:left;">
	<tr>
		<td class="grand_Titre"><center>C - REGULARITE DES ENREGISTREMENTS PARTIE :I</center></td>
	</tr>
</table>
...
<table width="100%" height="470">
	<tr>
		...
		<div id="contenue_travail" style="overflow:auto;height:450px;">
			...
			<label><strong>.</strong>Balance générale des comptes de trésorerie</label><br/><br/>
			<label><strong>.</strong>Journal de banque d'une période M</label><br/><br/>
			<label><strong>.</strong>Avis d'opération bancaire</label><br/><br/><br/><br/>
		<label><strong>Question 1 :</strong></label><br/>
		<label>Sur la base des avis d'opération sélectionnés, les écritures de banque sont-elles correctement comptabilisées ?</label><br/><br/><br/>			
		<label><strong>Feuille de travail :</strong></label><label id="revue" style="cursor:pointer;color:red;">
		&nbsp;Vérification des écritures de banques</label>	
		</div>
		</td>
		<td width="27.5%">
		<div id="contenue_question" style="overflow;height:450px;">
			...
			?> >
				<label><strong>Question 1 :</strong></label><br />
				<label>Sur la base des avis d'opération sélectionnés, les écritures de banque sont-elles correctement comptabilisées ?</label>
