...
$reponse1=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="tresorerie" and RDC_OBJECTIF="F" and MISSION_ID='.$mission_id.' and RDC_RANG=4');
...
$reponse2=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="tresorerie" and RDC_OBJECTIF="F" and MISSION_ID='.$mission_id.' and RDC_RANG=5');
...
$reponse3=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="tresorerie" and RDC_OBJECTIF="F" and MISSION_ID='.$mission_id.' and RDC_RANG=6');
...
<script>
	...
	$(function(){
		...
		$('#revue').click(function(){
			...
			// $('#contenue_travail').load("RDC/tresorerie/F_information/table_E72.php");
		});
		...
		$('#bt_suivant').click(function(){
			...
			if((reponse1=="non" && commentaire1=="") || (reponse2=="non" && commentaire2=="") || (reponse3=="non" && commentaire3=="") || reponse1=="" || reponse2=="" || reponse3==""){ 
				...
				add_Data(reponse1,commentaire1,'tresorerie','F',4,<?php echo $mission_id; ?>);
				add_Data(reponse2,commentaire2,'tresorerie','F',5,<?php echo $mission_id; ?>);
				add_Data(reponse3,commentaire3,'tresorerie','F',6,<?php echo $mission_id; ?>);
				$("#contenue").load("RDC/tresorerie/index.php");
			}
		});
...
<table width="100%" height="50" bgcolor="#00698d" style="text-align:left;">
	<tr>
		<td class="grand_Titre"><center>I - INFORMATION ET PRESENTATION PARTIE :II</center></td>
	</tr>
</table>
...
<table width="100%" height="470">
	<tr>
		...
		<div id="contenue_travail" style="overflow:auto;height:450px;width:100%;">
			...
			<br/>Vérifier les informations données en annexe.</label><br/><br/><br/>
			<label><strong>Documents et infos à obtenir</strong></label><br/>
			<label><strong></strong>Notes annexes</label><br/><br/><br/>
			<label><strong>Question 1 :</strong></label><br/>
			<label>Avez-vous vérifié les engagements financiers non inscrits au bilan (hypothèque, garanties, nantissements, …) ?</label><br/><br/><br/>	
			<label><strong>Question 2 :</strong></label><br/>
			<label>Les engagements hors bilan sont-ils mentionnés dans les annexes aux états financiers ?</label><br/><br/><br/>
			<label><strong>Question 3 :</strong></label><br/>
			<label>Les différence de change présentant un montant significatif sont-elles données en annexes ?</label><br/><br/><br/>
		...
		<div id="contenue_question" style="overflow;height:450px;">
			...
			?>>
				<label><strong>Question 1 :</strong></label><br />
				<label>Avez-vous vérifié les engagements financiers non inscrits au bilan (hypothèque, garanties, nantissements, …) ?</label>
				...
				<label><strong>Question 2 :</strong></label><br />
				<label>Les engagements hors bilan sont-ils mentionnés dans les annexes aux états financiers ?</label>
				...
				<label><strong>Question 3 :</strong></label><br />
				<label>Les différence de change présentant un montant significatif sont-elles données en annexes ?</label>
