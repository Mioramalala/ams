		...
		<script>
			$(function(){
					...
					$("#rattachement").click(function(){
						$("#contenue").load("RDC/tresorerie/D_rattachement/rattachement1.php");					
					});
					$("#juridique").click(function(){
						$("#contenue").load("RDC/tresorerie/E_juridique/juridique1.php");					
					});
					$("#information").click(function(){
						$("#contenue").load("RDC/tresorerie/F_information/information1.php");					
					});
					...
					$('#bt_feuille_maitresse').click(function(){
						$("#contenue").load("RDC/tresorerie/feuille_maitresse.php");
					});
