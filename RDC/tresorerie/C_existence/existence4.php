...
$reponse1=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="tresorerie" and RDC_OBJECTIF="C" and MISSION_ID='.$mission_id.' and RDC_RANG=14');
...
<script>
	...
	$(function(){
		...
		$('#revue').click(function(){
			...
			// $('#contenue_travail').load("RDC/tresorerie/C_existence/table_E61.php");
		});
		...
		$('#bt_suivant').click(function(){
			...
			if((reponse1=="non" && commentaire1=="") || reponse1==""){ 
				...
				add_Data(reponse1,commentaire1,'tresorerie','C',14,<?php echo $mission_id; ?>);
...
<table width="100%" height="50" bgcolor="#00698d" style="text-align:left;">
	<tr>
		<td class="grand_Titre"><center>E - EXISTENCE DE SOLDE PARTIE :IV</center></td>
	</tr>
</table>
...
<table width="100%" height="470">
	<tr>
		...
		<div id="contenue_travail" style="overflow:auto;height:450px;">
			...
			<label><strong></strong>Grand livre des comptes de virements internes</label><br/><br/><br/>
			<label><strong>Question 1 :</strong></label><br/>
			<label>Avez-vous obtenu le grand livre général des comptes de virements internes ?</label><br/><br/><br/>			
		...
		<div id="contenue_question" style="overflow;height:450px;">
			...
			?>>
				<label><strong>Question 1 :</strong></label><br />
				<label>Avez-vous obtenu le grand livre général des comptes de virements internes ?</label>
