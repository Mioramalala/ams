...
<script>
	...
	$(function(){
		...
		$('#synthese_feuille').click(function(){
			$('#contenue').load("RDC/immofi/synthese_immofi.php");
		});
		$('#coh1').click(function(){
			$('#contenue').load("RDC/immofi/A_coherence/coherence1.php?coherence_visible=OK");
		});
		$('#coh11').click(function(){
			$('#contenue').load("RDC/immofi/A_coherence/coherence1.php?coherence_visible=OK");
		});
		$('#coh2').click(function(){
			$('#contenue').load("RDC/immofi/A_coherence/coherence2.php?coherence_visible=OK");
		});
		$('#reg1').click(function(){
			$('#contenue').load("RDC/immofi/B_regularite/regularite1.php?regularite_visible=OK");
		});
		...
		$('#reg2').click(function(){
			$('#contenue').load("RDC/immofi/B_regularite/regularite2.php?regularite_visible=OK");
		});
		$('#reg22').click(function(){
			$('#contenue').load("RDC/immofi/B_regularite/regularite2.php?regularite_visible=OK");
		});
		$('#reg3').click(function(){
			$('#contenue').load("RDC/immofi/B_regularite/regularite3.php?regularite_visible=OK");
		});
		$('#reg33').click(function(){
			$('#contenue').load("RDC/immofi/B_regularite/regularite3.php?regularite_visible=OK");
		});
		$('#exist1').click(function(){
			$('#contenue').load("RDC/immofi/C_existence/existence1.php?existence_visible=OK");
		});
		$('#eval1').click(function(){
			$('#contenue').load("RDC/immofi/D_evaluation/evaluation1.php?evaluation_visible=OK");
		});
		...
		$('#eval2').click(function(){
			$('#contenue').load("RDC/immofi/D_evaluation/evaluation2.php?evaluation_visible=OK");
		});
		$('#rattach1').click(function(){
			$('#contenue').load("RDC/immofi/E_rattachement/rattachement1.php?rattachement_visible=OK");
		});
		$('#jurid1').click(function(){
			$('#contenue').load("RDC/immofi/F_juridique/juridique1.php?juridique_visible=OK");
		});
		$('#jurid11').click(function(){
			$('#contenue').load("RDC/immofi/F_juridique/juridique1.php?juridique_visible=OK");
		});
		$('#jurid2').click(function(){
			$('#contenue').load("RDC/immofi/F_juridique/juridique2.php?juridique_visible=OK");
		});
		$('#jurid3').click(function(){
			$('#contenue').load("RDC/immofi/F_juridique/juridique3.php?juridique_visible=OK");
		});
		$('#info1').click(function(){
			$('#contenue').load("RDC/immofi/G_information/information1.php?information_visible=OK");
		});
		$('#info11').click(function(){
			$('#contenue').load("RDC/immofi/G_information/information1.php?information_visible=OK");
		});
		$('#info2').click(function(){
			$('#contenue').load("RDC/immofi/G_information/information2.php?information_visible=OK");
		});
		$('#info3').click(function(){
			$('#contenue').load("RDC/immofi/G_information/information3.php?information_visible=OK");
		});
	});
</script>
