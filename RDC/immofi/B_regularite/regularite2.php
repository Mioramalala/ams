...
////////////////////question1///////////////
$reponse1=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="immofi" and RDC_OBJECTIF="B" and MISSION_ID='.$mission_id.' and RDC_RANG=4');
...
////////////////////question2///////////////
$reponse2=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="immofi" and RDC_OBJECTIF="B" and MISSION_ID='.$mission_id.' and RDC_RANG=5');
	...
	$(function(){
		...
		$('#bt_suivant').click(function(){
			...
			if((reponse1=="non" && commentaire1=="") || (reponse2=="non" && commentaire2=="") || reponse1=="" || reponse2==""){ 
				...
				add_Data(reponse1,commentaire1,'immofi','B',4,<?php echo $mission_id; ?>);
				add_Data(reponse2,commentaire2,'immofi','B',5,<?php echo $mission_id; ?>);
				$('#contenue').load("RDC/immofi/B_regularite/regularite3.php");
			}
		});
...
<table width="100%" height="470">
	<tr>
		...
		<div id="contenue_travail" style="height:450px;overflow:auto;width:900px;">
			...
			<br/>Reconstituer et justifier les cessions ou diminutions d’immobilisations financières de l’exercice, et notamment de la valeur comptable des titres cédés.</label><br /><br /><br/>
			
			<label><strong>Documents et infos à obtenir</strong></label><br /><br/>
			<label><strong>.</strong>Factures de cession</label><br /><br/>
			<label><strong>.</strong>GL comptes 26/29/68</label><br /><br /><br/>
			
			<label><strong>Question 1 :</strong></label><br />
				<label>Les cessions d'immobilisations financières sont-elles justifiées et correctement comptabilisées ?</label><br/><br /><br/>
						
			<label><strong>Question 2 :</strong></label><br />
				<label>Les changements survenus quant à la diminution de valeur des immobilisations financières sont-ils justifiés et correctement comptabilisés ?</label><br /><br /><br/>			
		...
		<div id="contenue_question" style="overflow;height:450px;" >
			...
			<div id="contenue_rdc" 
				...
				?> >
				<label><strong>Question 1 :</strong></label><br />
					<label>Les cessions d'immobilisations financières sont-elles justifiées et correctement comptabilisées ?</label>
