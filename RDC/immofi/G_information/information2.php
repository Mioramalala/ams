...
$reponse1=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="immofi" and RDC_OBJECTIF="G" and MISSION_ID='.$mission_id.' and RDC_RANG=3');
	...
	$(function(){
		...
		$('#bt_suivant').click(function(){
			...
			if((reponse1=="non" && commentaire1=="") || reponse1==""){ 
				...
				add_Data(reponse1,commentaire1,'immofi','G',3,<?php echo $mission_id; ?>);
				$('#contenue').load("RDC/immofi/G_information/information3.php");
			}
		});
...
<table width="100%" height="50" bgcolor="#00698d" style="text-align:left;">
	<tr>
		<td><center><label class="grand_Titre">I - INFORMATIONS ET PRESENTATIONS PARTIE :II</label></center></td>
	</tr>
</table>
<table width="100%" height="470">
	<tr>
		...
		<div id="contenue_travail" style="height:450px;overflow:auto;width:900px;">
			...
			<br/>Contrôler la ventilation des immobilisations financières entre court et long terme.</label><br/><br/><br/>
			
			<label><strong>Documents et infos à obtenir</strong></label><br />
				<label>GL des comptes liés aux immobilisations financières.</label><br/><br/><br/>
				
			<label><strong>Question :</strong></label><br />
				<label>Justifiez-vous la ventilation des immobilisations financières entre court et long terme selon leurs caractéristiques ?</label><br/><br/><br/>
			...
			<div id="upload" style="display:none;">
				<div id="uploadJustification">
					...
					<?php 
						$sql = "SELECT nom,extension FROM tab_pieces_justificatives WHERE mission_id=".$_SESSION['idMission']." AND pour = 'immofi_G2'";
						$rep =$bdd->query($sql);
						
						if($donnee = $rep->fetch()) {
					?>
						<a href="<?php echo "pieces_justificatives/pj_immofi_G2_".$_SESSION['idMission'].'.'.$donnee['extension'] ?>" target="_blank"><?php echo $donnee['nom'] ?></a>
					<?php
						}
					?>
					<form enctype="multipart/form-data" action="RDC/envoi_pieces_justificatives.php" method="POST" id="form" target="uploadFrame">
						...
						<input type="hidden" name="pour" value="immofi_G2" />
		...
		<div id="contenue_question" style="overflow;height:450px;">
			...
			>
				<label><strong>Question :</strong></label><br />
				<label>Justifiez-vous la ventilation des immobilisations financières entre court et long terme selon leurs caractéristiques ?</label>
