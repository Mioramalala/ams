...
//include '../../../test_acces.php';
	$reponse1=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="immofi" and RDC_OBJECTIF="G" and MISSION_ID='.$mission_id.' and RDC_RANG=4');
	...
	$(function(){
		...
		$('#bt_suivant').click(function(){
			...
			if((reponse1=="non" && commentaire1=="") || reponse1==""){ 
				...
				add_Data(reponse1,commentaire1,'immofi','G',4,<?php echo $mission_id; ?>);
		...
		<table width="100%" height="470">
			<tr>
				...
				<div id="contenue_travail" style="height:450px;overflow:auto;width:900px;">
					...
					<br/>Informations données en annexes.</label><br/><br/><br/>
					
					<label><strong>Documents et infos à obtenir</strong></label><br />
						<label>Etats financiers et notes annexes.</label><br/><br/><br/>
					...
					<div id="upload" style="display:none;">
						<div id="uploadJustification">
							...
							<?php 
								$sql = "SELECT nom,extension FROM tab_pieces_justificatives WHERE mission_id=".$_SESSION['idMission']." AND pour = 'immofi_G3'";
								$rep =$bdd->query($sql);
								
								if($donnee = $rep->fetch()) {
							?>
								<a href="<?php echo "pieces_justificatives/pj_immofi_G3_".$_SESSION['idMission'].'.'.$donnee['extension'] ?>" target="_blank"><?php echo $donnee['nom'] ?></a>
							<?php
								}
							?>
							<form enctype="multipart/form-data" action="RDC/envoi_pieces_justificatives.php" method="POST" id="form" target="uploadFrame">
								...
								<input type="hidden" name="pour" value="immofi_G3" />
