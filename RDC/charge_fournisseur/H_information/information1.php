...
$reponse1 = $bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="charge_fournisseur" and RDC_OBJECTIF="H" and MISSION_ID=' . $mission_id . ' and RDC_RANG=1');
...
<script>
    ...
    $(function () {
        ...
        $('#revue').click(function () {
            ...
            // $('#contenue_travail').load("RDC/charge_fournisseur/H_information/table_F65.php");
        });
        ...
        $('#bt_suivant').click(function () {
            ...
            if ((reponse1 == "non" && commentaire1 == "") || reponse1 == "") {
                ...
                add_Data(reponse1,commentaire1,'charge_fournisseur','H',1,<?php echo $mission_id; ?>);
...
<table width="100%" height="50" bgcolor="#00698d" style="text-align:left;">
    <tr>
        <td class="grand_Titre">
            <center><label style="font-weight:bold;">H - INFORMATION ET PRESENTATION PARTIE : I</label></center>
        </td>
    </tr>
</table>
        ...
        <tr>
            <td width="72.5%">
                <div id="contenue_travail" style="overflow:auto;height:450px;width:100%;">
                    ...
                    <p style="margin-left:15px;margin-top:5px;">S'assurer de la non compensation des soldes débiteurs et
                        créditeurs.</p>
                    <label><strong>Documents et infos à obtenir</strong></label><br/>
                    <ul>
                        <li>Balance auxiliaire comptes fournisseurs</li>
                        <li>Bilan : détails passif</li>
                    </ul>
                    <label><strong>Question :</strong></label><br/>
                    <p style="margin-left:15px;margin-top:5px;">Les tiers à solde débiteur sont-ils présentés à l'actif
                        courant du bilan et ceux à solde créditeur au passif courant du bilan ?</p>
            ...
            <td width="27.5%">
                ...
                <div id="contenue_question" style="overflow:auto;height:450px;">
                    ...
                    >
                        ...
                        <label>Les tiers à solde débiteur sont-ils présentés à l'actif courant du bilan et ceux à solde
                            créditeur au passif courant du bilan ?</label>
                        ...
                        <textarea id="comment1"><?php echo $commentaire1; ?></textarea>
                    </div>
                </div>
            </td>
        </tr>
