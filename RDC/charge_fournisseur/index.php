		...
		<script>
			$(function(){
					...
					$("#exhaustivite").click(function(){
						$("#contenue").load("RDC/charge_fournisseur/B_exhaustivite/exhaustivite1.php");				
					});	
					...
					$("#rattachement").click(function(){
						$("#contenue").load("RDC/charge_fournisseur/F_rattachement/rattachement1.php");				
					});	
					...
					$('#bt_feuille_maitresse').click(function(){
						$("#contenue").load("RDC/charge_fournisseur/feuille_maitresse.php");
					});
