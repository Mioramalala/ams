...
$reponse1=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="charge_fournisseur" and RDC_OBJECTIF="B" and MISSION_ID='.$mission_id.' and RDC_RANG=1');
...
<script>
	...
	$(function(){
		...
		$('#revue').click(function(){
			...
			$('#upload').show();
			// $('#contenue_travail').load("RDC/charge_fournisseur/B_exhaustivite/table_F52.php");
		});
		...
		$('#bt_suivant').click(function(){
			...
			if((reponse1=="non" && commentaire1=="") || reponse1==""){ 
				...
				add_Data(reponse1,commentaire1,'charge_fournisseur','B',1,<?php echo $mission_id; ?>);
				$("#contenue").load("RDC/charge_fournisseur/index.php");
			}
		});
...
<table width="100%" height="50" bgcolor="#00698d" style="text-align:left;">
	<tr>
		<td class="grand_Titre"><center><label>B - EXHAUSTIVITE DES ENREGISTREMENTS</label></center></td>
	</tr>
</table>
...
<table width="100%" height="470">
	<tr>
		...
		<div id="contenue_travail" style="overflow:auto;height:450px;width:100%;">
			...
			<br /><br />Contrôler l’exhaustivité des enregistrements.</label><br /><br /><br /><br />
			<label><strong>Documents et infos à obtenir</strong></label><br /><br />
			<label><strong>.</strong>Grand livre des comptes de charges</label><br /><br /><br />
			<label><strong>.</strong>Par sondage, sélection de factures/pièces justificatives</label><br /><br /><br /><br />
		<label><strong>Question 1 :</strong></label><br /><br />
		<label>Sur la base de la sélection, confirmez-vous que la comptabilisation des opérations d'achat de biens et services est exhaustive ?</label><br /><br /><br /><br />	
		...
		<div id="contenue_question" style="height:450px;">
			...
			>
				...
				<label>Sur la base de la sélection, confirmez-vous que la comptabilisation des opérations d'achat de biens et services est exhaustive ?</label>
