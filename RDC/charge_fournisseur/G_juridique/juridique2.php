<?php
	...
	$reponse1=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="charge_fournisseur" and RDC_OBJECTIF="G" and MISSION_ID='.$mission_id.' and RDC_RANG=4');
	...
	$(function(){
		...
		$('#bt_suivant').click(function(){
			...
			if((reponse1=="non" && commentaire1=="") || reponse1==""){ 
				...
				add_Data(reponse1,commentaire1,'charge_fournisseur','G',4,<?php echo $mission_id; ?>);
...
<table width="100%" height="470">
	<tr>
		...
		<label><strong>Question :</strong></label>
			<p style="margin-left:15px;margin-top:5px;">Les pièces justificatives des charges comportent-elles les informations exigées par l'Administration fiscale ?</p>		
		...
		<td width="27.5%">
			...
			<div id="contenue_question" style="overflow:auto;height:450px;">
				...
				>
					...
					<label>Les pièces justificatives des charges comportent-elles les informations exigées par l'Administration fiscale ?</label>
