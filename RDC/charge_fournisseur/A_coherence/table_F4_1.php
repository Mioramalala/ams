...
<!--div style="width:99.8%"-->
	...
	<table width="100%" bgcolor="#00698d">
		...
		<?php
			...
			$queryTabImportN0='select IMPORT_COMPTES, IMPORT_SOLDE, IMPORT_INTITULES from tab_importer where IMPORT_ID='.$idAchat[$i].' and IMPORT_CHOIX_ANNEE="N"';
			$queryTabImportN1='select IMPORT_COMPTES, IMPORT_SOLDE from tab_importer where IMPORT_ID='.$idAchat[$i].' and IMPORT_CHOIX_ANNEE="N-1"';
			...
			$donneeN1=$reponseN1->fetch();
                        ...
                        $queryF4N='select N2, N3, N4 from tab_rdc_cf_f4_2 where mission_id='.$mission_id.' and compte="'.$donneeN0['IMPORT_COMPTES'].'" and reference="achat"';
                        $reponseF4N=$bdd->query($queryF4N);
                        $donneesF4N=$reponseF4N->fetch();                        
                        
			?>
				<tr bgcolor="#ccc">
					<td><input type="Text" value="<?php echo $donneeN0['IMPORT_COMPTES']; ?>" id="CPT<?php echo $i; ?>" size="10px" disabled /></td>
                                        <td><input type="Text" value="<?php echo $donneeN0['IMPORT_INTITULES']; ?>" id="LBL<?php echo $i; ?>" size="30px"  disabled/></td>
                                        <td align="center"><input type="Text" value="<?php if($donneeN0['IMPORT_SOLDE']=="") echo '0'; else echo $donneeN0['IMPORT_SOLDE']; ?>" id="CPTN0<?php echo $i; ?>" size="10px" disabled /></td>
					<td align="center"><input type="Text" value="<?php if($donneeN1['IMPORT_SOLDE']=="") echo '0'; else echo $donneeN1['IMPORT_SOLDE']; ?>" id="CPTN1<?php echo $i; ?>" size="10px" disabled/></td>
                                        <td align="center"><input type="Text" id="CPTN2<?php echo $i; ?>" <?php if($idAchat[0]==0) echo 'disabled'; ?> size="10px" value="<?php if($donneesF4N['N2']=="") echo '0'; else echo $donneesF4N['N2']; ?>" /></td>
                                        <td align="center"><input type="Text" id="CPTN3<?php echo $i; ?>" <?php if($idAchat[0]==0) echo 'disabled'; ?> size="10px" value="<?php if($donneesF4N['N3']=="") echo '0'; else echo $donneesF4N['N3']; ?>" ></td>
					<td align="center"><input type="Text" id="CPTN4<?php echo $i; ?>" <?php if($idAchat[0]==0) echo 'disabled'; ?> size="10px" value="<?php if($donneesF4N['N4']=="") echo '0'; else echo $donneesF4N['N4']; ?>" /></td>
				</tr>
			<?php	
                            $achatTotN0=$achatTotN0+$donneeN0['IMPORT_SOLDE'];
                            $achatTotN1=$achatTotN1+$donneeN1['IMPORT_SOLDE'];
                            $achatTotN2=$achatTotN2+$donneesF4N['N2'];
                            $achatTotN3=$achatTotN3+$donneesF4N['N3'];
                            $achatTotN4=$achatTotN4+$donneesF4N['N4'];
			}	
                        $compteAchat=$i;
		?>
                <tr>				
			...
			?>
				<tr bgcolor="#ccc">
					<td><input type="Text" value="<?php echo $donneeN0['IMPORT_COMPTES']; ?>" id="CPTFRAI<?php echo $i; ?>"  size="10px" disabled /></td>
                                        <td><input type="Text" value="<?php echo $donneeN0['IMPORT_INTITULES']; ?>" id="LBLFRAI<?php echo $i; ?>"  size="30px" disabled /></td>
