...
$reponse2=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="charge_fournisseur" and RDC_OBJECTIF="D"
 and MISSION_ID='.$mission_id.' and RDC_RANG=4');
...
and MISSION_ID='.$mission_id.' and RDC_RANG=5');
	...
	$(function(){
		...
		$('#bt_suivant').click(function(){
			...
			if((reponse1=="non" && commentaire1=="") || (reponse2=="non" && commentaire2=="") || reponse1=="" || reponse2==""){ 
				...
				add_Data(reponse2,commentaire2,'charge_fournisseur','D',4,<?php echo $mission_id; ?>);
				add_Data(reponse1,commentaire1,'charge_fournisseur','D',5,<?php echo $mission_id; ?>);
				$("#contenue").load("RDC/charge_fournisseur/index.php");
			}
		});
...
<table width="100%" height="50" bgcolor="#00698d" style="text-align:left;">
	<tr>
		<td class="grand_Titre"><center><label>D- EXISTENCE DES SOLDES</label></center></td>
	</tr>
</table>
...
<table width="100%" height="470">
	<tr>
		...
		<label>Tous les comptes composant chaque poste sont-ils conformes aux soldes de la balance générale ?</label><br /><br /><br /><br />	
		...
		<div id="contenue_question" style="overflow:auto;height:450px;">
			...
			>
				...
				<label>Tous les comptes composant chaque poste sont-ils conformes aux soldes de la balance générale ?</label>
