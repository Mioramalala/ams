		...
		<script type="text/javascript">
			...
			$(function(){
				$('#synthese_feuille').click(function(){
					$('#contenue').load("RDC/emprunt/synthese_emprunt.php");
				});
				$('#coh1').click(function(){
					$('#contenue').load("RDC/emprunt/empruntA/objetAED1.php?coherence_visible=OK");
				});
				$('#coh11').click(function(){
					$('#contenue').load("RDC/emprunt/empruntA/objetAED1.php?coherence_visible=OK");
				});
				$('#coh2').click(function(){
					$('#contenue').load("RDC/emprunt/empruntA/objetAED2.php?coherence_visible=OK");
				});
				$('#reg1').click(function(){
					$('#contenue').load("RDC/emprunt/empruntB/objetBED1.php?regularite_visible=OK");
				});
				$('#reg2').click(function(){
					$('#contenue').load("RDC/emprunt/empruntB/objetBED2.php?regularite_visible=OK");
				});
				$('#eval1').click(function(){
					$('#contenue').load("RDC/emprunt/empruntC/objetCED1.php?evaluation_visible=OK");
				});
				$('#eval11').click(function(){
					$('#contenue').load("RDC/emprunt/empruntC/objetCED1.php?evaluation_visible=OK");
				});
				$('#info1').click(function(){
					$('#contenue').load("RDC/emprunt/empruntD/objetDED1.php?information_visible=OK");
				});
