...
<head>
		...
		<script>
			$(document).ready(function(){
				...
				$.ajax({
					type:"post",
					url:"RDC/paie/paieB/requetB2.php",
					data:{},
					success:function(e){
						$("#resultat").html(e);
						$("#waiting").hide();
	...
	<body>
		...
		<center>
			<p class="titreRenvoie">Etat récapitulatif des assurances allouées aux membres du personnel</p>
		</center>
		<div class="cadre">
			<table class="h4">
				<tr class="sous-titre">
