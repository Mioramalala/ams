	...
	if ($rowCount != 0){
		...
		while( $don = $rep->fetch() ){
			...
			echo '
				...
				<tr>
				<td width="100px" style="text-align:left;" id="compte'.$i.'">'.$compte.'</td>
				<td width="200px">'.$libelle.'</td>
				<td width="100px" style="text-align:right;">'.number_format((double)$debit, 2, '.', ' ').'</td>
				<td width="100px" style="text-align:right;">'.number_format((double)$credit, 2, '.', ' ').'</td>
				<td width="100px" style="text-align:right;">'.number_format((double)$SoldeN, 2, '.', ' ').'</td>
				<td width="100px" style="text-align:right;">'.number_format((double)$soldeN1, 2, '.', ' ').'</td>
				<td width="100px" style="text-align:right;">'.number_format((double)$variation, 2, '.', ' ').'</td>
				<td width="100px" style="text-align:right;">'.number_format((double)$pourcentage, 2, '.', ' ').'%</td>
