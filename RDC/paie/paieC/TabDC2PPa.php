		...
		<script>
			$(function(){
				$('#boutonAjout').click(function(){
					...
					var i = compteur + 1;
					$("#ajout").attr('alt',i);
					$('#ajout').append('<tr id="ligne'+ i +'"><td width="200px"><input type="text" placeholder="jj-mm-aaaa" id="date'+ i +'"/></td><td width="200px"><textarea id="police'+ i +'"></textarea></td><td width="200px"><textarea id="nature'+ i +'"></textarea></td><td width="200px"><input type="text" id="montant'+ i +'" /></td><td width="200px"><iframe style="display:none;" name="uploadFrame'+i+'"></iframe><form enctype="multipart/form-data" action="RDC/paie/paieC/TabDC2PPa.php" method="POST" id="form'+i+'" target="uploadFrame'+i+'"><input type="file" id="fichier'+ i +'" name="fichier"/><input type="hidden" name="MAX_FILE_SIZE" value="10485760" /><input id="submit'+i+'" type="submit" value="Upload" /></form></td><td width="200px"><textarea id="comment'+ i +'"></textarea></td></tr>');
				});
