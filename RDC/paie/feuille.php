	...
	<head>
		...
		<script type="text/javascript">
			...
			$('#synthese_feuille').click(function(){
				$('#contenue').load("RDC/paie/synthese_paie.php");
			});
			$('#coh1').click(function(){
				$('#contenue').load("RDC/paie/paieA/cohPrComAPP1.php?coherence_visible=OK");
			});
			$('#coh11').click(function(){
				$('#contenue').load("RDC/paie/paieA/cohPrComAPP1.php?coherence_visible=OK");
			});
			$('#coh2').click(function(){
				$('#contenue').load("RDC/paie/paieA/cohPrComAPP2.php?coherence_visible=OK");
			});
			$('#coh22').click(function(){
				$('#contenue').load("RDC/paie/paieA/cohPrComAPP2.php?coherence_visible=OK");
			});
			$('#coh3').click(function(){
				$('#contenue').load("RDC/paie/paieA/cohPrComAPP3.php?coherence_visible=OK");
			});
			$('#coh33').click(function(){
				$('#contenue').load("RDC/paie/paieA/cohPrComAPP3.php?coherence_visible=OK");
			});
			$('#exhaust1').click(function(){
				$('#contenue').load("RDC/paie/paieB/cohPrComBPP1.php?exhaustivte_visible=OK");
			});
			$('#exhaust2').click(function(){
				$('#contenue').load("RDC/paie/paieB/cohPrComBPP2.php?exhaustivte_visible=OK");
			});
			$('#exhaust22').click(function(){
				$('#contenue').load("RDC/paie/paieB/cohPrComBPP2.php?exhaustivte_visible=OK");
			});
			$('#reg1').click(function(){
				$('#contenue').load("RDC/paie/paieC/cohPrComCPP1.php?regularite_visible=OK");
			});
			$('#reg2').click(function(){
				$('#contenue').load("RDC/paie/paieC/cohPrComCPP2a.php?regularite_visible=OK");
			});
			$('#reg3').click(function(){
				$('#contenue').load("RDC/paie/paieC/cohPrComCPP2b.php?regularite_visible=OK");
			});
			$('#reg33').click(function(){
				$('#contenue').load("RDC/paie/paieC/cohPrComCPP2b.php?regularite_visible=OK");
			});
			$('#exist1').click(function(){
				$('#contenue').load("RDC/paie/paieD/cohPrComDPP1.php?existence_visible=OK");
			});
			$('#exist2').click(function(){
				$('#contenue').load("RDC/paie/paieD/cohPrComDPP1a.php?existence_visible=OK");
			});
			$('#exist22').click(function(){
				$('#contenue').load("RDC/paie/paieD/cohPrComDPP1a.php?existence_visible=OK");
			});
			$('#eval1').click(function(){
				$('#contenue').load("RDC/paie/paieE/cohPrComEPP1.php?evaluation_visible=OK");
			});
			$('#rattach1').click(function(){
				$('#contenue').load("RDC/paie/paieF/cohPrComFPP1.php?rattachement_visible=OK");
			});
			$('#jurid1').click(function(){
				$('#contenue').load("RDC/paie/paieG/cohPrComGPP1.php?juridique_visible=OK");
			});
			$('#jurid2').click(function(){
				$('#contenue').load("RDC/paie/paieG/cohPrComGPP2.php?juridique_visible=OK");
			});
			$('#jurid3').click(function(){
				$('#contenue').load("RDC/paie/paieG/cohPrComGPP3.php?juridique_visible=OK");
			});
			$('#jurid4').click(function(){
				$('#contenue').load("RDC/paie/paieG/cohPrComGPP4.php?juridique_visible=OK");
			});
			$('#jurid5').click(function(){
				$('#contenue').load("RDC/paie/paieG/cohPrComGPP5a.php?juridique_visible=OK");
			});
			$('#jurid55').click(function(){
				$('#contenue').load("RDC/paie/paieG/cohPrComGPP5a.php?juridique_visible=OK");
			});
			$('#jurid6').click(function(){
				$('#contenue').load("RDC/paie/paieG/cohPrComGPP5b.php?juridique_visible=OK");
			});
			$('#jurid66').click(function(){
				$('#contenue').load("RDC/paie/paieG/cohPrComGPP5b.php?juridique_visible=OK");
			});
			$('#jurid7').click(function(){
				$('#contenue').load("RDC/paie/paieG/cohPrComGPP5c.php?juridique_visible=OK");
			});
			$('#jurid77').click(function(){
				$('#contenue').load("RDC/paie/paieG/cohPrComGPP5c.php?juridique_visible=OK");
			});
			$('#info1').click(function(){
				$('#contenue').load("RDC/paie/paieH/cohPrComHPP1.php?information_visible=OK");
			});
			$('#info11').click(function(){
				$('#contenue').load("RDC/paie/paieH/cohPrComHPP1.php?information_visible=OK");
			});
			$('#info2').click(function(){
				$('#contenue').load("RDC/paie/paieH/cohPrComHPP2a.php?information_visible=OK");
			});
