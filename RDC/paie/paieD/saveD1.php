<?php
	...
	if( $rowCount == 0 ){
		$reqSyn=$bdd->exec("INSERT INTO  tab_cad_salaire_irsa ( PERIODE, NBR_PRS, AVANTAGE_NATURE, SALAIRE_BRUT, SALAIRE_TEMP, TOTAL_DECLARE, IRSA, PRS_TEMP, MISSION_ID,UTIL_ID) VALUES ('".$periode."','".$nbr."','".$avt."','".$salaire."','".$salaireT."','".$totalD."','".$irsa."','".$persT."',".$_SESSION['idMission'].",".$UTIL_ID.")");
