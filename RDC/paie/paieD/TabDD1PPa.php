		...
		<div class="cadre">
			...
			<div class="cadre2">
				<table width="910px">
					...
					<tr>
						<td height="100px"><textarea id="synthese" placeholder="Votre synthèse"><?php echo $syn['SYNTHESE'];?></textarea></td>
						<td height="100px"><textarea id="conclusion" placeholder="Votre commentaire"><?php echo $con['CONCLUSION'];?></textarea></td>
					</tr>
				</table>
			</div>
		</div>
