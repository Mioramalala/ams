...
<script>
	...
	$(function(){
		...
		$('#synthese_feuille').click(function(){
			$('#contenue').load("RDC/prod_client/synthese_prod_client.php");
		});
		
		$('#coh1').click(function(){
			$('#contenue').load("RDC/prod_client/A_coherence/coherence1.php?coherence_visible=OK");
		});
		$('#coh11').click(function(){
			$('#contenue').load("RDC/prod_client/A_coherence/coherence1.php?coherence_visible=OK");
		});
		$('#coh2').click(function(){
			$('#contenue').load("RDC/prod_client/A_coherence/coherence2.php?coherence_visible=OK");
		});
		$('#coh3').click(function(){
			$('#contenue').load("RDC/prod_client/A_coherence/coherence3.php?coherence_visible=OK");
		});
		...
		$('#exhaust1').click(function(){
			$('#contenue').load("RDC/prod_client/B_exhaustivite/exhaustivite1.php?exhaustivite_visible=OK");
		});
		$('#exhaust11').click(function(){
			$('#contenue').load("RDC/prod_client/B_exhaustivite/exhaustivite1.php?exhaustivite_visible=OK");
		});
		$('#reg1').click(function(){
			$('#contenue').load("RDC/prod_client/C_regularite/regularite1.php?regularite_visible=OK");
		});
		$('#reg11').click(function(){
			$('#contenue').load("RDC/prod_client/C_regularite/regularite1.php?regularite_visible=OK");
		});
		$('#reg2').click(function(){
			$('#contenue').load("RDC/prod_client/C_regularite/regularite2.php?regularite_visible=OK");
		});
		$('#exist1').click(function(){
			$('#contenue').load("RDC/prod_client/D_existence/existence1.php?existence_visible=OK");
		});
		$('#exist11').click(function(){
			$('#contenue').load("RDC/prod_client/D_existence/existence1.php?existence_visible=OK");
		});
		$('#exist2').click(function(){
			$('#contenue').load("RDC/prod_client/D_existence/existence2.php?existence_visible=OK");
		});
		...
		$('#eval1').click(function(){
			$('#contenue').load("RDC/prod_client/E_evaluation/evaluation1.php?evaluation_visible=OK");
		});
		$('#eval2').click(function(){
			$('#contenue').load("RDC/prod_client/E_evaluation/evaluation2.php?evaluation_visible=OK");
		});
		...
		$('#eval3').click(function(){
			$('#contenue').load("RDC/prod_client/E_evaluation/evaluation3.php?evaluation_visible=OK");
		});
		$('#eval4').click(function(){
			$('#contenue').load("RDC/prod_client/E_evaluation/evaluation4.php?evaluation_visible=OK");
		});
		$('#rattach1').click(function(){
			$('#contenue').load("RDC/prod_client/F_rattachement/rattachement1.php?rattachement_visible=OK");
		});
		$('#rattach11').click(function(){
			$('#contenue').load("RDC/prod_client/F_rattachement/rattachement1.php?rattachement_visible=OK");
		});
		$('#rattach2').click(function(){
			$('#contenue').load("RDC/prod_client/F_rattachement/rattachement2.php?rattachement_visible=OK");
		});
		$('#jurid1').click(function(){
			$('#contenue').load("RDC/prod_client/G_juridique/juridique1.php?juridique_visible=OK");
		});
		$('#jurid11').click(function(){
			$('#contenue').load("RDC/prod_client/G_juridique/juridique1.php?juridique_visible=OK");
		});
		$('#jurid2').click(function(){
			$('#contenue').load("RDC/prod_client/G_juridique/juridique2.php?juridique_visible=OK");
		});
		...
		$('#jurid3').click(function(){
			$('#contenue').load("RDC/prod_client/G_juridique/juridique3.php?juridique_visible=OK");
		});
		$('#info1').click(function(){
			$('#contenue').load("RDC/prod_client/H_information/information1.php?information_visible=OK");
		});
		$('#info2').click(function(){
			$('#contenue').load("RDC/prod_client/H_information/information2.php?information_visible=OK");
		});
		$('#info3').click(function(){
			$('#contenue').load("RDC/prod_client/H_information/information3.php?information_visible=OK");
		});
		$('#info4').click(function(){
			$('#contenue').load("RDC/prod_client/H_information/information4.php?information_visible=OK");
		});
	});
</script>
</head>
