...
if($donneesId['id']!=0){
	...
	$req='update tab_rdc_st_ra set UTIL_ID = "'.$UTIL_ID.'",SYNTHESE="'.$synthese.'" where MISSION_ID="'.$mission_id.'" AND id='.$donneesId['id'];
	...
	$req1='insert into tab_rdc_st_ra (SYNTHESE, MISSION_ID, OBJECTIF, CYCLE, REFERENCE,UTIL_ID) value ("'.$synthese.'",'.$mission_id.',"'.$objectif.'","'.$cycle.'","'.$reference.'","'.$UTIL_ID.'")';
