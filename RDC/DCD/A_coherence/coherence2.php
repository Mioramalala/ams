...
$reponse1=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="DCD" and RDC_OBJECTIF="A" and MISSION_ID='.$mission_id.' and RDC_RANG=3');
...
<script>
	...
	$(function(){
		...
		$('#bt_suivant').click(function(){
			...
			if((reponse1=="non" && commentaire1=="") || reponse1==""){ 
				...
				add_Data(reponse1,commentaire1,'DCD','A',3,<?php echo $mission_id; ?>);
				...
				for(var i=1; i <(lignes); i++){
					...
					if(observation!=''){
						add_Input(compte, observation, 'A', <?php echo $mission_id; ?>);					
					}	
				}
				$('#contenue').load("RDC/DCD/A_coherence/coherence3.php");
			}
	...
	function add_Input(compte,observation,objectif,mission_id){
		$.ajax({
			type:'POST',
			url:'RDC/DCD/A_coherence/add_Input_K2.php',
			data:{compte:compte,observation:observation,objectif:objectif, mission_id:mission_id},
			success:function(){
			}
		});	
	}
...
<table width="100%" height="470">
	<tr>
		...
		<div id="contenue_travail" style="overflow:auto;height:450px;">
			...
			<br />S'assurer de la cohérence de tous les états justificatifs des comptes</label><br /><br /><br />
			<label><strong>Documents et infos à obtenir</strong></label><br />
			.Balance générale N des DCD<br/><br />
			.Grand livre N des DCD<br/><br />
			.Balance auxiliaire des DCD<br/><br />
			.Balance âgée des DCD<br/><br /><br />
		<label><strong>Question :</strong></label><br />
		<label>Les soldes des grand-livres/balance auxiliaire/balance âgée/balance générale sont-ils conformes entre eux ?</label><br /><br /><br />
		
		<!--RENVOI B2-->
		<label><strong>Feuille de travail :</strong></label><label id="revue" style="cursor:pointer;color:red;">RAPPROCHEMENT SOLDES GL / BALANCE</label>
