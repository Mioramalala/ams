...
$reponse1     = $bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="DCD" and RDC_OBJECTIF="A" and MISSION_ID='.$mission_id.' and RDC_RANG=1');
$donnees      = $reponse1->fetch();
$commentaire1 = $donnees['RDC_COMMENTAIRE'];
$qcm1         = $donnees['RDC_REPONSE'];

$reponse2     = $bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="DCD" and RDC_OBJECTIF="A" and MISSION_ID='.$mission_id.' and RDC_RANG=2');
...
<script>
	...
	$(function(){
		...
		$('#revue').click(function(){
			...
			$('#contenue_rdc').show();
			$('#contenue_travail').load("RDC/DCD/A_coherence/table_K1.php");
		});
		...
		$('#bt_suivant').click(function(){
			...
			var synthese     = document.getElementById('synthese_dcd').value;
			var conclusion   = document.getElementById('conclusion_dcd').value;
			...
			if((reponse1 == "non" && commentaire1 == "") || (reponse2 == "non" && commentaire2 == "") || reponse1 == "" || reponse2 == "") { 
				...
				var synthese   = $("#synthese_dcd").val();	
				var conclusion = $("#conclusion_dcd").val();

				if(synthese!=''){add_Synth(synthese, conclusion);}
				if(conclusion!=''){add_Concl(synthese, conclusion);}
					$('#contenue').load("RDC/DCD/A_coherence/coherence2.php");
			}
	...
	function add_Synth(synthese, conclusion) {
		$.ajax({
			type    : 'POST',
			url     : 'RDC/DCD/A_coherence/add_Synth.php',
	...
	function add_Concl(synthese, conclusion){
		...
		$.ajax({
			type    : 'POST',
			url     : 'RDC/DCD/A_coherence/add_Concl.php',
			data    : {synthese:synthese, conclusion:conclusion, mission_id:<?php echo $mission_id;?>},
			success : function(e){}
		});		
	}
...
<table width="100%" height="470">
	<tr>
		...
		<div id="contenue_travail" style="overflow:auto;height:450px;width:100%;">
			...
			<br />Revue analytique : identifier et expliquer l'origine de tout écart significatif entre les deux exercices. </label><br /><br /><br />
			<label><strong>Documents et infos à obtenir</strong></label><br />
			<label><strong></strong>Balances générales et EF N-1 et N</label><br /><br /><br />
		<label><strong>Question 1 :</strong></label><br />
		<label>A-t-on effectué une revue analytique par rapport à l'exercice précédent ?</label><br /><br /><br />		
		<label><strong>Question 2 :</strong></label><br />
		<label>Les écarts significatifs sont-ils tous justifiés?</label><br /><br /><br />
		...
		<div id="contenue_question" style="overflow:auto;height:450px;" >
			...
			?>  >
				<label><strong>Question 1 :</strong></label><br />
				<label>A-t-on effectué une revue analytique par rapport à l'exercice précédent ?</label>
