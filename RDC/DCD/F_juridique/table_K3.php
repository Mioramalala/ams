		...
		<td width="100px">OBSERVATIONS</td>		
			...
			?>
					<tr bgcolor="white">
						...
						<td width="100px"><?php echo $donnees['IMPORT_SOLDE'];?></td> 
						<td width="100px"><input type="text" id=<?php echo "justification_".$ligne ?> /></td>
						<td width="100px"><input type="text" id=<?php echo "circularisation_".$ligne ?>/></td>
						<td width="100px"><input type="text" id=<?php echo "apurement_".$ligne ?>/></td>
						<td width="100px"><input type="text" id=<?php echo "observation_".$ligne ?>/></td>
					</tr>
