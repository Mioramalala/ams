		...
		<td width="100px">OBSERVATIONS</td>		
			...
			?>
					<tr bgcolor="white">
						...
						<td width="100px"><?php echo number_format((double)$donnees['IMPORT_SOLDE'],2,","," ");?>

						<?php
							$rep = $bdd->query("SELECT DCD_JUSTIFICATION,DCD_CIRCULARISATION,DCD_APUREMENT_N1,DCD_OBSERVATION FROM tab_just_apur_dcd WHERE DCD_OBJECTIF='D' AND 
