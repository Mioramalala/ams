...
$reponse1=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="DCD" and RDC_OBJECTIF="D" and MISSION_ID='.$mission_id.' and RDC_RANG=1');
...
<script>
	...
	$(function(){
		...
		$('#revue').click(function(){
			...
			$('#contenue_rdc').show();
			//D_existence
			$('#contenue_travail').load("RDC/DCD/D_existence/table_K3.php");
		});
		...
		$('#bt_suivant').click(function(){
			...
			if((reponse1=="non" && commentaire1=="") || reponse1==""){ 
				...
				add_Data(reponse1,commentaire1,'DCD','D',1,<?php echo $mission_id; ?>);			
				...
				for(var i=1; i <(lignes+1); i++){
					...
					add_Input(compte, apurement, justification, observation, circularisation, 'D', i, <?php echo $mission_id; ?>);
				}

				$("#contenue").load("RDC/DCD/index.php");
				//$('#contenue').load("RDC/DCD/D_existence/coherence2.php");
			}
		});
	...
	function add_Data(reponse,commentaire,cycle,objectif,rang,mission_id){
		$.ajax({
			type:'POST',
			url:'RDC/DCD/D_existence/add_Data.php',
...
<table width="100%" height="470">
	<tr>
		...
		<div id="contenue_travail" style="overflow:auto;height:450px;width:100%;">
			...
			<br/>Contrôler la justification du solde des DCD à la date de clôture</label><br /><br/><br/>
			<label><strong>Documents et infos à obtenir :</strong></label><br />
			.Tableau de rapprochement intragoupe<br/><br/>
			.Autres PJ (contrats, circularisation …)<br/><br/><br/>			
		<label><strong>Question  :</strong></label><br />
		<label>Les soldes des DCD sont-ils tous justifiés ?</label><br /><br/><br/>
		...
		<div id="contenue_question" style="overflow:auto;height:450px;" >
			...
			?>  >
				...
				<label><strong>Question :</strong></label><br />
				<label>Les soldes des DCD sont-ils tous justifiés ?</label>
