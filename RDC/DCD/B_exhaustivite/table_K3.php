...
<div align="center">
<label>JUSTIFICATION ET APUREMENT DES AVOCATS</label>
...
<table width="100%" class="tab">
	<tr bgcolor="#00698D" >
		...
		<td width="100px" >DATE DE CIRCULARISATION</td>
		<td width="100px">DATE DE LA REPONSE</td>
		<td width="100px">SOLDE CIRCULARISE</td>
		...
		<td width="100px">OBSERVATIONS</td>		
			...
			?>
					<tr bgcolor="white">
						...
						<?php
							$rep = $bdd->query("SELECT DCD_JUSTIFICATION,DCD_CIRCULARISATION,DCD_APUREMENT_N1,DCD_OBSERVATION FROM tab_just_apur_dcd WHERE DCD_OBJECTIF='B' AND 
						...
						<td width="100px"><input type="text" id="<?php echo "observation_".$ligne ?>" value="<?php $ecart=$donnees['IMPORT_SOLDE']-str_replace(",",".",$data['DCD_APUREMENT_N1']); echo number_format((double)$ecart,2,","," ");?>"/></td>
