...
<script>
	...
	$(function(){
		...
		$('#synthese_feuille').click(function(){
			$('#contenue').load("RDC/DCD/synthese_dcd.php");
		});
		$('#coh1').click(function(){
			$('#contenue').load("RDC/DCD/A_coherence/coherence1.php?coherence_visible=OK");
		});
		$('#coh11').click(function(){
			$('#contenue').load("RDC/DCD/A_coherence/coherence1.php?coherence_visible=OK");
		});
		$('#coh2').click(function(){
			$('#contenue').load("RDC/DCD/A_coherence/coherence2.php?coherence_visible=OK");
		});
		$('#coh3').click(function(){
			$('#contenue').load("RDC/DCD/A_coherence/coherence3.php?coherence_visible=OK");
		});
		$('#exhaust1').click(function(){
			$('#contenue').load("RDC/DCD/B_exhaustivite/exhaustivite1.php?exhaustivite_visible=OK");
		});
		$('#exhaust11').click(function(){
			$('#contenue').load("RDC/DCD/B_exhaustivite/exhaustivite1.php?exhaustivite_visible=OK");
		});
		$('#reg1').click(function(){
			$('#contenue').load("RDC/DCD/C_regularite/regularite1.php?regularite_visible=OK");
		});
		$('#reg11').click(function(){
			$('#contenue').load("RDC/DCD/C_regularite/regularite1.php?regularite_visible=OK");
		});
		$('#exist1').click(function(){
			$('#contenue').load("RDC/DCD/D_existence/existence1.php?existence_visible=OK");
		});
		$('#eval1').click(function(){
			$('#contenue').load("RDC/DCD/E_evaluation/evaluation1.php?evaluation_visible=OK");
		});
		$('#eval11').click(function(){
			$('#contenue').load("RDC/DCD/E_evaluation/evaluation1.php?evaluation_visible=OK");
		});
		$('#jurid1').click(function(){
			$('#contenue').load("RDC/DCD/F_juridique/juridique1.php?juridique_visible=OK");
		});
		...
		$('#info1').click(function(){
			$('#contenue').load("RDC/DCD/G_information/information1.php?information_visible=OK");
		});
	});
</script>
</head>
