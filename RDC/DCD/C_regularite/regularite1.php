...
$reponse1=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="DCD" and RDC_OBJECTIF="C" and MISSION_ID='.$mission_id.' and RDC_RANG=1');
...
$reponse2=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="DCD" and RDC_OBJECTIF="C" and MISSION_ID='.$mission_id.' and RDC_RANG=2');
...
<script>
	...
	$(function(){
		...
		$('#revue').click(function(){
			...
			$('#contenue_rdc').show();
			//C_regularite
			$('#contenue_travail').load("RDC/DCD/C_regularite/table_K3.php");
		});
		...
		$('#bt_suivant').click(function(){
			...
			if((reponse1=="non" && commentaire1=="") || (reponse2=="non" && commentaire2=="") || reponse1=="" || reponse2==""){ 
				...
				add_Data(reponse1,commentaire1,'DCD','C',1,<?php echo $mission_id; ?>);			
				add_Data(reponse2,commentaire2,'DCD','C',2,<?php echo $mission_id; ?>);	
				$("#contenue").load("RDC/DCD/index.php");
				...
				for(var i=1; i <(lignes+1); i++){
					...
					add_Input(compte, apurement, justification, observation, circularisation, 'C', i, <?php echo $mission_id; ?>);
				}

				
				//$('#contenue').load("RDC/DCD/C_regularite/coherence2.php");
			}
		});
	...
	function add_Data(reponse,commentaire,cycle,objectif,rang,mission_id){
		$.ajax({
			type:'POST',
			url:'RDC/DCD/C_regularite/add_Data.php',
...
<table width="100%" height="470">
	<tr>
		...
		<div id="contenue_travail" style="overflow:auto;height:450px;width:100%;">
			...
			<br/>.Contrôler la justification des montants comptabilisés en DCD<br/>
			<br/>.Contrôler l’apurement des montants portés en DCD sur l’exercice suivant
			</label><br /><br/><br/>
			<label><strong>Documents et infos à obtenir :</strong></label><br />
			.GL des DCD N et N+1<br/><br/>
			.PJ<br/><br/><br/>
		<label><strong>Question 1 :</strong></label><br />
		<label>Les montants des DCD comptabilisés sont-ils cohérents ?</label><br /><br/><br/>		
		<label><strong>Question 2 :</strong></label><br />
		<label>Les soldes des DCD sont-ils apurés en N+1 ?</label><br /><br/><br/>
		<!--Renvoi B6-->
		<label><strong>Feuille de travail :</strong></label><label id="revue" style="cursor:pointer;color:red;">JUSTIFICATION ET APUREMENT DES DCD</label>
		...
		<div id="contenue_question" style="overflow:auto;height:450px;" >
			...
			?>  >
				...
				<label><strong>Question 1:</strong></label><br />
				<label>Les montants des DCD comptabilisés sont-ils cohérents ?</label>
				...
				<label><strong>Question 2:</strong></label><br />
				<label>Les soldes des DCD sont-ils apurés en N+1 ?</label>
