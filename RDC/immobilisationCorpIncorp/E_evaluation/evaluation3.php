...
$reponse1=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="immobilisation corporelle et incorporelle" and RDC_OBJECTIF="E" and MISSION_ID='.$mission_id.' and RDC_RANG=7');
$donnees=$reponse1->fetch();
$commentaire1=$donnees['RDC_COMMENTAIRE'];
$qcm1=$donnees['RDC_REPONSE'];

$reponse2=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="immobilisation corporelle et incorporelle" and RDC_OBJECTIF="E" and MISSION_ID='.$mission_id.' and RDC_RANG=8');
	...
	$(function(){
		...
		$('#bt_suivant').click(function(){
			...
			if((reponse1=="non" && commentaire1=="") || (reponse2=="non" && commentaire2=="") || reponse1=="" || reponse2==""){ 
				...
				add_Data(reponse1,commentaire1,'immobilisation corporelle et incorporelle','E',7,<?php echo $mission_id; ?>);
				add_Data(reponse2,commentaire2,'immobilisation corporelle et incorporelle','E',8,<?php echo $mission_id; ?>);
...
<table width="100%" height="50" bgcolor="#00698d" style="text-align:left;">
	<tr>
		<td><center><label class="grand_Titre">E-  EVALUATION DES SOLDES PARTIE :III</label></center></td>
	</tr>
</table>
...
<table width="100%" height="470">
	<tr>
		...
		<div id="contenue_travail" style="overflow:auto;height:450px;">
			...
			<br/>Contrôler des réévaluations éventuelles</label><br /><br/><br/>
			<label><strong>Documents et infos à obtenir</strong></label><br />
			Rapport relatif à la réévaluation d'actif immobilisé<br/><br/><br/>
			
			<label><strong>Question 1:</strong></label><br />
			<label>Les réévaluations ont-elles été comptabilisées correctement ?</label><br /><br/><br/>
			<label><strong>Question 2:</strong></label><br />
			<label>Les (catégories) immobilisations ont-elles été réévaluées en totalité ?</label><br /><br/><br/>
		...
		<div id="contenue_question" style="overflow:auto;height:450px;" >
			...
			?> >
				<label><strong>Question 1:</strong></label><br />
				<label>Les réévaluations ont-elles été comptabilisées correctement ?</label>
				...
				<label><strong>Question 2:</strong></label><br />
				<label>Les (catégories) immobilisations ont-elles été réévaluées en totalité ?</label>
