...
<script>
	...
	$(function(){
		...
		$('#synthese_feuille').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/synthese_immo.php");
		});
		
		$('#coh1').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/A_coherence/coherence1.php?coherence_visible=OK");
		});
		$('#coh11').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/A_coherence/coherence1.php?coherence_visible=OK");
		});
		$('#coh2').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/A_coherence/coherence2.php?coherence_visible=OK");
		});
		$('#coh3').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/A_coherence/coherence3.php?coherence_visible=OK");
		});
		...
		$('#coh4').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/A_coherence/coherence4.php?coherence_visible=OK");
		});
		$('#coh44').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/A_coherence/coherence4.php?coherence_visible=OK");
		});
		$('#coh5').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/A_coherence/coherence5.php?coherence_visible=OK");
		});
		...
		$('#coh6').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/A_coherence/coherence6.php?coherence_visible=OK");
		});
		$('#coh7').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/A_coherence/coherence7.php?coherence_visible=OK");
		});
		...
		$('#coh8').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/A_coherence/coherence8.php?coherence_visible=OK");
		});
		...
		$('#exhaust1').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/B_exhaustivite/exhaustivite1.php?exhaustivite_visible=OK");
		});
		$('#reg1').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/C_regularite/regularite1.php?regularite_visible=OK");
		});
		...
		$('#reg2').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/C_regularite/regularite2.php?regularite_visible=OK");
		});
		$('#reg22').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/C_regularite/regularite2.php?regularite_visible=OK");
		});
		$('#reg3').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/C_regularite/regularite3.php?regularite_visible=OK");
		});
		$('#reg33').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/C_regularite/regularite3.php?regularite_visible=OK");
		});
		$('#reg4').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/C_regularite/regularite4.php?regularite_visible=OK");
		});
		$('#exist1').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/D_existence/existence1.php?existence_visible=OK");
		});
		$('#exist11').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/D_existence/existence1.php?existence_visible=OK");
		});
		$('#exist2').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/D_existence/existence2.php?existence_visible=OK");
		});
		$('#exist3').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/D_existence/existence3.php?existence_visible=OK");
		});
		$('#exist4').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/D_existence/existence4.php?existence_visible=OK");
		});
		$('#exist44').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/D_existence/existence4.php?existence_visible=OK");
		});
		$('#eval1').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/E_evaluation/evaluation1.php?evaluation_visible=OK");
		});
		$('#eval11').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/E_evaluation/evaluation1.php?evaluation_visible=OK");
		});
		$('#eval2').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/E_evaluation/evaluation2.php?evaluation_visible=OK");
		});
		...
		$('#eval3').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/E_evaluation/evaluation3.php?evaluation_visible=OK");
		});
		$('#eval33').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/E_evaluation/evaluation3.php?evaluation_visible=OK");
		});
		$('#rattach1').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/F_rattachement/rattachement1.php?rattachement_visible=OK");
		});
		...
		$('#rattach2').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/F_rattachement/rattachement2.php?rattachement_visible=OK");
		});
		$('#jurid1').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/G_juridique/juridique1.php?juridique_visible=OK");
		});
		$('#jurid2').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/G_juridique/juridique2.php?juridique_visible=OK");
		});
		$('#jurid3').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/G_juridique/juridique3.php?juridique_visible=OK");
		});
		$('#jurid4').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/G_juridique/juridique4.php?juridique_visible=OK");
		});
		$('#jurid5').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/G_juridique/juridique5.php?juridique_visible=OK");
		});
		$('#info1').click(function(){
			$('#contenue').load("RDC/immobilisationCorpIncorp/H_information/information1.php?information_visible=OK");
		});
