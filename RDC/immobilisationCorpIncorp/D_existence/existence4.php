...
$reponse1=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="immobilisation corporelle et incorporelle" and RDC_OBJECTIF="D" and MISSION_ID='.$mission_id.' and RDC_RANG=5');
$donnees=$reponse1->fetch();
$commentaire1=$donnees['RDC_COMMENTAIRE'];
$qcm1=$donnees['RDC_REPONSE'];

$reponse2=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="immobilisation corporelle et incorporelle" and RDC_OBJECTIF="D" and MISSION_ID='.$mission_id.' and RDC_RANG=6');
...
<script>
	...
	$(function(){
		...
		$('#bt_suivant').click(function(){
			...
			if((reponse1=="non" && commentaire1=="") || (reponse2=="non" && commentaire2=="") || reponse1=="" || reponse2==""){ 
				...
				add_Data(reponse1,commentaire1,'immobilisation corporelle et incorporelle','D',5,<?php echo $mission_id; ?>);
				add_Data(reponse2,commentaire2,'immobilisation corporelle et incorporelle','D',6,<?php echo $mission_id; ?>);
	...
	function add_Data(reponse,commentaire,cycle,objectif,rang,mission_id){
		$.ajax({
			type:'POST',
			url:'RDC/immobilisationCorpIncorp/D_existence/add_Data.php',
...
<table width="100%" height="50" bgcolor="#00698d" style="text-align:left;">
	<tr>
		<td><center><label class="grand_Titre">D-  EXISTENCE DES SOLDES PARTIE :IV</label></center></td>
	</tr>
</table>
...
<table width="100%" height="470">
	<tr>
		...
		<div id="contenue_travail" style="overflow:auto;height:450px;">
			...
			<br/>Justifier les acomptes versés sur commande d'immobilisations et immobilisations en cours</label><br /><br/><br/>
			<label><strong>Documents et infos à obtenir</strong></label><br />
			.GL des immobilisations en cours<br/><br/>
			.PJ des acomptes versés sur commande<br/><br/><br/>
			<label><strong>Question 1:</strong></label><br />
			<label>Le paiement d'acomptes versés sur commande a-t-il fait l'objet d'entrée en immobilisation en cours ?</label><br /><br/><br/>
			<label><strong>Question 2:</strong></label><br />
			<label>Les acomptes versés sur commande d'immobilisation et d'immobilisations en cours sont-ils justifiés ?</label><br /><br/><br/>
		...
		<div id="contenue_question" style="overflow:auto;height:450px;">
			...
			>
				<label><strong>Question 1:</strong></label><br />
				<label>Le paiement d'acomptes versés sur commande a-t-il fait l'objet d'entrée en immobilisation en cours ?</label>
				...
				<label><strong>Question 2:</strong></label><br />
				<label>Les acomptes versés sur commande d'immobilisation et d'immobilisations en cours sont-ils justifiés ?</label>
