...
$reponse1=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="immobilisation corporelle et incorporelle" and RDC_OBJECTIF="D" and MISSION_ID='.$mission_id.' and RDC_RANG=1');
$donnees=$reponse1->fetch();
$commentaire1=$donnees['RDC_COMMENTAIRE'];
$qcm1=$donnees['RDC_REPONSE'];

$reponse2=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="immobilisation corporelle et incorporelle" and RDC_OBJECTIF="D" and MISSION_ID='.$mission_id.' and RDC_RANG=2');
...
<script>
	...
	$(function(){
		...
		$('#revue').click(function(){
			...
			$('#bt_retour').hide();
			$('#contenue_rdc').show();
			$('#contenue_travail').load("RDC/immobilisationCorpIncorp/D_existence/table_B2.php");
		});
		...
		$('#bt_suivant').click(function(){
			...
			if((reponse1=="non" && commentaire1=="") || (reponse2=="non" && commentaire2=="") || reponse1=="" || reponse2==""){ 
				...
				add_Data(reponse1,commentaire1,'immobilisation corporelle et incorporelle','D',1,<?php echo $mission_id; ?>);
				add_Data(reponse2,commentaire2,'immobilisation corporelle et incorporelle','D',2,<?php echo $mission_id; ?>);			
				//C_regularite
...
<table width="100%" height="50" bgcolor="#00698d" style="text-align:left;">
	<tr>
		<td><center><label class="grand_Titre">D-  EXISTENCE DES SOLDES PARTIE :I</label></center></td>
	</tr>
</table>
...
<table width="100%" height="470">
	<tr>
		...
		<div id="contenue_travail" style="overflow:auto;height:450px;width:100%;">
			...
			<br/>Rapprocher le fichier des immobilisations avec la comptabilité</label><br /><br/><br/>
			<label><strong>Documents et infos à obtenir</strong></label><br />
			.Fichier des immobilisations<br /><br/>
			.Balance/GL des immobilisations<br/><br/><br/>
			<label><strong>Question 1 :</strong></label><br />
			<label>A-t-on rapproché le fichier des immobilisations avec la comptabilité?</label><br /><br/><br/>		
			<label><strong>Question 2 :</strong></label><br />
			<label>Les écarts sont-ils tous justifiés et expliqués ?</label><br /><br/><br/>
			
			<!--Renvoi B2-->
			<label><strong>Feuilles de travail :</strong></label>	
			<label id="revue" style="cursor:pointer;color:red;">Rapprochement fichier d'immobilisations avec la comptabilité</label><br/>
		...
		<div id="contenue_question" style="overflow:auto;height:450px;" >
			...
			?>  >
				<label><strong>Question 1 :</strong></label><br />
				<label>A-t-on rapproché le fichier des immobilisations avec la comptabilité?</label>
				...
				<label><strong>Question 2 :</strong></label><br />
				<label>Les écarts sont-ils tous justifiés et expliqués ?</label>
