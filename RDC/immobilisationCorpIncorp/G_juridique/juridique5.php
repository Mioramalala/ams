...
$reponse1=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="immobilisation corporelle et incorporelle" and RDC_OBJECTIF="G" and MISSION_ID='.$mission_id.' and RDC_RANG=7');
...
<script>
	...
	$(function(){
		...
		$('#revue').click(function(){
			...
			$('#contenue_travail').load("RDC/immobilisationCorpIncorp/G_juridique/table_B9.php");
		});
		...
		$('#bt_suivant').click(function(){
			...
			if((reponse1=="non" && commentaire1=="") || reponse1==""){ 
				...
				datatransfert=$("#frm_juridique").serialize();;
				add_Data(reponse1,commentaire1,'immobilisation corporelle et incorporelle','G',7,<?php echo $mission_id; ?>);
				 $.ajax({
                        type : "POST",
                        url : "RDC/immobilisationCorpIncorp/G_juridique/enregistrement_tauxammortissement.php",
                        data : datatransfert,
                        error :function(msg)
                        {
                            alert( "Erreur  : " + msg );
		...
		$('#bt_precedent').click(function(){
			$("#contenue").load("RDC/immobilisationCorpIncorp/G_juridique/juridique4.php");
		});
	});
...
<table width="100%" height="50" bgcolor="#00698d" style="text-align:left;">
	<tr>
		<td><center><label class="grand_Titre">G- JURIDIQUE FISCAL ET DIVERS PARTIE :V</label></center></td>
	</tr>
</table>
<table width="100%" height="470">
	<tr>
		...
		<div id="contenue_travail" style="overflow:auto;height:450px;">
			...
			<br/>Contrôler les taux d'amortissements appliqués</label><br /><br/><br/>
			<label><strong>Documents et infos à obtenir</strong></label><br />
			Tableau d'amortissement des immobilisations<br/><br/><br/>

			<label><strong>Question :</strong></label><br />
			<label>Les taux d'amortisssement appliqués ne dépassent-ils pas ceux admis fiscalement ?</label><br /><br/><br/>
		...
		<div id="contenue_question" style="overflow:auto;height:450px;">
			...
			<?php 
				...
				?> >
				<label><strong>Question :</strong></label><br />
				<label>Les taux d'amortisssement appliqués ne dépassent-ils pas ceux admis fiscalement ?</label>
