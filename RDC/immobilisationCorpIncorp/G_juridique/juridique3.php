...
$reponse1=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="immobilisation corporelle et incorporelle" and RDC_OBJECTIF="G" and MISSION_ID='.$mission_id.' and RDC_RANG=5');
	...
	$(function(){
		...
		$('#bt_suivant').click(function(){
			...
			if((reponse1=="non" && commentaire1=="") || reponse1==""){ 
				...
				add_Data(reponse1,commentaire1,'immobilisation corporelle et incorporelle','G',5,<?php echo $mission_id; ?>);
...
<table width="100%" height="50" bgcolor="#00698d" style="text-align:left;">
	<tr>
		<td><center><label class="grand_Titre">G- JURIDIQUE FISCAL ET DIVERS PARTIE :III</label></center></td>
	</tr>
</table>
<table width="100%" height="470">
	<tr>
		...
		<div id="contenue_travail" style="overflow:auto;height:450px;">
			...
			<br/>Contrôler l'application des règles de TVA sur les acquisitions. </label><br /><br/><br/>
			<label><strong>Documents et infos à obtenir</strong></label><br />
			Annexes aux déclarations de TVA<br/><br/><br/>

			<label><strong>Question :</strong></label><br />
			<label>La récupération de la TVA ne dépasse-t-elle pas le délai autorisé par le CGI ?</label><br /><br/><br/>
		...
		<div id="contenue_question" style="overflow:auto;height:450px;">
			...
			<?php 
			 ...
			 ?>  >
				<label><strong>Question :</strong></label><br />
				<label>La récupération de la TVA ne dépasse-t-elle pas le délai autorisé par le CGI ?</label>
