...
$reponse1=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="immobilisation corporelle et incorporelle" and RDC_OBJECTIF="G" and MISSION_ID='.$mission_id.' and RDC_RANG=4');
	...
	$(function(){
		...
		$('#bt_suivant').click(function(){
			...
			if((reponse1=="non" && commentaire1=="") || reponse1==""){ 
				...
				add_Data(reponse1,commentaire1,'immobilisation corporelle et incorporelle','G',4,<?php echo $mission_id; ?>);
...
<table width="100%" height="470">
	<tr>
		...
		<div id="contenue_travail" style="overflow:auto;height:450px;">
			...
			<br/>Contrôler l’application des règles de TVA sur les cessions </label><br /><br/><br/>
			<label><strong>Documents et infos à obtenir</strong></label><br />
			Grand livre des comptes<br/><br/><br/>

			<label><strong>Question :</strong></label><br />
			<label>Le calcul de la TVA sur les cessions est-il effectué sur la valeur la plus significative entre le prix de vente et la valeur nette comptable ?</label><br /><br/><br/>
		...
		<div id="contenue_question" style="overflow:auto;height:450px;">
			...
			?> >
				<label><strong>Question :</strong></label><br />
				<label>Le calcul de la TVA sur les cessions est-il effectué sur la valeur la plus significative entre le prix de vente et la valeur nette comptable ?</label>
