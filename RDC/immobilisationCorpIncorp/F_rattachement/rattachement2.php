...
$reponse1=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="immobilisation corporelle et incorporelle" and RDC_OBJECTIF="F" and MISSION_ID='.$mission_id.' and RDC_RANG=4');
	...
	$(function(){
		...
		$('#bt_suivant').click(function(){
			...
			if((reponse1=="non" && commentaire1=="") || (reponse2=="non" && commentaire2=="") || reponse1=="" || reponse2==""){ 
				...
				add_Data(reponse1,commentaire1,'immobilisation corporelle et incorporelle','F',4,<?php echo $mission_id; ?>);
...
<table width="100%" height="50" bgcolor="#00698d" style="text-align:left;">
	<tr>
		<td><center><label class="grand_Titre">F- RATTACHEMENT DES OPERATIONS PARTIE :II</label></center></td>
	</tr>
</table>
<table width="100%" height="470">
	<tr>
		...
		<div id="contenue_travail" style="overflow:auto;height:450px;">
			...
			<br/>Contrôler l'absence d'immobilisations déjà mises en service, dans les immobilisations en cours</label><br /><br/><br/>
			<label><strong>Documents et infos à obtenir</strong></label><br />
			.Registre des immobilisations (état de suivi des mouvements des immobilisations)<br/><br/>
			.Grand livre des comptes<br/><br/><br/>
			
			<label><strong>Question :</strong></label><br />
			<label>Confirmez-vous que tous les éléments comptabilisés parmi les immobilisations en cours concernent des immobilisations non encore mises en service ?</label><br /><br/><br/>
		...
		<div id="contenue_question" style="overflow:auto;height:450px;">
			...
			?>>
				<label><strong>Question :</strong></label><br />
				<label>Confirmez-vous que tous les éléments comptabilisés parmi les immobilisations en cours concernent des immobilisations non encore mises en service ?</label>
