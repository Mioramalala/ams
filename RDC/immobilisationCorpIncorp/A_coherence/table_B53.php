...
$mission_id=@$_SESSION['idMission'];
	...
	///////////////////////////compt accessoires/////////////
	$reponse=$bdd->query("select count(tab_Frais_Accessoire.id_frais_acc) As nbr_Acc from tab_Frais_Accessoire,tbl_detaillefraix_acc where   	type_fraixacc='accuisition' and  tab_Frais_Accessoire.id_frais_acc=tbl_detaillefraix_acc.id_frais_acc AND  tab_Frais_Accessoire.id_mission=".$mission_id);
		$donnees=$reponse->fetch();
		$nbr_Acc=(int)$donnees['nbr_Acc'];
		// echo $nbr_Acc;
	///////////////////////////////////////////////////////
	$reponse=$bdd->query("select nom_frais_acc from tab_Frais_Accessoire,tbl_detaillefraix_acc where  type_fraixacc='accuisition' and  tab_Frais_Accessoire.id_frais_acc=tbl_detaillefraix_acc.id_frais_acc and  tab_Frais_Accessoire.id_mission=".$mission_id);
...
<input type="button" value="Enregistrement coût d'acquisition" id="Enregistrmentcoutacquisition" style="width:378px;heigth:60px;background: rgb(0, 105, 141) none repeat scroll 0% 0%;font-size: 18px;float: left;text-align: center;color: rgb(255, 255, 255)">
<div  style="width:100%">

 <center><label>Détermination du coût d'acquisition</label></center>
...
<table id="tb" style="border-collapse:collapse;">
	...
	<tbody>
			...
			<?php 
				...
				where id_mission='$mission_id' AND objectif='A5' AND type_fraixacc='accuisition' and GL_GEN_CYCLE='B- Immobilisations incorporelles et corporelles'" ;
