...
$reponse1=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="immobilisation corporelle et incorporelle" and RDC_OBJECTIF="A" and MISSION_ID='.$mission_id.' and RDC_RANG=4');
$donnees=$reponse1->fetch();
$commentaire1=$donnees['RDC_COMMENTAIRE'];
$qcm1=$donnees['RDC_REPONSE'];

$reponse2=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="immobilisation corporelle et incorporelle" and RDC_OBJECTIF="A" and MISSION_ID='.$mission_id.' and RDC_RANG=5');
$donnees2=$reponse2->fetch();
$commentaire2=$donnees2['RDC_COMMENTAIRE'];
$qcm2=$donnees2['RDC_REPONSE'];

$reponse3=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="immobilisation corporelle et incorporelle" and RDC_OBJECTIF="A" and MISSION_ID='.$mission_id.' and RDC_RANG=6');
...
<script>
	...
	$(function(){
		...
		$('#revue').click(function(){
			...
			$('#contenue_travail').load("RDC/immobilisationCorpIncorp/A_coherence/table_B3.php");
		});
		...
		$('#bt_suivant').click(function(){	
			...
			if((reponse1=="non" && commentaire1=="") || (reponse2=="non" && commentaire2=="") || (reponse3=="non" && commentaire3=="") || reponse1=="" || reponse2=="" || reponse3==""){ 
				...
				add_Data(reponse1,commentaire1,'immobilisation corporelle et incorporelle','A',4,<?php echo $mission_id; ?>);
				add_Data(reponse2,commentaire2,'immobilisation corporelle et incorporelle','A',5,<?php echo $mission_id; ?>);
				add_Data(reponse3,commentaire3,'immobilisation corporelle et incorporelle','A',6,<?php echo $mission_id; ?>);
				addDataRDCcohpart3();
	...
	function addDataRDCcohpart3()
	{
		
		datatransfert=$("#frmRDCcoherence").serialize()+"&cycle=B- Immobilisations incorporelles et corporelles";
			$.ajax({
				type:'POST',
				url:'RDC/immobilisationCorpIncorp/A_coherence/addDataRDCcohpart3.php',
				data:datatransfert,
...
<table width="100%" height="470">
	<tr>
		...
		<div id="contenue_travail" style="overflow:auto;height:450px;">
			<label><strong>Travaux à faire :</strong>Rapprocher les investissements de l'exercice avec le budget</label><br /><br/><br/>
			<label><strong>Documents et infos à obtenir</strong></label><br />
			.Tableau de rapprochement entre investissements et budget<br/>
			.Budget d'investissements de l'exercice N<br/>
			.Liste des acquisitions de l'exercice N<br/><br/>


		<label><strong>Question 1 :</strong></label><br />
		<label>Un rapprochement des investissements réalisés avec le budget a-t-il été réalisé ?</label><br /><br/>	
		<label><strong>Question 2 :</strong></label><br />
		<label>Toutes les acquisitions ont-elles été prévues par le budget ?</label><br /><br/>
		<label><strong>Question 3 :</strong></label><br />
		<label>Les écarts significatifs sont-ils tous justifiés ?</label><br /><br/>
		
		<!--Renvoi B3-->
		<label><strong>Feuille de travail :</strong></label><label id="revue" style="cursor:pointer;color:red;">Rapprochement des investissements réalisés avec le budget</label>
		...
		<div id="contenue_question" style="overflow:auto;height:450px;"
			...
			>
				<label><strong>Question 1 :</strong></label><br />
				<label>Un rapprochement des investissements réalisés avec le budget a-t-il été réalisé ?</label>
				...
				<label><strong>Question 2 :</strong></label><br />
				<label>Toutes les acquisitions ont-elles été prévues par le budget ?</label>
				...
				<label><strong>Question 3 :</strong></label><br />
				<label>Les écarts significatifs sont-ils tous justifiés ?</label>
