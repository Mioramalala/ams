...
<div style="overflow:auto;height:360px;">
    ...
    <input style="float: left;height: 40px;font-size: 18px; color: #fff; background: #00698d" type="button"  id="enregistrer_echantillon" value="enregistrer"/>
	...
	<?php
			...
			debit_ech_gl,crd_ech_gl, pointage, regularite_pj, observation, renvoi
			 from tab_ehantillon_gl
			 where GL_GEN_CYCLE='".$cycle."' AND objectif='".$objectif."' AND id_mission=".$mission_id;
	...
	?>
			<tr>
				...
				<td><input type="file" name="renvoi_<?php echo $Comp.'_'.$ref ;?>" /><br>
...
<script>
      ...
      {
          $('#contenue_travail').load("RDC/immobilisationCorpIncorp/C_regularite/table_B6.php?objectif=<?php echo $objectif; ?>&Revoir_echantillon=retourechant");
      });
