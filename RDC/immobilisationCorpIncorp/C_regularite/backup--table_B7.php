	...
	<tbody>
			...
			<?php 
				...
				{ 
					...
					$sqlEchant="select prix_achat,cout,prix_achat,ec,tbl_fraixAcc_coutacquisition_immocorp.observation as 'observation' from tbl_fraixAcc_coutacquisition_immocorp 
					...
					<td> <input type="file"/ name="renvoi[]"> <?php echo $renvoi; ?> </td>
