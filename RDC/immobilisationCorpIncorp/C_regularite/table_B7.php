		  ...
		  $.ajax({
            ...
            objectif : '<?php echo $objectif; ?>'
    		  ...
    		  success:function(e){
    		   ...
    		   $('#contenue_travail').load("RDC/immobilisationCorpIncorp/C_regularite/table_new_B6.php?objectif=<?php echo $objectif;?>");
          },
          error : function(e) {
            alert("Error : " + e);
          }
  ...
  <?php 
    ...
    while($donnees=$reponse->fetch())
    {
                ...
                $sql="select id_echantillon_GL,compt_ech_gl,date_ech_gl,journal_ech_gl,ref_ech_gl,libelle_ech_gl,debit_ech_gl,crd_ech_gl,sold_ech_gl	
									...
									ref_ech_gl='$ref' AND
									id_mission='$mission_id' AND objectif='$objectif' and GL_GEN_CYCLE='B- Immobilisations incorporelles et corporelles'" ;
...
<script type="text/javascript">
  $(function()
  {
      $(document).on("click","#Revoir_echantillon",function ()
      {
          $('#contenue_travail').load("RDC/immobilisationCorpIncorp/C_regularite/table_B7.php?objectif=<?php echo $objectif; ?>&Revoir_echantillon=retourechant");
      });
...
<br>
  <label><strong>Travaux à faire :</strong>
   <br/>Analyser les produits et les charges exceptionnels relatifs aux sorties d’immobilisations</label><br /><br>
