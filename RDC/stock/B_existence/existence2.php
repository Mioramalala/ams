...
$reponse1=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="stock" and RDC_OBJECTIF="B" and MISSION_ID='.$mission_id.' and RDC_RANG=2');
...
<script>
	...
	$(function(){
		...
		$('#revue').click(function(){
			...
			$('#contenue_travail').load("RDC/stock/B_existence/table_D4.php");
		});
		...
		$('#bt_suivant').click(function(){
			...
			if((reponse1=="non" && commentaire1=="") || reponse1==""){ 
				...
				add_Data(reponse1,commentaire1,'stock','B',2,<?php echo $mission_id; ?>);
...
<table width="100%" height="50" bgcolor="#00698d" style="text-align:left;">
	<tr>
		<td class="grand_Titre"><center><label>B - EXISTENCE DES SOLDES : PARTIE  II</label></center></td>
	</tr>
</table>
<table width="100%" style="border:2px solid #ccc;" height="470">
	<tr>
		...
		<div id="contenue_travail" style="overflow:auto;height:450px;width:100%;">
			...
			<br/>Rapprocher par sondage des quantités inventoriées avec l'etat théorique des stocks.</label><br/><br/><br/>
			<label><strong>Documents et infos à obtenir</strong></label><br/>
			<label><strong></strong>Etats théoriques des stocks</label><br/><br/><br/>
			<label><strong>Question :</strong></label><br/>
			<label>A-t-on rapproché, par sondage, l'état théorique final des stocks et l'état <br/>d'inventaire physique final ?</label><br/><br/><br/>
			<label><strong>Feuille de Travail :</strong></label><label id="revue" style="cursor:pointer;color:red;">&nbsp;
			Rapprochement de l'état théorique avec le résultat des inventaires physiques des stocks</label>		
		</div>
		...
		<div id="contenue_question" style="overflow;height:450px;">
			...
			>
				<label><strong>Question :</strong></label><br />
				<label>A-t-on rapproché, par sondage, l'état théorique final des stocks et l'état d'inventaire physique final ?</label>
