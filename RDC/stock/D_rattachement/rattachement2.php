...
$reponse1=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="stock" and RDC_OBJECTIF="D" and MISSION_ID='.$mission_id.' and RDC_RANG=2');
...
$reponse2=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="stock" and RDC_OBJECTIF="D" and MISSION_ID='.$mission_id.' and RDC_RANG=3');
...
<script>
	...
	$(function(){
		...
		$('#revue').click(function(){
			...
			$('#bt_retour').hide();
			$('#rev').hide();
			// $('#contenue_travail').load("RDC/stock/D_rattachement/table_D54.php");
		});
		...
		$('#bt_suivant').click(function(){
			...
			if((reponse1=="non" && commentaire1=="") || (reponse2=="non" && commentaire2=="") || reponse1=="" || reponse2==""){ 
				...
				add_Data(reponse1,commentaire1,'stock','D',2,<?php echo $mission_id; ?>);
				add_Data(reponse2,commentaire2,'stock','D',3,<?php echo $mission_id; ?>);
				$("#contenue").load("RDC/stock/index.php");
			}
		});
	...
	function add_Data(reponse,commentaire,cycle,objectif,rang,mission_id){
		$.ajax({
			type:'POST',
			url:'RDC/stock/D_rattachement/add_Data.php',
...
<table width="100%" height="50" bgcolor="#00698d" style="text-align:left;">
	<tr>
		<td class="grand_Titre"><center><label> G - RATTACHEMENT DES OPERATIONS : PARTIE  II</label></center></td>
	</tr>
</table>
<table width="100%" style="border:2px solid #ccc;" height="470">
	<tr>
		...
		<div id="contenue_travail" style="overflow:auto;height:450px;">
			...
			<br/>Contrôler les stocks en transit.</label><br/><br/><br/>
			<label><strong>Documents et infos à obtenir</strong></label><br/>
			<label><strong>.</strong>&nbsp;Etat des stocks en transit</label><br/><br/>
			<label><strong>.</strong>&nbsp;GL des stocks</label><br/><br/><br/>
			<label><strong>Question 1 :</strong></label><br/>
			<label>A-t-on obtenu l'état des stocks en transit ?</label><br/><br/><br/>
			<label><strong>Question 2 :</strong></label><br/>
			<label>Les stocks en transit sont-ils traités correctement ?</label><br/><br/><br/>
		...
		<div>
			...
			>
				<label><strong>Question 1 :</strong></label><br />
				<label>A-t-on obtenu l'état des stocks en transit ?</label>
				...
				<label><strong>Question 2 :</strong></label><br />
				<label>Les stocks en transit sont-ils traités correctement ?</label>
