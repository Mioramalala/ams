	...
	$(function(){
		...
		$('#bt_suivant').click(function(){
			...
			if((reponse1=="non" && commentaire1=="") || reponse1==""){ 
				...
				add_Data(reponse1,commentaire1,'stock','D',1,<?php echo $mission_id; ?>);
				$('#contenue').load("RDC/stock/D_rattachement/rattachement2.php");
			}
		});
...
<table width="100%" height="50" bgcolor="#00698d" style="text-align:left;">
	<tr>
		<td class="grand_Titre"><center><label> G - RATTACHEMENT DES OPERATIONS : PARTIE I</label></center></td>
	</tr>
</table>
<table width="100%" style="border:2px solid #ccc;" height="470">
	<tr>
		...
		<div id="contenue_travail" style="overflow:auto;height:450px;">
			...
			<label><strong></strong>Fiches de stocks : derniers mouvements de clôture (N) <br />et premiers mouvements d'ouverture (N+1)</label><br/><br/><br/>
			<label><strong>Question :</strong></label><br />
			<label>Vous êtes-vous assuré de l'absence d'opération ne se rattachant pas au bon exercice ?</label><br/><br/><br/>
