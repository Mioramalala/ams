...
<script>
	...
	$(function(){
		...
		$('#synthese_feuille').click(function(){
			$('#contenue').load("RDC/stock/synthese_stock.php");
		});
		
		$('#coh').click(function(){
			$('#contenue').load("RDC/stock/A_coherence/coherence.php?coherence_visible=OK");
		});
		
		$('#coh1').click(function(){
			$('#contenue').load("RDC/stock/A_coherence/coherence1.php?coherence_visible=OK");
		});
		$('#coh2').click(function(){
			$('#contenue').load("RDC/stock/A_coherence/coherence2.php?coherence_visible=OK");
		});
		$('#coh22').click(function(){
			$('#contenue').load("RDC/stock/A_coherence/coherence2.php?coherence_visible=OK");
		});
		$('#coh3').click(function(){
			$('#contenue').load("RDC/stock/A_coherence/coherence3.php?coherence_visible=OK");
		});
		$('#coh4').click(function(){
			$('#contenue').load("RDC/stock/A_coherence/coherence4.php?coherence_visible=OK");
		});
		...
		$('#exist1').click(function(){
			$('#contenue').load("RDC/stock/B_existence/existence1.php?existence_visible=OK");
		});
		$('#exist2').click(function(){
			$('#contenue').load("RDC/stock/B_existence/existence2.php?existence_visible=OK");
		});
		$('#exist3').click(function(){
			$('#contenue').load("RDC/stock/B_existence/existence3.php?existence_visible=OK");
		});
		$('#exist4').click(function(){
			$('#contenue').load("RDC/stock/B_existence/existence4.php?existence_visible=OK");
		});
		$('#exist44').click(function(){
			$('#contenue').load("RDC/stock/B_existence/existence44.php?existence_visible=OK");
		});
		$('#eval1').click(function(){
			$('#contenue').load("RDC/stock/C_evaluation/evaluation1.php?evaluation_visible=OK");
		});
		$('#eval2').click(function(){
			$('#contenue').load("RDC/stock/C_evaluation/evaluation2.php?evaluation_visible=OK");
		});
		$('#eval22').click(function(){
			$('#contenue').load("RDC/stock/C_evaluation/evaluation2.php?evaluation_visible=OK");
		});
		$('#eval3').click(function(){
			$('#contenue').load("RDC/stock/C_evaluation/evaluation3.php?evaluation_visible=OK");
		});
		$('#eval33').click(function(){
			$('#contenue').load("RDC/stock/C_evaluation/evaluation3.php?evaluation_visible=OK");
		});
		$('#eval4').click(function(){
			$('#contenue').load("RDC/stock/C_evaluation/evaluation4.php?evaluation_visible=OK");
		});
		$('#eval44').click(function(){
			$('#contenue').load("RDC/stock/C_evaluation/evaluation4.php?evaluation_visible=OK");
		});
		$('#eval5').click(function(){
			$('#contenue').load("RDC/stock/C_evaluation/evaluation5.php?evaluation_visible=OK");
		});
		$('#eval55').click(function(){
			$('#contenue').load("RDC/stock/C_evaluation/evaluation5.php?evaluation_visible=OK");
		});
		$('#eval6').click(function(){
			$('#contenue').load("RDC/stock/C_evaluation/evaluation6.php?evaluation_visible=OK");
		});
		$('#rattach1').click(function(){
			$('#contenue').load("RDC/stock/D_rattachement/rattachement1.php?rattachement_visible=OK");
		});
		$('#rattach2').click(function(){
			$('#contenue').load("RDC/stock/D_rattachement/rattachement2.php?rattachement_visible=OK");
		});
		$('#rattach22').click(function(){
			$('#contenue').load("RDC/stock/D_rattachement/rattachement2.php?rattachement_visible=OK");
		});
		$('#jurid1').click(function(){
			$('#contenue').load("RDC/stock/E_juridique/juridique1.php?juridique_visible=OK");
		});
		$('#info1').click(function(){
			$('#contenue').load("RDC/stock/F_information/information1.php?information_visible=OK");
		});
		$('#info2').click(function(){
			$('#contenue').load("RDC/stock/F_information/information2.php?information_visible=OK");
		});
