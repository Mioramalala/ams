...
$reponse1=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="stock" and RDC_OBJECTIF="C" and MISSION_ID='.$mission_id.' and RDC_RANG=8');
...
$reponse2=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="stock" and RDC_OBJECTIF="C" and MISSION_ID='.$mission_id.' and RDC_RANG=9');
...
<script>
	...
	$(function(){
		...
		$('#revue').click(function(){
			...
			$('#bt_retour_1').hide();
			$('#rev').hide();
			// $('#contenue_travail').load("RDC/stock/C_evaluation/table_D51.php");
		});
		...
		$('#bt_suivant').click(function(){
			...
			if((reponse1=="non" && commentaire1=="") || (reponse2=="non" && commentaire2=="") || reponse1=="" || reponse2==""){ 
				...
				add_Data(reponse1,commentaire1,'stock','C',8,<?php echo $mission_id; ?>);
				add_Data(reponse1,commentaire1,'stock','C',9,<?php echo $mission_id; ?>);
				$('#contenue').load("RDC/stock/C_evaluation/evaluation6.php");
			}
		});
...
<table width="100%" height="50" bgcolor="#00698d" style="text-align:left;">
	<tr>
		<td class="grand_Titre"><center><label>F - EVALUATION DES SOLDES : PARTIE  V</label></center></td>
	</tr>
</table>
<table width="100%" style="border:2px solid #ccc;" height="470">
	<tr>
		...
		<div id="contenue_travail" style="overflow:auto;height:450px;">
			...
			<br/>Contrôler le traitement de la sur ou sous activité.</label><br/><br/><br/>
			<label><strong>Documents et infos à obtenir</strong></label><br/>
			<label><strong></strong>Etat détaillé du calcul du coût de revient (PF)</label><br/><br/><br/>
			<label><strong>Question 1 :</strong></label><br/>
			<label>Existe-t-il une comptabilité analytique permettant d'évaluer la sur ou sous-activité ?</label><br/><br/><br/>
			<label><strong>Question 2 :</strong></label><br/>
			<label>La sur ou sous activité est-elle prise en compte dans la détermination du coût de revient ?</label><br/><br/><br/>
		...
		<div>
			...
			>
				<label><strong>Question 1 :</strong></label><br />
				<label>Existe-t-il une comptabilité analytique permettant d'évaluer la sur ou sous-activité ?</label>
				...
				<label><strong>Question 2 :</strong></label><br />
				<label>La sur ou sous activité est-elle prise en compte dans la détermination du coût de revient ?</label>
