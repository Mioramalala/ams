...
$reponse1=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="stock" and RDC_OBJECTIF="C" and MISSION_ID='.$mission_id.' and RDC_RANG=2');
...
$reponse2=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="stock" and RDC_OBJECTIF="C" and MISSION_ID='.$mission_id.' and RDC_RANG=3');
...
<script>
	...
	$(function(){
		...
		$('#revue').click(function(){
			...
			$('#bt_retour_1').hide();
			$('#rev').hide();
			// $('#contenue_travail').load("RDC/stock/C_evaluation/table_D44.php");
		});
		...
		$('#bt_suivant').click(function(){
			...
			if((reponse1=="non" && commentaire1=="") || (reponse2=="non" && commentaire2=="") || reponse1=="" || reponse2==""){ 
				...
				add_Data(reponse1,commentaire1,'stock','C',2,<?php echo $mission_id; ?>);
				add_Data(reponse2,commentaire2,'stock','C',3,<?php echo $mission_id; ?>);
...
<table width="100%" height="50" bgcolor="#00698d" style="text-align:left;">
	<tr>
		<td class="grand_Titre"><center><label>F - EVALUATION DES SOLDES : PARTIE  II</label></center></td>
	</tr>
</table>
<table width="100%" style="border:2px solid #ccc;" height="470">
	<tr>
		...
		<div id="contenue_travail" style="overflow:auto;height:450px;">
			...
			<br/>Examiner la méthode de valorisation et de depréciation <br/>des stocks et en cours (stocks morts, détériorés ou obsolètes).</label><br/><br/><br/>
			<label><strong>Documents et infos à obtenir</strong></label><br/>
			<label><strong>.</strong>&nbsp;Etat extra-comptable de valorisation des stocks</label><br/><br/>
			<label><strong>.</strong>&nbsp;Fiche de calcul du prix de revient des articles</label><br/><br/>
			<label><strong>.</strong>&nbsp;Justificatifs et état des provisions pour perte de valeur</label><br/><br/><br/>
			<label><strong>Question 1 :</strong></label><br/>
			<label>Les stocks sont-ils valorisés correctement ?</label><br/><br/><br/>
			<label><strong>Question 2 :</strong></label><br/>
			<label>Les provisions pour dépréciation sont elles suffisantes et justifiées ?</label><br/><br/><br/>
		...
		<div>
			...
			>
				<label><strong>Question 1 :</strong></label><br />
				<label>Les stocks sont-ils valorisés correctement ?</label>
				...
				<label><strong>Question 2 :</strong></label><br />
				<label>Les provisions pour dépréciation sont elles suffisantes et justifiées ?</label>
