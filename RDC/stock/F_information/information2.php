...
$reponse1=$bdd->query('select RDC_COMMENTAIRE, RDC_REPONSE from tab_rdc where RDC_CYCLE="stock" and RDC_OBJECTIF="F" and MISSION_ID='.$mission_id.' and RDC_RANG=2');
...
<script>
	...
	$(function(){
		...
		$('#revue').click(function(){
			...
			$('#bt_retour_1').hide();
			$('#rev').hide();
			// $('#contenue_travail').load("RDC/stock/F_information/table_D56.php");
		});
		...
		$('#bt_suivant').click(function(){
			...
			if((reponse1=="non" && commentaire1=="") || reponse1==""){ 
				...
				add_Data(reponse1,commentaire1,'stock','F',2,<?php echo $mission_id; ?>);
				$("#contenue").load("RDC/stock/index.php");
			}
		});
...
<table width="100%" height="50" bgcolor="#00698d" style="text-align:left;">
	<tr>
		<td class="grand_Titre"><center><label>I - INFORMATION ET PRESENTATION : PARTIE  II</label></center></td>
	</tr>
</table>
<table width="100%" style="border:2px solid #ccc;" height="470">
	<tr>
		...
		<div id="contenue_travail" style="overflow:auto;height:450px;">
			...
			<br/>Information données en annexe : mode d'évaluation et de dépréciation, <br/>différence entre valeur comptable des stocks et le dernier prix du marché à la clôture.</label><br/><br/><br/>
			<label><strong>Documents et infos à obtenir</strong></label><br/>
			<label><strong></strong>Etats financiers et  notes annexes </label><br/><br/><br/>
		<label><strong>Question :</strong></label><br/>
		<label>Confirmez-vous que tous les détails des états financiers ainsi <br />que toutes les informations devant figurer dans les annexes aux états financiers y sont présentées ?</label><br/><br/><br/>
