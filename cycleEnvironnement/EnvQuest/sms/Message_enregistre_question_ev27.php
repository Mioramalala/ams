...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_ev27').click(function(){	
	if((document.getElementById("commentaire_Question_ev27").value=="" && document.getElementById("rad_Question_Non_ev_27").checked== true) || (document.getElementById("rad_Question_Oui_ev_27").checked==false  && document.getElementById("rad_Question_Non_ev_27").checked==false)){
			$('#mess_quest_vide_ev27').show();
			$('#Question_ev_451').hide();
			$('#message_fermeture_question_ev27').hide();
		}
		else{
	...
	$('#valider_Fermeture_Question_ev27').click(function(){
		$('#message_fermeture_question_ev27').hide();
		$('#fancybox_ev').hide();
		openButtObjev();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_ev27" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_ev27" />
		</td>
	</tr>
</table>
</div>