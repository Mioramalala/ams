...
$(function(){
	$('#Question_std_9_Bouton').click(function(){
		if((document.getElementById("commentaire_Question_std9").value=="" && document.getElementById("rad_Question_Non_std_9").checked== true) || (document.getElementById("rad_Question_Oui_std_9").checked==false && document.getElementById("rad_Question_NA_std_9").checked==false && document.getElementById("rad_Question_Non_std_9").checked==false)){
