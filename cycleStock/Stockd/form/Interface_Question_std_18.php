...
$(function(){
	$('#Question_std_18_Bouton').click(function(){
		if((document.getElementById("commentaire_Question_std18").value=="" && document.getElementById("rad_Question_Non_std_18").checked== true) || (document.getElementById("rad_Question_Oui_std_18").checked==false && document.getElementById("rad_Question_NA_std_18").checked==false && document.getElementById("rad_Question_Non_std_18").checked==false)){
