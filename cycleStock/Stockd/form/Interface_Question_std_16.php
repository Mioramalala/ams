...
$(function(){
	$('#Question_std_16_Bouton').click(function(){
		if((document.getElementById("commentaire_Question_std16").value=="" && document.getElementById("rad_Question_Non_std_16").checked== true) || (document.getElementById("rad_Question_Oui_std_16").checked==false && document.getElementById("rad_Question_NA_std_16").checked==false && document.getElementById("rad_Question_Non_std_16").checked==false)){
