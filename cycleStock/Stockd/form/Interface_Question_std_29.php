...
$(function(){
	$('#Question_std_29_Bouton').click(function(){
		if((document.getElementById("commentaire_Question_std29").value=="" && document.getElementById("rad_Question_Non_std_29").checked== true) || (document.getElementById("rad_Question_Oui_std_29").checked==false && document.getElementById("rad_Question_NA_std_29").checked==false && document.getElementById("rad_Question_Non_std_29").checked==false)){
...
<div id="int_Question_std_29">
	<table width="500">
		<tr style="height:10px">
			<td class="label_Question" align="center">13.<b>Autres</b><br/>
