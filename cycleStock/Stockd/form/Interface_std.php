...
<script language="javascript">
    ...
    $.ajax({
        ...
        success: function (e) {
            ...
            $("#Int_std_Continuer").attr('disabled', result);
            $("#Int_std_Synthese").attr('disabled', result);
        }
    });
...
$(function() {
			...
			success:function(e){
					...
					$.ajax({
						...
						success:function(e1){
							...
							for(i=152; i<=180; i++){  // Dans la base 180 en fait partie
								if(i==std){
									stdId= "std_"+cpt;
									stdIdCom="std"+cpt;
	...
	$('#Int_std_Synthese').click(function(){	
		...
		$.ajax({
			type:'POST',
			url:'cycleStock/Stockd/php/select_score_std.php',
			data:{mission_id:mission_id},
			success:function(e){
			    $("#echo_score_std").html(e);
			}			
		});
...
<div id="int_std"><label class="lb_veuillez" id="lb_veuillez_aff_std"><br />Veuillez répondre aux questions suivantes par OUI, N/A ou NON</label><br />
	...
	<div id="Int_Droite_std">
		...
		<input type="button" class="bouton" value="Synthèse" id="Int_std_Synthese" /><br />
		<span class="label">
...
<div id="message_fermeture_question_std"><?php include 'cycleStock/Stockd/sms/Message annulation question std.php';?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message de fermeture de toutes les question*************************-->
<div id="message_fermeture_question_std2"><?php include 'cycleStock/Stockd/sms/Message_enregistre_question_std2.php';?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message de fermeture de toutes les question*************************-->
<div id="message_fermeture_question_std3"><?php include 'cycleStock/Stockd/sms/Message_enregistre_question_std3.php';?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message de fermeture de toutes les question*************************-->
<div id="message_fermeture_question_std4"><?php include 'cycleStock/Stockd/sms/Message_enregistre_question_std4.php';?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message de fermeture de toutes les question*************************-->
<div id="message_fermeture_question_std5"><?php include 'cycleStock/Stockd/sms/Message_enregistre_question_std5.php';?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message de fermeture de toutes les question*************************-->
<div id="message_fermeture_question_std6"><?php include 'cycleStock/Stockd/sms/Message_enregistre_question_std6.php';?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message de fermeture de toutes les question*************************-->
<div id="message_fermeture_question_std7"><?php include 'cycleStock/Stockd/sms/Message_enregistre_question_std7.php';?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message de fermeture de toutes les question*************************-->
<div id="message_fermeture_question_std8"><?php include 'cycleStock/Stockd/sms/Message_enregistre_question_std8.php';?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message de fermeture de toutes les question*************************-->
<div id="message_fermeture_question_std9"><?php include 'cycleStock/Stockd/sms/Message_enregistre_question_std9.php';?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message de fermeture de toutes les question*************************-->
<div id="message_fermeture_question_std10"><?php include 'cycleStock/Stockd/sms/Message_enregistre_question_std10.php';?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message de fermeture de toutes les question*************************-->
<div id="message_fermeture_question_std11"><?php include 'cycleStock/Stockd/sms/Message_enregistre_question_std11.php';?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message de fermeture de toutes les question*************************-->
<div id="message_fermeture_question_std12"><?php include 'cycleStock/Stockd/sms/Message_enregistre_question_std12.php';?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message de fermeture de toutes les question*************************-->
<div id="message_fermeture_question_std13"><?php include 'cycleStock/Stockd/sms/Message_enregistre_question_std13.php';?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message de fermeture de toutes les question*************************-->
<div id="message_fermeture_question_std14"><?php include 'cycleStock/Stockd/sms/Message_enregistre_question_std14.php';?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message de fermeture de toutes les question*************************-->
<div id="message_fermeture_question_std15"><?php include 'cycleStock/Stockd/sms/Message_enregistre_question_std15.php';?></div>
<!--*******************************************************************************************************-->
<div id="message_fermeture_question_std16"><?php include 'cycleStock/Stockd/sms/Message_enregistre_question_std16.php';?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message de fermeture de toutes les question*************************-->
<div id="message_fermeture_question_std17"><?php include 'cycleStock/Stockd/sms/Message_enregistre_question_std17.php';?></div>
<!--*******************************************************************************************************-->

<div id="message_fermeture_question_std18"><?php include 'cycleStock/Stockd/sms/Message_enregistre_question_std18.php';?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message de fermeture de toutes les question*************************-->
<div id="message_fermeture_question_std19"><?php include 'cycleStock/Stockd/sms/Message_enregistre_question_std19.php';?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message de fermeture de toutes les question*************************-->
<div id="message_fermeture_question_std20"><?php include 'cycleStock/Stockd/sms/Message_enregistre_question_std20.php';?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message de fermeture de toutes les question*************************-->
<div id="message_fermeture_question_std21"><?php include 'cycleStock/Stockd/sms/Message_enregistre_question_std21.php';?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message de fermeture de toutes les question*************************-->
<div id="message_fermeture_question_std22"><?php include 'cycleStock/Stockd/sms/Message_enregistre_question_std22.php';?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message de fermeture de toutes les question*************************-->
<div id="message_fermeture_question_std23"><?php include 'cycleStock/Stockd/sms/Message_enregistre_question_std23.php';?></div>
<!--*******************************************************************************************************-->
<div id="message_fermeture_question_std24"><?php include 'cycleStock/Stockd/sms/Message_enregistre_question_std24.php';?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message de fermeture de toutes les question*************************-->
<div id="message_fermeture_question_std25"><?php include 'cycleStock/Stockd/sms/Message_enregistre_question_std25.php';?></div>
<!--***********************************Message de fermeture de toutes les question*************************-->
<div id="message_fermeture_question_std26"><?php include 'cycleStock/Stockd/sms/Message_enregistre_question_std26.php';?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message de fermeture de toutes les question*************************-->
<div id="message_fermeture_question_std27"><?php include 'cycleStock/Stockd/sms/Message_enregistre_question_std27.php';?></div>
<!--*******************************************************************************************************-->
<div id="message_fermeture_question_std28"><?php include 'cycleStock/Stockd/sms/Message_enregistre_question_std28.php';?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message de fermeture de toutes les question*************************-->
<div id="message_fermeture_question_std29"><?php include 'cycleStock/Stockd/sms/Message_enregistre_question_std29.php';?></div>
...
<div id="mess_quest_vide_std1"><?php include 'cycleStock/Stockd/sms/Message_question_vide.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_std2"><?php include 'cycleStock/Stockd/sms/sms_empty/Mess_quest_vide_std2.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_std3"><?php include 'cycleStock/Stockd/sms/sms_empty/Mess_quest_vide_std3.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_std4"><?php include 'cycleStock/Stockd/sms/sms_empty/Mess_quest_vide_std4.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_std5"><?php include 'cycleStock/Stockd/sms/sms_empty/Mess_quest_vide_std5.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_std6"><?php include 'cycleStock/Stockd/sms/sms_empty/Mess_quest_vide_std6.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_std7"><?php include 'cycleStock/Stockd/sms/sms_empty/Mess_quest_vide_std7.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_std8"><?php include 'cycleStock/Stockd/sms/sms_empty/Mess_quest_vide_std8.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_std9"><?php include 'cycleStock/Stockd/sms/sms_empty/Mess_quest_vide_std9.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_std10"><?php include 'cycleStock/Stockd/sms/sms_empty/Mess_quest_vide_std10.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_std11"><?php include 'cycleStock/Stockd/sms/sms_empty/Mess_quest_vide_std11.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_std12"><?php include 'cycleStock/Stockd/sms/sms_empty/Mess_quest_vide_std12.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_std13"><?php include 'cycleStock/Stockd/sms/sms_empty/Mess_quest_vide_std13.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_std14"><?php include 'cycleStock/Stockd/sms/sms_empty/Mess_quest_vide_std14.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_std15"><?php include 'cycleStock/Stockd/sms/sms_empty/Mess_quest_vide_std15.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_std16"><?php include 'cycleStock/Stockd/sms/sms_empty/Mess_quest_vide_std16.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_std17"><?php include 'cycleStock/Stockd/sms/sms_empty/Mess_quest_vide_std17.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_std18"><?php include 'cycleStock/Stockd/sms/sms_empty/Mess_quest_vide_std18.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_std19"><?php include 'cycleStock/Stockd/sms/sms_empty/Mess_quest_vide_std19.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_std20"><?php include 'cycleStock/Stockd/sms/sms_empty/Mess_quest_vide_std20.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_std21"><?php include 'cycleStock/Stockd/sms/sms_empty/Mess_quest_vide_std21.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_std22"><?php include 'cycleStock/Stockd/sms/sms_empty/Mess_quest_vide_std22.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_std23"><?php include 'cycleStock/Stockd/sms/sms_empty/Mess_quest_vide_std23.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_std24"><?php include 'cycleStock/Stockd/sms/sms_empty/Mess_quest_vide_std24.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_std25"><?php include 'cycleStock/Stockd/sms/sms_empty/Mess_quest_vide_std25.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_std26"><?php include 'cycleStock/Stockd/sms/sms_empty/Mess_quest_vide_std26.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_std27"><?php include 'cycleStock/Stockd/sms/sms_empty/Mess_quest_vide_std27.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_std28"><?php include 'cycleStock/Stockd/sms/sms_empty/Mess_quest_vide_std28.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_std29"><?php include 'cycleStock/Stockd/sms/sms_empty/Mess_quest_vide_std29.php'; ?></div>


<!--*************************************Message vide resultat b*******************************************-->
<div id="mess_vide_obj_std"><?php include 'cycleStock/Stockd/sms/mess_vid_aud_std.php'; ?></div>
<!--*******************************************************************************************************-->
