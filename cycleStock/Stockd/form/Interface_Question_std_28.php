...
$(function(){
	$('#Question_std_28_Bouton').click(function(){
		if((document.getElementById("commentaire_Question_std28").value=="" && document.getElementById("rad_Question_Non_std_28").checked== true) || (document.getElementById("rad_Question_Oui_std_28").checked==false && document.getElementById("rad_Question_NA_std_28").checked==false && document.getElementById("rad_Question_Non_std_28").checked==false)){
	...
	<table width="500">
		<tr style="height:10px">
			<td class="label_Question" align="center">
				12.Le système de suivi des stocks permet-il d'identifier régulièrement :<br/>c)	les stocks à marge insuffisante ?
			</td>
		</tr>
		<tr style="height:10px">
