...
$(function(){
	$('#Question_std_12_Bouton').click(function(){
		if((document.getElementById("commentaire_Question_std12").value=="" && document.getElementById("rad_Question_Non_std_12").checked== true) || (document.getElementById("rad_Question_Oui_std_12").checked==false && document.getElementById("rad_Question_NA_std_12").checked==false && document.getElementById("rad_Question_Non_std_12").checked==false)){
...
<div id="int_Question_std_12">
	<table width="500">
		<tr style="height:10px">
			<td class="label_Question" align="center">6.Les écarts entre coûts standards et coûts réels sont-ils :<br/>b)	analysés ?
			</td>
		</tr>
		<tr style="height:10px">
