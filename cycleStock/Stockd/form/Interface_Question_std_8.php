...
$(function(){
	$('#Question_std_8_Bouton').click(function(){
		if((document.getElementById("commentaire_Question_std8").value=="" && document.getElementById("rad_Question_Non_std_8").checked== true) || (document.getElementById("rad_Question_Oui_std_8").checked==false && document.getElementById("rad_Question_NA_std_8").checked==false && document.getElementById("rad_Question_Non_std_8").checked==false)){
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:159, mission_id:mission_id, cycleId:13},
							success:function(e1){
								eo=""+e1+"";
								doc=eo.split(',');
