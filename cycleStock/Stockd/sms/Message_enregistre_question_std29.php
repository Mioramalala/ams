...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_std29').click(function(){	
	if((document.getElementById("commentaire_Question_std29").value=="") || (document.getElementById("rad_Question_Oui_std_29").checked==false && document.getElementById("rad_Question_NA_std_29").checked==false && document.getElementById("rad_Question_Non_std_29").checked==false)){
			...
			$('#message_fermeture_question_std29').hide();
		}
		else{
	...
	$('#valider_Fermeture_Question_std29').click(function(){
		$('#message_fermeture_question_std29').hide();
		$('#fancybox_std').hide();
		openButtObjstd();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_std29" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_std29" />
		</td>
	</tr>
</table>
</div>