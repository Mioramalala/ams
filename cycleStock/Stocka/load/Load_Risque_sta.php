...
<table>
	...
	?>	
			<td class="titre" width="100" align="center">
				<select id="risque_sta<?php echo $cpt; ?>" onchange="select_risque_sta(this.id,<?php echo $donnees['POSTE_CYCLE_ID']; ?>,<?php echo $mission_id;?>,<?php echo $cpt; ?>)" <?php if($conclusionId!=0) echo 'disabled'; ?> >
