...
$(function(){
	$('#Question_stc_8_Bouton').click(function(){
		...
		if((document.getElementById("commentaire_Question_stc8").value=="" && document.getElementById("rad_Question_Non_stc_8").checked== true) || (document.getElementById("rad_Question_Oui_stc_8").checked==false && document.getElementById("rad_Question_NA_stc_8").checked==false && document.getElementById("rad_Question_Non_stc_8").checked==false)){
				...
				success:function(e){
					...
					if(e==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:142, mission_id:mission_id, cycleId:12},
							success:function(e1){
								eo=""+e1+"";
								doc=eo.split(',');
...
<div id="int_Question_stc_8">
	<table width="500">
		<tr style="height:10px">
			<td class="label_Question" align="center">4.Si des inventaires tournants sont effectués :<br/>a)	existe-t-il un programme qui permet de suivre l'avancement des comptages ?</td>
		</tr>
		<tr style="height:10px">
