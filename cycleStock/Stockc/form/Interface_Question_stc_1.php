...
$(function(){
	$('#Question_stc_1_Bouton').click(function(){
		...
		if((document.getElementById("commentaire_Question_stc1").value==""&& document.getElementById("rad_Question_Non_stc_1").checked== true) || (document.getElementById("rad_Question_Oui_stc_1").checked==false && document.getElementById("rad_Question_NA_stc_1").checked==false && document.getElementById("rad_Question_Non_stc_1").checked==false)){
