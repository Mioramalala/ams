...
$(function(){
	$('#Question_stc_10_Bouton').click(function(){
		...
		if((document.getElementById("commentaire_Question_stc10").value=="" && document.getElementById("rad_Question_Non_stc_10").checked== true) || (document.getElementById("rad_Question_Oui_stc_10").checked==false && document.getElementById("rad_Question_NA_stc_10").checked==false && document.getElementById("rad_Question_Non_stc_10").checked==false)){
...
<div id="int_Question_stc_10">
	<table width="500">
		<tr style="height:10px">
			<td class="label_Question" align="center">4.Si des inventaires tournants sont effectués :<br/>c)	les mouvements physiques et comptables sont-ils arrêtés simultanément pour chaque produit compté ?
			</td>
		</tr>
		<tr style="height:10px">
