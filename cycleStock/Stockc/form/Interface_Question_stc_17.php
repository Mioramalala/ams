...
$(function(){
	$('#Question_stc_17_Bouton').click(function(){
		...
		if((document.getElementById("commentaire_Question_stc17").value=="" && document.getElementById("rad_Question_Non_stc_17").checked== true) || (document.getElementById("rad_Question_Oui_stc_17").checked==false && document.getElementById("rad_Question_NA_stc_17").checked==false && document.getElementById("rad_Question_Non_stc_17").checked==false)){
...
<div id="int_Question_stc_17">
	<table width="500" onclick="changecouleur()" id="tab17">
		<tr style="height:10px">
			<td class="label_Question" align="center">8.Les stocks détenus pour le compte de tiers sont-ils :<br/>b)	confirmés régulièrement avec les tiers ?</td>
		</tr>
		<tr style="height:10px">
