...
$(function(){
	$('#Question_stc_13_Bouton').click(function(){
		...
		if((document.getElementById("commentaire_Question_stc13").value=="" && document.getElementById("rad_Question_Non_stc_13").checked== true) || (document.getElementById("rad_Question_Oui_stc_13").checked==false && document.getElementById("rad_Question_NA_stc_13").checked==false && document.getElementById("rad_Question_Non_stc_13").checked==false)){
...
<div id="int_Question_stc_13">
	<table width="500">
		<tr style="height:10px">
			<td class="label_Question" align="center">6.Les écarts éventuels sont-ils :<br/>b)	enregistrés sur les fiches de stocks après autorisation par un responsable ?</td>
		</tr>
		<tr style="height:10px">
