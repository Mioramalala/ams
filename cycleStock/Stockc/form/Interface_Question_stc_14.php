...
$(function(){
	$('#Question_stc_14_Bouton').click(function(){
		...
		if((document.getElementById("commentaire_Question_stc14").value=="" && document.getElementById("rad_Question_Non_stc_14").checked== true) || (document.getElementById("rad_Question_Oui_stc_14").checked==false && document.getElementById("rad_Question_NA_stc_14").checked==false && document.getElementById("rad_Question_Non_stc_14").checked==false)){
...
<div id="int_Question_stc_14">
	<table width="500">
		<tr style="height:10px">
			<td class="label_Question" align="center">7.Les stocks détenus par des tiers sont-ils :<br/>a)	suivis sur des fiches de stocks distinctes ?</td>
		</tr>
		<tr style="height:10px">
