...
$(function(){
	$('#Question_stc_7_Bouton').click(function(){
		...
		if((document.getElementById("commentaire_Question_stc7").value=="" && document.getElementById("rad_Question_Non_stc_7").checked== true) || (document.getElementById("rad_Question_Oui_stc_7").checked==false && document.getElementById("rad_Question_NA_stc_7").checked==false && document.getElementById("rad_Question_Non_stc_7").checked==false)){
...
<div id="int_Question_stc_7">
	<table width="500">
		<tr style="height:10px">
			<td class="label_Question" align="center">3.Si l'inventaire est réalisé en une seule fois, les procédures d'inventaire sont-elles fiables (voir questionnaire spécial) ?</td>
		</tr>
		<tr style="height:10px">
