...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_stc7').click(function(){	
	if((document.getElementById("commentaire_Question_stc7").value=="") || (document.getElementById("rad_Question_Oui_stc_7").checked==false && document.getElementById("rad_Question_NA_stc_7").checked==false && document.getElementById("rad_Question_Non_stc_7").checked==false)){
			...
			$('#message_fermeture_question_stc7').hide();
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:141},
							success:function(){
								$.ajax({
									type:'POST',
	...
	$('#valider_Fermeture_Question_stc7').click(function(){
		$('#message_fermeture_question_stc7').hide();
		$('#fancybox_stc').hide();
		openButtObjstc();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_stc7" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_stc7" />
		</td>
	</tr>
</table>
</div>