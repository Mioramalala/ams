...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_stc17').click(function(){
if((document.getElementById("commentaire_Question_stc17").value=="") || (document.getElementById("rad_Question_Oui_stc_17").checked==false && document.getElementById("rad_Question_NA_stc_17").checked==false && document.getElementById("rad_Question_Non_stc_17").checked==false)){
			...
			$('#message_fermeture_question_stc17').hide();
		}
		else{
	...
	$('#valider_Fermeture_Question_stc17').click(function(){
		$('#message_fermeture_question_stc17').hide();
		$('#fancybox_stc').hide();
		openButtObjstc();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_stc17" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_stc17" />
		</td>
	</tr>
</table>
</div>