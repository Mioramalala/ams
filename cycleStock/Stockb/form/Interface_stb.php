...
$.ajax({
    ...
    success: function (e) {
        ...
        $("#Int_stb_Continuer").attr('disabled', result);
        $("#Int_stb_Synthese").attr('disabled', result);
    }
});
$(function(){
	$("#boo").draggable({
	...
	$('#Int_stb_Continuer').click(function(){
		...
		$.ajax({
			type:'POST',
			url:'cycleStock/Stockb/php/aff_quest_fin_stb.php',
			...
			success:function(e){
					...
					$.ajax({
						type:'POST',
						url:'cycleStock/Stockb/php/getRepContinuer.php',
						data:{mission_id:mission_id, questId:e, cycleId:11},
						success:function(e1)
						{
							...
							{ 
								if(i==stb)
								{
									stbId="stb_"+cpt;
									stbIdCom="stb"+cpt;
									afficheReponseQuest(stbId,stbIdCom);
									break;
								}
								cpt++;
							}//FIN FON
	...
	$('#Int_stb_Synthese').click(function(){	
		...
		$.ajax({
			type:'POST',
			url:'cycleStock/Stockb/php/select_score_stb.php',
			data:{mission_id:mission_id},
			success:function(e){
			    $("#echo_score_stb").html(e);
			}			
		});
...
function afficheReponseQuest(stbId,stbIdCom){
	document.getElementById("rad_Question_Oui_"+stbId).checked=false;
	document.getElementById("rad_Question_NA_"+stbId).checked=false;
	document.getElementById("rad_Question_Non_"+stbId).checked=false;
	if(doc[0]==0){
		document.getElementById("commentaire_Question_"+stbIdCom).value="";
	}
	else
		document.getElementById("commentaire_Question_"+stbIdCom).value=doc[0];
	if(doc[1]=='OUI'){
		document.getElementById("rad_Question_Oui_"+stbId).checked=true;
	}
	else if(doc[1]=='N/A'){
		document.getElementById("rad_Question_NA_"+stbId).checked=true;
	}
	else if(doc[1]=='NON'){
		document.getElementById("rad_Question_Non_"+stbId).checked=true;
	}
}
</script>
...
<div id="int_stb"><label class="lb_veuillez" id="lb_veuillez_aff_stb"><br />Veuillez répondre aux questions suivantes par OUI, N/A ou NON</label><br />
	...
	<div id="Int_Droite_stb">
		...
		<input type="button" class="bouton" value="Synthèse" id="Int_stb_Synthese" /><br />
		<span class="label">
...
<?php include 'cycleStock/Stockb/form/Interface_stb_Synthese.php';?></div>
<!--*******************************************************************************************************-->
...
<div id="mess_quest_vide_stb1"><?php include 'cycleStock/Stockb/sms/Message_question_vide.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_stb2"><?php include 'cycleStock/Stockb/sms/sms_empty/Mess_quest_vide_stb2.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_stb3"><?php include 'cycleStock/Stockb/sms/sms_empty/Mess_quest_vide_stb3.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_stb4"><?php include 'cycleStock/Stockb/sms/sms_empty/Mess_quest_vide_stb4.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_stb5"><?php include 'cycleStock/Stockb/sms/sms_empty/Mess_quest_vide_stb5.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_stb6"><?php include 'cycleStock/Stockb/sms/sms_empty/Mess_quest_vide_stb6.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_stb7"><?php include 'cycleStock/Stockb/sms/sms_empty/Mess_quest_vide_stb7.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_stb8"><?php include 'cycleStock/Stockb/sms/sms_empty/Mess_quest_vide_stb8.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_stb9"><?php include 'cycleStock/Stockb/sms/sms_empty/Mess_quest_vide_stb9.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_stb10"><?php include 'cycleStock/Stockb/sms/sms_empty/Mess_quest_vide_stb10.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_stb11"><?php include 'cycleStock/Stockb/sms/sms_empty/Mess_quest_vide_stb11.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_stb12"><?php include 'cycleStock/Stockb/sms/sms_empty/Mess_quest_vide_stb12.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_stb13"><?php include 'cycleStock/Stockb/sms/sms_empty/Mess_quest_vide_stb13.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_stb14"><?php include 'cycleStock/Stockb/sms/sms_empty/Mess_quest_vide_stb14.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_stb15"><?php include 'cycleStock/Stockb/sms/sms_empty/Mess_quest_vide_stb15.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_stb16"><?php include 'cycleStock/Stockb/sms/sms_empty/Mess_quest_vide_stb16.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_stb17"><?php include 'cycleStock/Stockb/sms/sms_empty/Mess_quest_vide_stb17.php'; ?></div>
<!--*******************************************************************************************************-->
<!--***********************************Message question vide B2***********************************************-->
<div id="mess_quest_vide_stb18"><?php include 'cycleStock/Stockb/sms/sms_empty/Mess_quest_vide_stb18.php'; ?></div>
<!--*******************************************************************************************************-->
