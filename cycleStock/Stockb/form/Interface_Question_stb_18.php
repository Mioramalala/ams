...
$(function(){
	$('#Question_stb_18_Bouton').click(function(){
		...
		if((document.getElementById("commentaire_Question_stb18").value=="" && document.getElementById("rad_Question_Non_stb_18").checked== true) || (document.getElementById("rad_Question_Oui_stb_18").checked==false && document.getElementById("rad_Question_NA_stb_18").checked==false && document.getElementById("rad_Question_Non_stb_18").checked==false)){
...
<div id="int_Question_stb_18">
	<table width="500">
		<tr style="height:10px">
			<td class="label_Question" align="center">7.Si les contrôles ci-dessus sont faits par informatique, les rapports d’anomalies font-ils l’objet d’un contrôle permettant de s’assurer qu’elles sont toutes retraitées ?</td>
		</tr>
		<tr style="height:10px">
