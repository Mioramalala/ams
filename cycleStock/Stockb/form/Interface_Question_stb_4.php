...
$(function(){
	$('#Question_stb_4_Bouton').click(function(){
		...
		if((document.getElementById("commentaire_Question_stb4").value=="" && document.getElementById("rad_Question_Non_stb_4").checked== true) || (document.getElementById("rad_Question_Oui_stb_4").checked==false && document.getElementById("rad_Question_NA_stb_4").checked==false && document.getElementById("rad_Question_Non_stb_4").checked==false)){
...
<div id="int_Question_stb_4">
	<table width="500">
		<tr style="height:10px">
			<td class="label_Question" align="center">1.Les mouvements de stocks suivants sont-ils saisis sur des documents standards au moment où ils ont lieu :<br/>d) transferts de la production vers les magasins de produits finis ?</td>
		</tr>
		<tr style="height:10px">
