...
$(function(){
	$('#Question_stb_17_Bouton').click(function(){
		...
		if((document.getElementById("commentaire_Question_stb17").value=="" && document.getElementById("rad_Question_Non_stb_17").checked== true) || (document.getElementById("rad_Question_Oui_stb_17").checked==false && document.getElementById("rad_Question_NA_stb_17").checked==false && document.getElementById("rad_Question_Non_stb_17").checked==false)){
...
<div id="int_Question_stb_17">
	<table width="500">
		<tr style="height:10px">
			<td class="label_Question" align="center">6.Si oui, les informations correspondantes sont-elles saisies immédiatement :<br/>b)	dans le stock théorique ?
</td>
		</tr>
		<tr style="height:10px">
