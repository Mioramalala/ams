...
$(function(){
	$('#Question_stb_11_Bouton').click(function(){
		...
		if((document.getElementById("commentaire_Question_stb11").value=="" && document.getElementById("rad_Question_Non_stb_11").checked== true) || (document.getElementById("rad_Question_Oui_stb_11").checked==false && document.getElementById("rad_Question_NA_stb_11").checked==false && document.getElementById("rad_Question_Non_stb_11").checked==false)){
...
<div id="int_Question_stb_11">
	<table width="500">
		<tr style="height:10px">
			<td class="label_Question" align="center">3.La séquence numérique de ces documents est-elle utilisée pour :<br/>b)	vérifier que tous les mouvements sont enregistrés ?
</td>
		</tr>
		<tr style="height:10px">
