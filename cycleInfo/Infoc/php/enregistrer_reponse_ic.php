...
if($donnees['QUESTION_ID']==$question_id){
	...
	if($reponse1) echo 'updaté enregistre response';
}
else{
	$reponse2 = $bdd->exec('INSERT INTO tab_objectif (OBJECTIF_QCM, MISSION_ID, QUESTION_ID, CYCLE_ACHAT_ID, UTIL_ID) VALUES ("'.$reponse.'","'.$_SESSION['idMission'].'",'.$question_id.',33,'.$UTIL_ID.')');
	if($reponse2) echo 'enregistré';
}
