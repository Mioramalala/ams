<?php
	...
	$reponse=$bdd->query('SELECT count(CONCLUSION_ID) as nb  FROM tab_conclusion WHERE CYCLE_ACHAT_ID=100000000 AND MISSION_ID='.$mission_id);
	$donnees=$reponse->fetch();
	$conclusionId=$donnees['nb'];

	//$nbRES=$conclusionId;
	$validatInfoA=$conclusionId;
?>
...
$(function(){
    ...
    $.ajax({
        ...
        success: function (e) {
            ...
            editable = result;
            $("input:checkbox").attr('disabled', result);
            $("#Int_ia_Suivant").attr('disabled', result);
...
<div id="message_Synthese_ia" data-options="handle:'#dragg'" align="center">
