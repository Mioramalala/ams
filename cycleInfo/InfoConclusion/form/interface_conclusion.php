...
//PARTIE I
$reponse1 = $bdd->query('SELECT SYNTHESE_COMMENTAIRE,SYNTHESE_RISQUE FROM tab_synthese WHERE MISSION_ID='.$_SESSION['idMission'].' AND CYCLE_ACHAT_ID=100 000 000');
...
<div id="dicgg" class="td_Titre_Question"><br />CONCLUSION</div>
