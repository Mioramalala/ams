<?php 
	...
	$titre = "Créances et emplois assimilés";
...
<td> -->
			<?php	
				...
				echo '&nbsp;&nbsp;<input type="checkbox" id="affichertab'.$id.'" name="affichertab'.$id.'" checked>&nbsp;<label for="affichertab'. $id.'">Afficher</label>'."</h4>";
				//echo "<p>".$texte."</p>";
...
<!-- 						<th>&nbsp;</th> -->
						<th>&nbsp;</th>
						<th width="20%" style="text-align: right;"><?php echo $N ?></th>
						<th width="20%" style="text-align: right;padding-right:2%;"><?php echo $N1 ?></th>
					</thead>
					<thead>
						<th >Rubrique</th>
					<!-- <th width="100em" style="text-align: right">Valeur brute</th>
						<th width="100em" style="text-align: right">Amortissement</th> -->
						<th width="20%" style="text-align: right;">Valeur nette</th>
						<th width="20%" style="text-align: right;padding-right:2%;">Valeur nette</th>
					</thead>
					<tbody>
					<?php
			...
			$t1=$t2 = 0;
								while($sous = $req->fetch())
								{
								  ...
								  $sql_credit = "SELECT sum(RA_SOLDE_N1) as c FROM tab_ra WHERE MISSION_ID=".$mission_id."  AND rubrique_cycle='".$rb_cycle."' AND sous_rubrique=".$sous['sous_id'];
					...
					$t2 += $c;							
									...
									<tr>
				 						...
				 						<td id="v_brute<?php  echo $j;?>" width="20%" style="text-align: right;"><?php echo number_format($d, 2, ',', ' '); ?></td>
									 	<td id="amortissement<?php  echo $j;?>" width="20%" style="text-align: right;padding-right:2%;"><?php echo number_format($c, 2, ',', ' '); ?></td>
									</tr>
						<?php 
									}
						  ?>
	...
	<!-- </div> -->
<!-- /tableau -->
<!-- </td><td class="choixaff">&nbsp;&nbsp;<input type="checkbox" id="affichertab<?php echo $id; ?>" name="affichertab<?php echo $id; ?>" checked>&nbsp;<label for="affichertab<?php echo $id; ?>">Afficher</label></td>
</tr>
<tr >
<td> -->
<!-- commentaire -->
...
<!-- /commentaire -->
<!-- </td>
<td class="choixaff">&nbsp;&nbsp;<input type="checkbox" id="affichercom<?php echo $id; ?>" name="affichercom<?php echo $id; ?>" checked>&nbsp;<label for="affichercom<?php echo $id; ?>">Afficher</label></td>
</tr>
</table> -->
<br>
	<?php
...
<script type="text/javascript">
	...
	$("#btn-preview").click(function(){
		$("#contenue_RA").load("Rap_Inter/notesAnnexes/gen_tableau/rub_creance.php?p="+cycle);
	});
