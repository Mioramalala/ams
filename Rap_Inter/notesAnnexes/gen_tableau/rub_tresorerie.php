			...
			<div class="tableau ">
				<table class="table table-hover">
					...
					<tr id="<?php echo "ligne".$idra; ?>">
						...
						<td>
							<select name="rubrique_id" id="<?php echo "rubrique".$idra; ?>" class="select_rubrique" index="<?php echo $idra; ?>" title="Rubrique">
							<option value="">&nbsp;</option>
							<?php 
							$sql = "SELECT `rubrique_id`, `rubrique_libelle`, `rubrique_cycle` FROM `tab_rubrique_notes_annexes` WHERE `rubrique_cycle` = '".$cycle."' AND `ENTREPRISE_ID` =".$identreprise." ORDER BY `rubrique_cycle` ASC ";
...
// 	//suivant attribution rubrique
	$("#generer").click(function(){
		if(rowCount > 0){
			$("#contenue_RA").load("Rap_Inter/notesAnnexes/gen_tableau/recap_N_N1tresorerie.php?p="+cycle);
		} else {
