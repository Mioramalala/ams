			...
			<div class="tableau ">
				<table class="table table-hover">
					...
					<tr id="<?php echo "ligne".$idra; ?>">
						...
						<td>
							<select name="rubrique_id" id="rubrique<?php echo $idra; ?>" class="select_rubrique" title="Rubrique">
							<option value="">&nbsp;</option>
							<?php 
								$sql1 = "select rubrique_id, rubrique_libelle FROM `tab_rubrique_notes_annexes` 
...
// 	//ajoute la ligne input on click plus
	$(".plus").click(function(){
		...
		var typeba   ="";
		// alert(typeba);
		// alert("rub: "+rubrique +" idra: "+index+" type: "+typeba);
		// //envoi ajax
		$.ajax({
			type: "post",
...
// 	//suivant attribution rubrique
	$("#generer").click(function(){
		if(rowCount > 0){
			$("#contenue_RA").load("Rap_Inter/notesAnnexes/gen_tableau/recap_N_N1provision.php?p="+cycle);
		} else {
