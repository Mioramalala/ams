...
$lienRDC="http://".$_SERVER['HTTP_HOST']."/RDC_liengenerer.php?lien=IMMO_FINANCE/".$idMission;


$feuille->setCellValue('G1', $lienRDC);
$feuille->setCellValue('F8', $lienRDC."/C_existence");
$feuille->setCellValue('F9', $lienRDC."/C_existence");
...
echo '<a id="icone_Immo_fin" href="includes/google_docs_viewer.php?id=Dossier_Rapport/Sauvegarde_sortie/Excel/Immo_fin('.$date_font.').xls&amp;nomfichier=" TARGET="_BLANK"><img src="Dossier_Rapport/img/Excel.png" height="28px" width="28px"/></a>';
