 ...
 */
	...
	================================================ */
    include('PDF_Environement_Control.php');    
    ...
    try
    {
       ...
       // $html2pdf->pdf->IncludeJS("print(true);");//fenêtre imprimer
        ...
        $html2pdf->Output('../../../Sauvegarde_sortie/PDF/cycle_achat('.$DATE_PIECES.').pdf','F');
echo '<a href="Dossier_Rapport/Sauvegarde_sortie/PDF/cycle_achat('.$DATE_PIECES.').pdf" TARGET="_BLANK"><img src="Dossier_Rapport/img/telecharger.png" height="28px" width="28px"/></a>';
