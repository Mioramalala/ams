...
$lienRA="http://".$_SERVER['HTTP_HOST']."/RA_liengenerer.php?lien=PLANIF_GENERAL/".$idMission;
...
echo '<a id="icone_planif" href="includes/google_docs_viewer.php?id=Dossier_Rapport/Sauvegarde_sortie/Word/Planification_generale('.$DATE_Planification_generale.').docx&amp;nomfichier=" TARGET="_BLANK"><img src="Dossier_Rapport/img/telecharger.png" height="28px" width="28px"/></a>';
/*
