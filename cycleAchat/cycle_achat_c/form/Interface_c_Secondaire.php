...
$(document).ready(function() {
	...
	$('#Int_Synthese_c').draggable();
	$('#Question_c_23').draggable();
	$('#Question_c_24').draggable();
	$('#Question_c_25').draggable();
	$('#Question_c_26').draggable();
	$('#Question_c_27').draggable();
	$('#Question_c_28').draggable();
	$('#Question_c_29').draggable();
	$('#Question_c_30').draggable();
	$('#Question_c_31').draggable();
	$('#Question_c_32').draggable();
	$('#Question_c_33').draggable();
...
<!--**************************************Affichage de A.************************************************-->
<div id="interface_c" align="center"><?php include 'Interface_c.php'; ?></div>
<!--*****************************************************************************************************-->
</body>
</html>