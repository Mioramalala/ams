...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_c3').click(function(){	
	if((document.getElementById("commentaire_Question_c3").value=="") || (document.getElementById("rad_Question_Oui_c_3").checked==false && document.getElementById("rad_Question_NA_c_3").checked==false && document.getElementById("rad_Question_Non_c_3").checked==false)){
			...
			$('#Question_c_25').hide();
			$('#message_fermeture_question_c3').hide();
		}
		else{
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:25},
							success:function(){
								$.ajax({
									type:'POST',
	...
	$('#valider_Fermeture_Question_c3').click(function(){
		$('#message_fermeture_question_c3').hide();
		$('#fancybox_c').hide();
		openButtObjc();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_c3" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_c3" />
		</td>
	</tr>
</table>
</div>