...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_c8').click(function(){	
	if((document.getElementById("commentaire_Question_c8").value=="") || (document.getElementById("rad_Question_Oui_c_8").checked==false && document.getElementById("rad_Question_NA_c_8").checked==false && document.getElementById("rad_Question_Non_c_8").checked==false)){
			...
			$('#Question_c_30').hide();
			$('#message_fermeture_question_c8').hide();
		}
		else{
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:30},
							success:function(){
								$.ajax({
									type:'POST',
	...
	$('#valider_Fermeture_Question_c8').click(function(){
		$('#message_fermeture_question_c8').hide();
		$('#fancybox_c').hide();
		openButtObjc();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_c8" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_c8" />
		</td>
	</tr>
</table>
</div>