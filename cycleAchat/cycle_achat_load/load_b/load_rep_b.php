...
<p>Tinay mandalo ato load_rep_b.php</p>
...
<?php
  ...
  $reponse=$bdd->query('SELECT QUESTION_LIBELLE, OBJECTIF_QCM, OBJECTIF_COMMENTAIRE, OBJECTIF_ID FROM tab_objectif INNER JOIN tab_question ON tab_objectif.QUESTION_ID=tab_question.QUESTION_ID WHERE MISSION_ID= "' .$mission_id .'" AND CYCLE_ACHAT_ID=2 ORDER BY tab_question.QUESTION_ID ASC');
  $couleur="#fff";
  $cpt=1;
  $cptFrm=1;
...
<tr bgcolor="<?php echo $couleur;?>" <?php if ($couleur=="#fff") echo $couleur="#efefef"; else $couleur="#fff"; ?> onclick="select_tabacb(this.id,<?php echo $cpt; ?>,<?php echo $mission_id;?>, <?php echo $cptFrm;?>)" id="tab<?php echo $cpt; ?>" height="50">
