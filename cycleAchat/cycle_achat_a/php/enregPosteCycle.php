...
for($i=0; $i<count($tab); $i++){
	...
	$reponse=$bdd->query('SELECT POSTE_CYCLE_ID FROM tab_poste_cycle WHERE POSTE_CLE_ID='.$tab[$i].' AND MISSION_ID='.$mission_id.' AND ENTREPRISE_ID='.$entrepiseId.' AND POSTE_CYCLE_NOM="achat"');
