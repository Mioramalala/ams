...
$reponse2=$bdd->exec('INSERT INTO tab_poste_cycle (POSTE_CYCLE_NOM, POSTE_CLE_ID, MISSION_ID, ENTREPRISE_ID, UTIL_ID) VALUE ("achat",'.$posteCleId.','.$mission_id.','.$entrepiseId.','.$UTIL_ID.')');
