...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_d12').click(function(){	
	if((document.getElementById("commentaire_Question_d12").value=="") || (document.getElementById("rad_Question_Oui_d_12").checked==false && document.getElementById("rad_Question_NA_d_12").checked==false && document.getElementById("rad_Question_Non_d_11").checked==false)){
			$('#mess_quest_vide_d12').show();
			$('#Question_d_45').hide();
			$('#message_fermeture_question_d12').hide();
		}
		else{
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:45},
							success:function(){
								$.ajax({
									type:'POST',
	...
	$('#valider_Fermeture_Question_d12').click(function(){
		$('#message_fermeture_question_d12').hide();
		$('#fancybox_d').hide();
		openButtObjd();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_d12" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_d12" />
		</td>
	</tr>
</table>
</div>