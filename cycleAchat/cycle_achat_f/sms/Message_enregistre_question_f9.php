...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_f9').click(function(){	
	if((document.getElementById("commentaire_Question_f9").value=="") || (document.getElementById("rad_Question_Oui_f_9").checked==false && document.getElementById("rad_Question_NA_f_9").checked==false && document.getElementById("rad_Question_Non_f_9").checked==false)){
			...
			$('#message_fermeture_question_f9').hide();
			$('#Question_f_63').hide();
		}
		else{
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:63},
							success:function(){
								$.ajax({
									type:'POST',
	...
	$('#valider_Fermeture_Question_f9').click(function(){
		$('#message_fermeture_question_f9').hide();
		$('#fancybox_f').hide();
		openButtObjf();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_f9" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_f9" />
		</td>
	</tr>
</table>
</div>