...
<html>
    <head>
        ...
        <script>
            $(document).ready(function () {
                ...
                $('#Int_Synthese_f').draggable();
                $('#Question_f_55').draggable();
                $('#Question_f_56').draggable();
                $('#Question_f_57').draggable();
                $('#Question_f_58').draggable();
                $('#Question_f_59').draggable();
                $('#Question_f_60').draggable();
                $('#Question_f_61').draggable();
                $('#Question_f_62').draggable();
                $('#Question_f_63').draggable();
                $('#Question_f_64').draggable();
                $('#Question_f_65').draggable();
                $('#Question_f_66').draggable();
                $('#Question_f_67').draggable();
                $('#Question_f_68').draggable();
                $('#Question_f_69').draggable();
    ...
    <body>
        ...
        <!--**************************************Affichage de A.************************************************-->
        <div id="interface_f" align="center"><?php include 'Interface_f.php'; ?></div>
        <!--*****************************************************************************************************-->
    </body>
</html>