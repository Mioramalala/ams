...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_acb8').click(function(){	
	// tinay editer
	...
	if((document.getElementById("commentaire_Question_acb8").value=="" && document.getElementById("rad_Question_Non_acb_8").checked==true) || (document.getElementById("rad_Question_Oui_acb_8").checked==false && document.getElementById("rad_Question_NA_acb_8").checked==false && document.getElementById("rad_Question_Non_acb_8").checked==false)){		
			...
			$('#message_fermeture_question_acb8').hide();
	...
	$('#valider_Fermeture_Question_acb8').click(function(){
		$('#message_fermeture_question_acb8').hide();
		$('#fancybox_acb').hide();
		openButtObjacb();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_acb8" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_acb8" />
		</td>
	</tr>
</table>
</div>