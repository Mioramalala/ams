...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_acb15').click(function(){
	...
	if((document.getElementById("commentaire_Question_acb15").value=="" && document.getElementById("rad_Question_Non_acb_15").checked== true) || (document.getElementById("rad_Question_Oui_acb_15").checked==false && document.getElementById("rad_Question_NA_acb_15").checked==false && document.getElementById("rad_Question_Non_acb_15").checked==false)){
			...
			$('#Question_acb_81').hide();
			$('#message_fermeture_question_acb15').hide();
		}
		else{
	...
	$('#valider_Fermeture_Question_acb15').click(function(){
		$('#message_fermeture_question_acb15').hide();
		$('#fancybox_acb').hide();
		openButtObjacb();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_acb15" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_acb15" />
		</td>
	</tr>
</table>
</div>