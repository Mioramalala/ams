...
$(function(){
	...
	$('#Question_acb_7_Bouton').click(function(){
		//tinay editer
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:7, mission_id:mission_id, cycleId:2},
							...
							success:function(e1){
								...
								afficheReponseQuest("acb_8","acb8");
	...
	$('#int_acb_Question_Precedent_7').click(function(){
	...
	$('#fermer_Question_acb_7').click(function(){

		$('#message_fermeture_question_acb7').show();
...
a)	bons de réception ?
		...
		<tr>
			...
			Oui<input type="radio" id="rad_Question_Oui_acb_7" name="rad_Question_acb7" <?php if($qcm=="OUI") echo 'checked'; ?> />&nbsp;&nbsp;&nbsp;

			N/A<input type="radio" id="rad_Question_NA_acb_7" name="rad_Question_acb7" <?php if($qcm=="N/A") echo 'checked'; ?> />&nbsp;&nbsp;&nbsp;

			Non <input type="radio" id="rad_Question_Non_acb_7" name="rad_Question_acb7" <?php if($qcm=="NON") echo 'checked'; ?> />
		...
		<tr>
			...
			<td align="center"><textarea id="commentaire_Question_acb7" rows="15" cols="50"><?php echo $commentaire; ?></textarea>
		...
		<tr>
			...
			<td align="center"><input type="button" value="Precedent" class="bouton" id="int_acb_Question_Precedent_7"/>&nbsp;&nbsp;&nbsp;

				<input type="button" value="Suivant" class="bouton" id="Question_acb_7_Bouton" />
...
<div id="fermeture_Icone_Question_acb"><img src="../cycle_achat_image/Fermer.png" id="fermer_Question_acb_7" /></div>