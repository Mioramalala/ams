...
$(function(){
	...
	$('#Question_acb_13_Bouton').click(function(){
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:13, mission_id:mission_id, cycleId:2},
							...
							success:function(e1){
								...
								afficheReponseQuest("acb_14","acb14");
	...
	$('#int_acb_Question_Precedent_13').click(function(){
	...
	$('#fermer_Question_acb_13').click(function(){

		$('#message_fermeture_question_acb13').show();
...
a)	les avoirs sont reçus ?
		...
		<tr>
			...
			Oui<input type="radio" id="rad_Question_Oui_acb_13" name="rad_Question_acb13" <?php if($qcm=="OUI") echo 'checked'; ?> />&nbsp;&nbsp;&nbsp;

			N/A<input type="radio" id="rad_Question_NA_acb_13" name="rad_Question_acb13" <?php if($qcm=="N/A") echo 'checked'; ?> />&nbsp;&nbsp;&nbsp;

			Non <input type="radio" id="rad_Question_Non_acb_13" name="rad_Question_acb13" <?php if($qcm=="NON") echo 'checked'; ?> />
		...
		<tr>
			...
			<td align="center"><textarea id="commentaire_Question_acb13" rows="15" cols="50"><?php echo $commentaire; ?></textarea>
		...
		<tr>
			...
			<td align="center"><input type="button" value="Precedent" class="bouton" id="int_acb_Question_Precedent_13"/>&nbsp;&nbsp;&nbsp;

				<input type="button" value="Suivant" class="bouton" id="Question_acb_13_Bouton" />
...
<div id="fermeture_Icone_Question_acb"><img src="../cycle_achat_image/Fermer.png" id="fermer_Question_acb_13" /></div>