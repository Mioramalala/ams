...
$(function(){
	...
	$('#Question_acb_5_Bouton').click(function(){
		//tinay editer
		//if((document.getElementById("commentaire_Question_acb5").value=="") || (document.getElementById("rad_Question_Oui_acb_5").checked==false && document.getElementById("rad_Question_NA_acb_5").checked==false && document.getElementById("rad_Question_Non_acb_5").checked==false)){
			...
			$.ajax({
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						enregistrer_commentaire_acb(commentaire, qcm, mission_id, 5);
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:5, mission_id:mission_id, cycleId:2},
							...
							success:function(e1){
								...
								afficheReponseQuest("acb_6","acb6");
			...
			$('#Question_acb_5').fadeOut(500);

			$('#Question_acb_6').fadeIn(500);
	...
	$('#int_acb_Question_Precedent_5').click(function(){
	...
	$('#fermer_Question_acb_5').click(function(){

		$('#message_fermeture_question_acb5').show();
...
a)	standard ?
		...
		<tr>
			...
			Oui<input type="radio" id="rad_Question_Oui_acb_5" name="rad_Question_acb5" <?php if($qcm=="OUI") echo 'checked'; ?> />&nbsp;&nbsp;&nbsp;

			N/A<input type="radio" id="rad_Question_NA_acb_5" name="rad_Question_acb5" <?php if($qcm=="N/A") echo 'checked'; ?> />&nbsp;&nbsp;&nbsp;

			Non <input type="radio" id="rad_Question_Non_acb_5" name="rad_Question_acb5" <?php if($qcm=="NON") echo 'checked'; ?> />
		...
		<tr>
			...
			<td align="center"><textarea id="commentaire_Question_acb5" rows="15" cols="50"><?php echo $commentaire; ?></textarea>
		...
		<tr>
			...
			<td align="center">
				...
				<input type="button" value="Precedent" class="bouton" id="int_acb_Question_Precedent_5"/>&nbsp;&nbsp;&nbsp;

					<input type="button" value="Suivant" class="bouton" id="Question_acb_5_Bouton" />
...
<div id="fermeture_Icone_Question_acb"><img src="../cycle_achat_image/Fermer.png" id="fermer_Question_acb_5" /></div>