...
$reponse = $bdd->query('SELECT * FROM tab_objectif INNER JOIN tab_question ON tab_objectif.QUESTION_ID=tab_question.QUESTION_ID WHERE MISSION_ID='.$mission_id.' AND CYCLE_ACHAT_ID=2');
$compte=0;
$couleur='#efefef';
while ($donnees = $reponse->fetch())
{
?>	<tr bgcolor="<?php if($couleur=='#efefef'){$couleur='#7da0f8'; echo '#7da0f8';} else {$couleur='#efefef';echo '#efefef';}?>" class="sous_Titre">
		<td width="550" align="left" height="40"><?php echo utf8_encode($donnees['QUESTION_LIBELLE']); ?></td>
		<td width="50" align="center"><?php echo $donnees['OBJECTIF_QCM']; ?></td>
		<td width="480" align="center"><?php echo utf8_encode($donnees['OBJECTIF_COMMENTAIRE']); ?></td>
	</tr>
<?php
$compte++;
}
