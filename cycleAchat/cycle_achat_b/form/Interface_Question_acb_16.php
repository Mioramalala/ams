...
$(function(){
	...
	$('#Question_acb_16_Bouton').click(function(){
		//tinay editer
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:16, mission_id:mission_id, cycleId:2},
							...
							success:function(e1){
								...
								afficheReponseQuest("acb_17","acb17");
	...
	$('#int_acb_Question_Precedent_16').click(function(){
	...
	$('#fermer_Question_acb_16').click(function(){

		$('#message_fermeture_question_acb16').show();
...
b)	les factures sont comptabilisées ?			
		...
		<tr>
			...
			Oui<input type="radio" id="rad_Question_Oui_acb_16" name="rad_Question_acb16" <?php if($qcm=="OUI") echo 'checked'; ?> />&nbsp;&nbsp;&nbsp;

			N/A<input type="radio" id="rad_Question_NA_acb_16" name="rad_Question_acb16" <?php if($qcm=="N/A") echo 'checked'; ?> />&nbsp;&nbsp;&nbsp;

			Non <input type="radio" id="rad_Question_Non_acb_16" name="rad_Question_acb16" <?php if($qcm=="NON") echo 'checked'; ?> />
		...
		<tr>
			...
			<td align="center"><textarea id="commentaire_Question_acb16" rows="15" cols="50"><?php echo $commentaire; ?></textarea>
		...
		<tr>
			...
			<td align="center"><input type="button" value="Precedent" class="bouton" id="int_acb_Question_Precedent_16"/>&nbsp;&nbsp;&nbsp;

				<input type="button" value="Suivant" class="bouton" id="Question_acb_16_Bouton" />
...
<div id="fermeture_Icone_Question_acb"><img src="../cycle_achat_image/Fermer.png" id="fermer_Question_acb_16" /></div>