...
echo '<a id="icone_vente" href="Dossier_Rapport/Sauvegarde_sortie/Word/RSCI_Cycle_Ventes('.$DATE_vente.').docx" TARGET="_BLANK"><img src="Dossier_Rapport/img/telecharger.png" height="28px" width="28px"/></a>';
