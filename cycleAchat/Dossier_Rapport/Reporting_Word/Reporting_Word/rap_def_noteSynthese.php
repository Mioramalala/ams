...
$document = $PHPWord->loadTemplate('Template_word/Note_de_synthese.docx');
...
$fichier ='Note_de_synthese ('.$DATE_export.').docx';
   if( file_exists ($fichier)){
		unlink($fichier);
		$document->save('../Sauvegarde_sortie/Word/Note_de_synthese ('.$DATE_export.').docx');
		}else{
		$document->save('../Sauvegarde_sortie/Word/Note_de_synthese ('.$DATE_export.').docx');
		}
...
echo '<a href="Dossier_Rapport/Sauvegarde_sortie/Word/Note_de_synthese ('.$DATE_export.').docx" TARGET="_BLANK"><img src="Dossier_Rapport/img/telecharger.png" height="28px" width="28px"/></a>';
