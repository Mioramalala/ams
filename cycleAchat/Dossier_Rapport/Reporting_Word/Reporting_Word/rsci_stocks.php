...
syntheseFinale($document, "stock", $ID_mission);
...
echo '<a id="icone_stock" href="Dossier_Rapport/Sauvegarde_sortie/Word/RSCI_Cycle_Stocks('.$DATE_stock.').docx" TARGET="_BLANK"><img src="Dossier_Rapport/img/telecharger.png" height="28px" width="28px"/></a>';
