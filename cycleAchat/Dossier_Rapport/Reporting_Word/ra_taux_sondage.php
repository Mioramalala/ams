...
echo '<a id="icone_sondage" href="Dossier_Rapport/Sauvegarde_sortie/Word/TAUX_SONDAGE(' . $DATE_GENERATION . ').docx" TARGET="_BLANK"><img src="Dossier_Rapport/img/telecharger.png" height="28px" width="28px"/></a>';
?>