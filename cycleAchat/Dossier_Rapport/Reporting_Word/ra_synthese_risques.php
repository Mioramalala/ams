...
{
    //Immobilisations
    if ($donnee['DOMAINE'] == utf8_decode("IMMOBILISATIONS Corporelles, incorporelles, financi̬res")) {
...
echo '<a id="icone_risque" href="Dossier_Rapport/Sauvegarde_sortie/Word/SYNTHESE_RISQUES_CONCEPTION_SYSTEMES(' . $DATE_GENERATION . ').docx" TARGET="_BLANK"><img src="Dossier_Rapport/img/telecharger.png" height="28px" width="28px"/></a>';
?>