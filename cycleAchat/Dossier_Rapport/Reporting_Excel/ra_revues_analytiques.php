...
echo '<a id="icone_ra" href="Dossier_Rapport/Sauvegarde_sortie/Excel/Revues_analytiques('.$date_font.').xls" TARGET="_BLANK"><img src="Dossier_Rapport/img/Excel.png" height="28px" width="28px"/></a>';