...
echo '<a id="icone_fondPropre" href="Dossier_Rapport/Sauvegarde_sortie/Excel/Fonds_propres('.$date_font.').xls" TARGET="_BLANK"><img src="Dossier_Rapport/img/Excel.png" height="28px" width="28px"/></a>';
