...
echo '<a id="icone_Paie_personnel" href="Dossier_Rapport/Sauvegarde_sortie/Excel/Paie_personnel('.$date_font.').xls" TARGET="_BLANK"><img src="Dossier_Rapport/img/Excel.png" height="28px" width="28px"/></a>';
