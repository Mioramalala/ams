...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_stb3').click(function(){	
	if((document.getElementById("commentaire_Question_stb3").value=="") || (document.getElementById("rad_Question_Oui_stb_3").checked==false && document.getElementById("rad_Question_NA_stb_3").checked==false && document.getElementById("rad_Question_Non_stb_3").checked==false)){
			...
			$('#message_fermeture_question_stb3').hide();
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:119},
							success:function(){
								$.ajax({
									type:'POST',
	...
	$('#valider_Fermeture_Question_stb3').click(function(){
		$('#message_fermeture_question_stb3').hide();
		$('#fancybox_stb').hide();
		openButtObjstb();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_stb3" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_stb3" />
		</td>
	</tr>
</table>
</div>