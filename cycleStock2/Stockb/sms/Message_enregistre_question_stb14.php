...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_stb14').click(function(){
if((document.getElementById("commentaire_Question_stb14").value=="") || (document.getElementById("rad_Question_Oui_stb_14").checked==false && document.getElementById("rad_Question_NA_stb_14").checked==false && document.getElementById("rad_Question_Non_stb_14").checked==false)){
			...
			$('#message_fermeture_question_stb14').hide();
		}
		else{
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:130},
							success:function(){
								$.ajax({
									type:'POST',
	...
	$('#valider_Fermeture_Question_stb14').click(function(){
		$('#message_fermeture_question_stb14').hide();
		$('#fancybox_stb').hide();
		openButtObjstb();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_stb14" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_stb14" />
		</td>
	</tr>
</table>
</div>