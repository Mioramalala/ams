...
$(function(){
	...
	$('#txt_Synthese_sta').click(function(){
		$('#txt_Synthese_sta').val("");
	});
});
	...
	<table width="500">
		<tr>
							...
							<table>
								<tr>
									<td class="label_Question">
										<input type="radio" class="verrou_tache16" id="rd_Synthese_sta_Faible" name="rd_Synthese_sta" <?php if($conclusionId!=0) echo 'disabled'; ?> />Faible<br />
										<input type="radio"  class="verrou_tache16" id="rd_Synthese_sta_Moyen" name="rd_Synthese_sta" <?php if($conclusionId!=0) echo 'disabled'; ?> />Moyen<br />
										<input type="radio" class="verrou_tache16" id="rd_Synthese_sta_Eleve" name="rd_Synthese_sta" <?php if($conclusionId!=0) echo 'disabled'; ?> />Elevé
									</td>
								</tr>
							</table>
						</td>
			...
			<td>
				<table>
					<tr>
						<td class="td_Titre_Question"><textarea class="verrou_tache16" id="txt_Synthese_sta" cols="40" rows="20" <?php if($conclusionId!=0) echo 'disabled'; ?> ><?php //if($commentaire=="") {echo '[Rédiger ici votre synthèse]';} else echo $commentaire;?></textarea>
						</td>
					</tr>
				</table>
			</td>
		...
		<tr>
			...
			<td>
				...
				<input type="button" id="Synthese_sta_Terminer" value="Terminer" class="bouton verrou_tache16" <?php if($conclusionId!=0) echo 'disabled'; ?> />
			</td>
		</tr>
	</table>
