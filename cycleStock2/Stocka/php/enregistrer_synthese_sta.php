...
$req='UPDATE tab_synthese SET SYNTHESE_COMMENTAIRE="'.$commentaire.'",UTIL_ID="'.$UTIL_ID.'", SYNTHESE_RISQUE="faible" WHERE MISSION_ID='.$mission_id.' AND CYCLE_ACHAT_ID=111';
echo $req;
$reponse2 = $bdd->exec($req);

$req1='UPDATE tab_synthese SET SYNTHESE_COMMENTAIRE="'.$commentaire.'",UTIL_ID="'.$UTIL_ID.'", SYNTHESE_RISQUE="faible" WHERE MISSION_ID='.$mission_id.' AND CYCLE_ACHAT_ID=111';
...
$req1='INSERT INTO tab_synthese (SYNTHESE_COMMENTAIRE, SYNTHESE_RISQUE, MISSION_ID, CYCLE_ACHAT_ID,UTIL_ID) VALUES ("'.$commentaire.'","faible",'.$mission_id.',111,'.$UTIL_ID.')';
$file = '../../../fichier/save_mission/mission.sql';
file_put_contents($file, $req1.";", FILE_APPEND | LOCK_EX);
