...
<div id="int_Question_stc_9">
	<table width="500">
		<tr style="height:10px">
			<td class="label_Question" align="center">9.Si des inventaires tournants sont effectués :<br/>b) les procédures utilisées permettent-elles de s'assurer que tous les stocks d'un même produit sont comptés en une seule fois ?
</td>
		</tr>
		<tr style="height:10px">
