...
$(function(){
	...
	$('#valid_non_vb').click(function(){
		$('#mess_vide_vente').hide();
		document.getElementById("validate_va").disabled=false;
		document.getElementById("validate_vb").disabled=false;
...
<div id="mess_non_vide_vb">
	<table width="500">
		...
		<tr>
			<td align="center">
				<input type="button" value="OK" class="bouton" id="valid_non_vb" />
			</td>
		</tr>
	</table>
</div>