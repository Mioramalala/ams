...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_vb12').click(function(){	
	if((document.getElementById("commentaire_Question_vb12").value=="") || (document.getElementById("rad_Question_Oui_vb_12").checked==false && document.getElementById("rad_Question_NA_vb_12").checked==false && document.getElementById("rad_Question_Non_vb_12").checked==false)){
			$('#mess_quest_vide_vb12').show();
			$('#Question_vb_329').hide();
			$('#message_fermeture_question_vb12').hide();
		}
		else{
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:329},
							success:function(){
								$.ajax({
									type:'POST',
	...
	$('#valider_Fermeture_Question_vb12').click(function(){
		$('#message_fermeture_question_vb12').hide();
		$('#fancybox_vb').hide();
		openButtObjvb();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_vb12" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_vb12" />
		</td>
	</tr>
</table>
</div>