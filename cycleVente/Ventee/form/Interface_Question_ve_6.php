...
$(function(){
	$('#Question_ve_6_Bouton').click(function(){
		if((document.getElementById("commentaire_Question_ve6").value=="" && document.getElementById("rad_Question_Non_ve_6").checked== true) || (document.getElementById("rad_Question_Oui_ve_6").checked==false && document.getElementById("rad_Question_NA_ve_6").checked==false && document.getElementById("rad_Question_Non_ve_6").checked==false)){
...
<div id="int_Question_ve_6">
	<table width="500">
		<tr style="height:10px">
			<td class="label_Question" align="center">5.Les contrôles réalisés en 2 et 3 ci-dessus permettent-ils de s'assurer, en fin de période, que les expéditions, les facturations et le journal des ventes sont arrêtés à la même date ?</td>
		</tr>
		<tr style="height:10px">
