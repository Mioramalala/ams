...
$(function(){
	$('#Question_ve_1_Bouton').click(function(){
		if((document.getElementById("commentaire_Question_ve1").value=="" && document.getElementById("rad_Question_Non_ve_1").checked== true) || (document.getElementById("rad_Question_Oui_ve_1").checked==false && document.getElementById("rad_Question_NA_ve_1").checked==false && document.getElementById("rad_Question_Non_ve_1").checked==false)){
