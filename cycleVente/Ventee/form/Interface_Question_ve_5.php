...
$(function(){
	$('#Question_ve_5_Bouton').click(function(){
		if((document.getElementById("commentaire_Question_ve5").value=="" && document.getElementById("rad_Question_Non_ve_5").checked== true) || (document.getElementById("rad_Question_Oui_ve_5").checked==false && document.getElementById("rad_Question_NA_ve_5").checked==false && document.getElementById("rad_Question_Non_ve_5").checked==false)){
...
<div id="int_Question_ve_5">
	<table width="500">
		<tr style="height:10px">
			<td class="label_Question" align="center">4.Les factures et avoirs sont-ils comptabilisés sans délai ?</td>
		</tr>
		<tr style="height:10px">
