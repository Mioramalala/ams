...
$(function(){
	$('#Question_ve_3_Bouton').click(function(){
		if((document.getElementById("commentaire_Question_ve3").value=="" && document.getElementById("rad_Question_Non_ve_3").checked== true) || (document.getElementById("rad_Question_Oui_ve_3").checked==false && document.getElementById("rad_Question_NA_ve_3").checked==false && document.getElementById("rad_Question_Non_ve_3").checked==false)){
...
<div id="int_Question_ve_3">
	<table width="500">
		<tr style="height:10px">
			<td class="label_Question" align="center">2.Les factures et avoirs sont-ils émis sans délais après réception des bons d'expédition et de retour ?
			</td>
		</tr>
		<tr style="height:10px">
