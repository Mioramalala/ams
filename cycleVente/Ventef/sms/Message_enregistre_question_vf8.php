...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_vf8').click(function(){	
	if((document.getElementById("commentaire_Question_vf8").value=="") || (document.getElementById("rad_Question_Oui_vf_8").checked==false && document.getElementById("rad_Question_NA_vf_8").checked==false && document.getElementById("rad_Question_Non_vf_8").checked==false)){
			$('#mess_quest_vide_vf8').show();
			$('#message_fermeture_question_vf8').hide();
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:400},
							success:function(){
								$.ajax({
									type:'POST',
	...
	$('#valider_Fermeture_Question_vf8').click(function(){
		$('#message_fermeture_question_vf8').hide();
		$('#fancybox_vf').hide();
		openButtObjvf();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_vf8" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_vf8" />
		</td>
	</tr>
</table>
</div>