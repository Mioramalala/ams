...
$(function(){
	...
	$('#int_ve_Question_Precedent_9').click(function(){
		$('#Question_ve_392').fadeOut(500);
...
<div id="int_Question_ve_7">
	<table width="500" id="t_ve_7">
		<tr style="height:10px">
			<td class="label_Question" align="center">9.Si certains de ces contrôles sont réalisés par informatique, les listings d’anomalies sont-ils régulièrement analysés ?</td>
		</tr>
		<tr style="height:10px">
		...
		<tr>
			<td align="center"><input type="button" value="Precedent" class="bouton" id="int_ve_Question_Precedent_9"/>&nbsp;&nbsp;&nbsp;
