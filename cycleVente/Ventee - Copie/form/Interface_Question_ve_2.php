...
<div id="int_Question_ve_2">
	<table width="500" id="t_ve_2">
		<tr style="height:10px">
			<td class="label_Question" align="center">2.Le service facturation s'assure-t-il qu'il reçoit sans délai :<br/>b)	tous les bons de retour ?</td>
		</tr>
		<tr style="height:10px">
