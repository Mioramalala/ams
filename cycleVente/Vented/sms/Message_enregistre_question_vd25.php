...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_vd25').click(function(){	
	if((document.getElementById("commentaire_Question_vd25").value=="") || (document.getElementById("rad_Question_Oui_vd_25").checked==false && document.getElementById("rad_Question_NA_vd_25").checked==false && document.getElementById("rad_Question_Non_f_25").checked==false)){
			$('#mess_quest_vide_vd25').show();
			$('#message_fermeture_question_vd25').hide();
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:375},
							success:function(){
								$.ajax({
									type:'POST',
	...
	$('#valider_Fermeture_Question_vd25').click(function(){
		$('#message_fermeture_question_vd25').hide();
		$('#fancybox_vd').hide();
		openButtObjvd();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_vd25" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_vd25" />
		</td>
	</tr>
</table>
</div>