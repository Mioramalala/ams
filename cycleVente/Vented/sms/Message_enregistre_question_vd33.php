...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_vd33').click(function(){	
	if((document.getElementById("commentaire_Question_vd33").value=="") || (document.getElementById("rad_Question_Oui_vd_33").checked==false && document.getElementById("rad_Question_NA_vd_33").checked==false && document.getElementById("rad_Question_Non_vd_33").checked==false)){
			$('#mess_quest_vide_vd33').show();
			$('#message_fermeture_question_vd33').hide();
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:383},
							success:function(){
								$.ajax({
									type:'POST',
	...
	$('#valider_Fermeture_Question_vd33').click(function(){
		$('#message_fermeture_question_vd33').hide();
		$('#fancybox_vd').hide();
		openButtObjvd();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_vd33" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_vd33" />
		</td>
	</tr>
</table>
</div>