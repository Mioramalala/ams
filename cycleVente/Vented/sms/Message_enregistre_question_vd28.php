...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_vd28').click(function(){	
	if((document.getElementById("commentaire_Question_vd28").value=="") || (document.getElementById("rad_Question_Oui_vd_28").checked==false && document.getElementById("rad_Question_NA_vd_28").checked==false && document.getElementById("rad_Question_Non_vd_28").checked==false)){
			$('#mess_quest_vide_vd28').show();
			$('#Question_vd_378').hide();
			$('#message_fermeture_question_vd28').hide();
		}
		else{
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:378},
							success:function(){
								$.ajax({
									type:'POST',
	...
	$('#valider_Fermeture_Question_vd28').click(function(){
		$('#message_fermeture_question_vd28').hide();
		$('#fancybox_vd').hide();
		openButtObjvd();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_vd28" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_vd28" />
		</td>
	</tr>
</table>
</div>