...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_vd12').click(function(){	
	if((document.getElementById("commentaire_Question_vd12").value=="") || (document.getElementById("rad_Question_Oui_vd_12").checked==false && document.getElementById("rad_Question_NA_vd_12").checked==false && document.getElementById("rad_Question_Non_vd_12").checked==false)){
			$('#mess_quest_vide_vd12').show();
			$('#Question_vd_362').hide();
			$('#message_fermeture_question_vd12').hide();
		}
		else{
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:362},
							success:function(){
								$.ajax({
									type:'POST',
	...
	$('#valider_Fermeture_Question_vd12').click(function(){
		$('#message_fermeture_question_vd12').hide();
		$('#fancybox_vd').hide();
		openButtObjvd();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_vd12" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_vd12" />
		</td>
	</tr>
</table>
</div>