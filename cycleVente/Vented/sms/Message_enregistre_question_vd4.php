...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_vd4').click(function(){	
	if((document.getElementById("commentaire_Question_vd4").value=="") || (document.getElementById("rad_Question_Oui_vd_4").checked==false && document.getElementById("rad_Question_NA_vd_4").checked==false && document.getElementById("rad_Question_Non_vd_4").checked==false)){
			$('#mess_quest_vide_vd4').show();
			$('#message_fermeture_question_vd4').hide();
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:354},
							success:function(){
								$.ajax({
									type:'POST',
	...
	$('#valider_Fermeture_Question_vd4').click(function(){
		$('#message_fermeture_question_vd4').hide();
		$('#fancybox_vd').hide();
		openButtObjvd();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_vd4" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_vd4" />
		</td>
	</tr>
</table>
</div>