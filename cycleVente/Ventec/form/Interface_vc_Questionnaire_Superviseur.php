...
$reponse=$bdd->query('SELECT QUESTION_LIBELLE, OBJECTIF_COMMENTAIRE, OBJECTIF_QCM FROM tab_objectif INNER JOIN tab_question ON tab_objectif.QUESTION_ID=tab_question.QUESTION_ID WHERE QUESTION_CYCLE_ACHAT=27 AND MISSION_ID='.$mission_id);
$compte=0;
$couleur='#efefef';
