...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_vc2').click(function(){	
	if((document.getElementById("commentaire_Question_vc2").value=="") || (document.getElementById("rad_Question_Oui_vc_2").checked==false && document.getElementById("rad_Question_NA_vc_2").checked==false && document.getElementById("rad_Question_Non_vc_2").checked==false)){
			$('#mess_quest_vide_vc2').show();
			$('#Question_vc_336').hide();
			$('#message_fermeture_question_vc2').hide();
		}
		else{
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:336},
							success:function(){
								$.ajax({
									type:'POST',
	...
	$('#valider_Fermeture_Question_vc2').click(function(){
		$('#message_fermeture_question_vc2').hide();
		$('#fancybox_vc').hide();
		openButtObjvc();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_vc2" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_vc2" />
		</td>
	</tr>
</table>
</div>