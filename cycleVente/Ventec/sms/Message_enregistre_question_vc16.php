...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_vc16').click(function(){
if((document.getElementById("commentaire_Question_vc16").value=="") || (document.getElementById("rad_Question_Oui_vc_16").checked==false && document.getElementById("rad_Question_NA_vc_16").checked==false && document.getElementById("rad_Question_Non_vc_16").checked==false)){
			$('#mess_quest_vide_vc16').show();
			$('#Question_vc_350').hide();
			$('#message_fermeture_question_vc16').hide();
		}
		else{
	...
	$('#valider_Fermeture_Question_vc16').click(function(){
		$('#message_fermeture_question_vc16').hide();
		$('#fancybox_vc').hide();
		openButtObjvc();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_vc16" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_vc16" />
		</td>
	</tr>
</table>
</div>