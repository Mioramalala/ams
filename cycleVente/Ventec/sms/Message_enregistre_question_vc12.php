...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_vc12').click(function(){	
	if((document.getElementById("commentaire_Question_vc12").value=="") || (document.getElementById("rad_Question_Oui_vc_12").checked==false && document.getElementById("rad_Question_NA_vc_12").checked==false && document.getElementById("rad_Question_Non_vc_12").checked==false)){
			$('#mess_quest_vide_vc12').show();
			$('#Question_vc_346').hide();
			$('#message_fermeture_question_vc12').hide();
		}
		else{
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:346},
							success:function(){
								$.ajax({
									type:'POST',
	...
	$('#valider_Fermeture_Question_vc12').click(function(){
		$('#message_fermeture_question_vc12').hide();
		$('#fancybox_vc').hide();
		openButtObjvc();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_vc12" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_vc12" />
		</td>
	</tr>
</table>
</div>