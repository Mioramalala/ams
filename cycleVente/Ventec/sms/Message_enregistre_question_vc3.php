...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_vc3').click(function(){	
	if((document.getElementById("commentaire_Question_vc3").value=="") || (document.getElementById("rad_Question_Oui_vc_3").checked==false && document.getElementById("rad_Question_NA_vc_3").checked==false && document.getElementById("rad_Question_Non_vc_3").checked==false)){
			$('#mess_quest_vide_vc3').show();
			$('#message_fermeture_question_vc3').hide();
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:337},
							success:function(){
								$.ajax({
									type:'POST',
	...
	$('#valider_Fermeture_Question_vc3').click(function(){
		$('#message_fermeture_question_vc3').hide();
		$('#fancybox_vc').hide();
		openButtObjvc();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_vc3" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_vc3" />
		</td>
	</tr>
</table>
</div>