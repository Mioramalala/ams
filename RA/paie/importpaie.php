...
{ 
	$NameFileko=$_SESSION['nom_entreprise'].$mission_id.$_FILES['file_Import_paie']['name'];
	echo $NameFileko;
?>	
	
<?php	
	$loader=$_SERVER['DOCUMENT_ROOT']."/RA/paie/uploads/".$NameFileko;
	$sourceDoc="/RA/paie/uploads/".$NameFileko;
