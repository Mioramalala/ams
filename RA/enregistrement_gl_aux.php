 <?php
		...
		$sqlA = "INSERT INTO tab_gl_aux (GL_AUX_COMPTE,GL_AUX_CODE,GL_AUX_DATE,GL_AUX_JL,GL_AUX_LIGNE,GL_AUX_REF, 	 	 	GL_AUX_LIBELLE,GL_AUX_ECHEANCE,GL_AUX_LETTRAGE,GL_AUX_DEBIT,GL_AUX_CREDIT,GL_AUX_SOLDE,GL_AUX_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUX_CHOIX_ANNEE,GL_AUX_DOCUMENT,UTIL_ID) VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]','$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]','A- Fonds propres','$mission_id','$entrepriseId','$annee','$fileName','$UTIL_ID')";
		$bdd->query($sqlA);
		...
		$sqlJ = "INSERT INTO tab_gl_aux (GL_AUX_COMPTE,GL_AUX_CODE,GL_AUX_DATE,GL_AUX_JL,GL_AUX_LIGNE,GL_AUX_REF, 	 	 	GL_AUX_LIBELLE,GL_AUX_ECHEANCE,GL_AUX_LETTRAGE,GL_AUX_DEBIT,GL_AUX_CREDIT,GL_AUX_SOLDE,GL_AUX_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUX_CHOIX_ANNEE,GL_AUX_DOCUMENT,UTIL_ID) 
		...
		$sqlB = "INSERT INTO tab_gl_aux (GL_AUX_COMPTE,GL_AUX_CODE,GL_AUX_DATE,GL_AUX_JL,GL_AUX_LIGNE,GL_AUX_REF, 	 	 	GL_AUX_LIBELLE,GL_AUX_ECHEANCE,GL_AUX_LETTRAGE,GL_AUX_DEBIT,GL_AUX_CREDIT,GL_AUX_SOLDE,GL_AUX_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUX_CHOIX_ANNEE,GL_AUX_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlC = "INSERT INTO tab_gl_aux (GL_AUX_COMPTE,GL_AUX_CODE,GL_AUX_DATE,GL_AUX_JL,GL_AUX_LIGNE,GL_AUX_REF, 	 	 	GL_AUX_LIBELLE,GL_AUX_ECHEANCE,GL_AUX_LETTRAGE,GL_AUX_DEBIT,GL_AUX_CREDIT,GL_AUX_SOLDE,GL_AUX_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUX_CHOIX_ANNEE,GL_AUX_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlD = "INSERT INTO tab_gl_aux (GL_AUX_COMPTE,GL_AUX_CODE,GL_AUX_DATE,GL_AUX_JL,GL_AUX_LIGNE,GL_AUX_REF, 	 	 	GL_AUX_LIBELLE,GL_AUX_ECHEANCE,GL_AUX_LETTRAGE,GL_AUX_DEBIT,GL_AUX_CREDIT,GL_AUX_SOLDE,GL_AUX_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUX_CHOIX_ANNEE,GL_AUX_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlE = "INSERT INTO tab_gl_aux (GL_AUX_COMPTE,GL_AUX_CODE,GL_AUX_DATE,GL_AUX_JL,GL_AUX_LIGNE,GL_AUX_REF,GL_AUX_LIBELLE,GL_AUX_ECHEANCE,GL_AUX_LETTRAGE,GL_AUX_DEBIT,GL_AUX_CREDIT,GL_AUX_SOLDE,GL_AUX_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUX_CHOIX_ANNEE,GL_AUX_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlF = "INSERT INTO tab_gl_aux (GL_AUX_COMPTE,GL_AUX_CODE,GL_AUX_DATE,GL_AUX_JL,GL_AUX_LIGNE,GL_AUX_REF,GL_AUX_LIBELLE,GL_AUX_ECHEANCE,GL_AUX_LETTRAGE,GL_AUX_DEBIT,GL_AUX_CREDIT,GL_AUX_SOLDE,GL_AUX_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUX_CHOIX_ANNEE,GL_AUX_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlG = "INSERT INTO tab_gl_aux (GL_AUX_COMPTE,GL_AUX_CODE,GL_AUX_DATE,GL_AUX_JL,GL_AUX_LIGNE,GL_AUX_REF, 	 	 	GL_AUX_LIBELLE,GL_AUX_ECHEANCE,GL_AUX_LETTRAGE,GL_AUX_DEBIT,GL_AUX_CREDIT,GL_AUX_SOLDE,GL_AUX_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUX_CHOIX_ANNEE,GL_AUX_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlH = "INSERT INTO tab_gl_aux (GL_AUX_COMPTE,GL_AUX_CODE,GL_AUX_DATE,GL_AUX_JL,GL_AUX_LIGNE,GL_AUX_REF, 	 	 	GL_AUX_LIBELLE,GL_AUX_ECHEANCE,GL_AUX_LETTRAGE,GL_AUX_DEBIT,GL_AUX_CREDIT,GL_AUX_SOLDE,GL_AUX_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUX_CHOIX_ANNEE,GL_AUX_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlI = "INSERT INTO tab_gl_aux (GL_AUX_COMPTE,GL_AUX_CODE,GL_AUX_DATE,GL_AUX_JL,GL_AUX_LIGNE,GL_AUX_REF, 	 	 	GL_AUX_LIBELLE,GL_AUX_ECHEANCE,GL_AUX_LETTRAGE,GL_AUX_DEBIT,GL_AUX_CREDIT,GL_AUX_SOLDE,GL_AUX_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUX_CHOIX_ANNEE,GL_AUX_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlK = "INSERT INTO tab_gl_aux (GL_AUX_COMPTE,GL_AUX_CODE,GL_AUX_DATE,GL_AUX_JL,GL_AUX_LIGNE,GL_AUX_REF, 	 	 	GL_AUX_LIBELLE,GL_AUX_ECHEANCE,GL_AUX_LETTRAGE,GL_AUX_DEBIT,GL_AUX_CREDIT,GL_AUX_SOLDE,GL_AUX_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUX_CHOIX_ANNEE,GL_AUX_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
