 <?php
		...
		$sqlA = "INSERT INTO tab_gl_genc6 (GL_GENC6_COMPTES,GL_GENC6_DATE,GL_GENC6_JL,GL_GENC6_REF,GL_GENC6_LIBELLE,GL_GENC6_LEFT,GL_GENC6_DEBIT,GL_GENC6_CREDIT,GL_GENC6_SOLDE,GL_GENC6_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC6_CHOIX_ANNEE,GL_GENC6_DOCUMENT,UTIL_ID)VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]','$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','A- Fonds propres','$mission_id','$entrepriseId','$annee','$fileName','$UTIL_ID')";
		$bdd->query($sqlA);
		...
		$sqlJ = "INSERT INTO tab_gl_genc6 (GL_GENC6_COMPTES,GL_GENC6_DATE,GL_GENC6_JL,GL_GENC6_REF,GL_GENC6_LIBELLE,GL_GENC6_LEFT,GL_GENC6_DEBIT,GL_GENC6_CREDIT,GL_GENC6_SOLDE,GL_GENC6_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC6_CHOIX_ANNEE,GL_GENC6_DOCUMENT,UTIL_ID) 
		...
		$sqlB = "INSERT INTO tab_gl_genc6 (GL_GENC6_COMPTES,GL_GENC6_DATE,GL_GENC6_JL,GL_GENC6_REF,GL_GENC6_LIBELLE,GL_GENC6_LEFT,GL_GENC6_DEBIT,GL_GENC6_CREDIT,GL_GENC6_SOLDE,GL_GENC6_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC6_CHOIX_ANNEE,GL_GENC6_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlC = "INSERT INTO tab_gl_genc6 (GL_GENC6_COMPTES,GL_GENC6_DATE,GL_GENC6_JL,GL_GENC6_REF,GL_GENC6_LIBELLE,GL_GENC6_LEFT,GL_GENC6_DEBIT,GL_GENC6_CREDIT,GL_GENC6_SOLDE,GL_GENC6_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC6_CHOIX_ANNEE,GL_GENC6_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlD = "INSERT INTO tab_gl_genc6 (GL_GENC6_COMPTES,GL_GENC6_DATE,GL_GENC6_JL,GL_GENC6_REF,GL_GENC6_LIBELLE,GL_GENC6_LEFT,GL_GENC6_DEBIT,GL_GENC6_CREDIT,GL_GENC6_SOLDE,GL_GENC6_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC6_CHOIX_ANNEE,GL_GENC6_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlE = "INSERT INTO tab_gl_genc6 (GL_GENC6_COMPTES,GL_GENC6_DATE,GL_GENC6_JL,GL_GENC6_REF,GL_GENC6_LIBELLE,GL_GENC6_LEFT,GL_GENC6_DEBIT,GL_GENC6_CREDIT,GL_GENC6_SOLDE,GL_GENC6_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC6_CHOIX_ANNEE,GL_GENC6_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlF = "INSERT INTO tab_gl_genc6 (GL_GENC6_COMPTES,GL_GENC6_DATE,GL_GENC6_JL,GL_GENC6_REF,GL_GENC6_LIBELLE,GL_GENC6_LEFT,GL_GENC6_DEBIT,GL_GENC6_CREDIT,GL_GENC6_SOLDE,GL_GENC6_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC6_CHOIX_ANNEE,GL_GENC6_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlG = "INSERT INTO tab_gl_genc6 (GL_GENC6_COMPTES,GL_GENC6_DATE,GL_GENC6_JL,GL_GENC6_REF,GL_GENC6_LIBELLE,GL_GENC6_LEFT,GL_GENC6_DEBIT,GL_GENC6_CREDIT,GL_GENC6_SOLDE,GL_GENC6_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC6_CHOIX_ANNEE,GL_GENC6_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlH = "INSERT INTO tab_gl_genc6 (GL_GENC6_COMPTES,GL_GENC6_DATE,GL_GENC6_JL,GL_GENC6_REF,GL_GENC6_LIBELLE,GL_GENC6_LEFT,GL_GENC6_DEBIT,GL_GENC6_CREDIT,GL_GENC6_SOLDE,GL_GENC6_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC6_CHOIX_ANNEE,GL_GENC6_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlI = "INSERT INTO tab_gl_genc6 (GL_GENC6_COMPTES,GL_GENC6_DATE,GL_GENC6_JL,GL_GENC6_REF,GL_GENC6_LIBELLE,GL_GENC6_LEFT,GL_GENC6_DEBIT,GL_GENC6_CREDIT,GL_GENC6_SOLDE,GL_GENC6_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC6_CHOIX_ANNEE,GL_GENC6_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlK = "INSERT INTO tab_gl_genc6 (GL_GENC6_COMPTES,GL_GENC6_DATE,GL_GENC6_JL,GL_GENC6_REF,GL_GENC6_LIBELLE,GL_GENC6_LEFT,GL_GENC6_DEBIT,GL_GENC6_CREDIT,GL_GENC6_SOLDE,GL_GENC6_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC6_CHOIX_ANNEE,GL_GENC6_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
