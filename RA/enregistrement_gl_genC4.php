 <?php
		...
		{
		$sqlA = "INSERT INTO tab_gl_genc4 (GL_GENC4_COMPTES,GL_GENC4_DATE,GL_GENC4_JL,GL_GENC4_REF,GL_GENC4_LIBELLE,GL_GENC4_LEFT,GL_GENC4_DEBIT,GL_GENC4_CREDIT,GL_GENC4_SOLDE,GL_GENC4_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC4_CHOIX_ANNEE,GL_GENC4_DOCUMENT,UTIL_ID)VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]','$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','A- Fonds propres','$mission_id','$entrepriseId','$annee','$fileName','$UTIL_ID')";
		$bdd->query($sqlA);
		...
		$sqlJ = "INSERT INTO tab_gl_genc4 (GL_GENC4_COMPTES,GL_GENC4_DATE,GL_GENC4_JL,GL_GENC4_REF,GL_GENC4_LIBELLE,GL_GENC4_LEFT,GL_GENC4_DEBIT,GL_GENC4_CREDIT,GL_GENC4_SOLDE,GL_GENC4_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC4_CHOIX_ANNEE,GL_GENC4_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','J- Emprunts et dettes financi&egrave;res','$mission_id','$entrepriseId','$annee','$fileName','$UTIL_ID')";
		$bdd->query($sqlJ);
		$file = '../fichier/save_mission/mission.sql';
		...
		$sqlB = "INSERT INTO tab_gl_genc4 (GL_GENC4_COMPTES,GL_GENC4_DATE,GL_GENC4_JL,GL_GENC4_REF,GL_GENC4_LIBELLE,GL_GENC4_LEFT,GL_GENC4_DEBIT,GL_GENC4_CREDIT,GL_GENC4_SOLDE,GL_GENC4_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC4_CHOIX_ANNEE,GL_GENC4_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','B- Immobilisations incorporelles et corporelles','$mission_id','$entrepriseId','$annee','$fileName','$UTIL_ID')";
		$bdd->query($sqlB);
		$file = '../fichier/save_mission/mission.sql';
		...
		$sqlC = "INSERT INTO tab_gl_genc4 (GL_GENC4_COMPTES,GL_GENC4_DATE,GL_GENC4_JL,GL_GENC4_REF,GL_GENC4_LIBELLE,GL_GENC4_LEFT,GL_GENC4_DEBIT,GL_GENC4_CREDIT,GL_GENC4_SOLDE,GL_GENC4_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC4_CHOIX_ANNEE,GL_GENC4_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','C- Immobilisations financi&egrave;res','$mission_id','$entrepriseId','$annee','$fileName','$UTIL_ID')";
		$bdd->query($sqlC);
		$file = '../fichier/save_mission/mission.sql';
		...
		$sqlD = "INSERT INTO tab_gl_genc4 (GL_GENC4_COMPTES,GL_GENC4_DATE,GL_GENC4_JL,GL_GENC4_REF,GL_GENC4_LIBELLE,GL_GENC4_LEFT,GL_GENC4_DEBIT,GL_GENC4_CREDIT,GL_GENC4_SOLDE,GL_GENC4_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC4_CHOIX_ANNEE,GL_GENC4_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','D- Stocks','$mission_id','$entrepriseId','$annee','$fileName','$UTIL_ID')";
		$bdd->query($sqlD);
		$file = '../fichier/save_mission/mission.sql';
		...
		$sqlE = "INSERT INTO tab_gl_genc4 (GL_GENC4_COMPTES,GL_GENC4_DATE,GL_GENC4_JL,GL_GENC4_REF,GL_GENC4_LIBELLE,GL_GENC4_LEFT,GL_GENC4_DEBIT,GL_GENC4_CREDIT,GL_GENC4_SOLDE,GL_GENC4_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC4_CHOIX_ANNEE,GL_GENC4_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlF = "INSERT INTO tab_gl_genc4 (GL_GENC4_COMPTES,GL_GENC4_DATE,GL_GENC4_JL,GL_GENC4_REF,GL_GENC4_LIBELLE,GL_GENC4_LEFT,GL_GENC4_DEBIT,GL_GENC4_CREDIT,GL_GENC4_SOLDE,GL_GENC4_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC4_CHOIX_ANNEE,GL_GENC4_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		//libelle amaina @ balance generale tab_imborter @ alalany idcompte
		//soldeGLivre=sommeDebit-somme credi;
		/////////////////////////////////////////////////G////////////////////////////////////////////////////////////
		...
		$sqlG = "INSERT INTO tab_gl_genc4 (GL_GENC4_COMPTES,GL_GENC4_DATE,GL_GENC4_JL,GL_GENC4_REF,GL_GENC4_LIBELLE,GL_GENC4_LEFT,GL_GENC4_DEBIT,GL_GENC4_CREDIT,GL_GENC4_SOLDE,GL_GENC4_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC4_CHOIX_ANNEE,GL_GENC4_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlH = "INSERT INTO tab_gl_genc4 (GL_GENC4_COMPTES,GL_GENC4_DATE,GL_GENC4_JL,GL_GENC4_REF,GL_GENC4_LIBELLE,GL_GENC4_LEFT,GL_GENC4_DEBIT,GL_GENC4_CREDIT,GL_GENC4_SOLDE,GL_GENC4_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC4_CHOIX_ANNEE,GL_GENC4_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlI = "INSERT INTO tab_gl_genc4 (GL_GENC4_COMPTES,GL_GENC4_DATE,GL_GENC4_JL,GL_GENC4_REF,GL_GENC4_LIBELLE,GL_GENC4_LEFT,GL_GENC4_DEBIT,GL_GENC4_CREDIT,GL_GENC4_SOLDE,GL_GENC4_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC4_CHOIX_ANNEE,GL_GENC4_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlK = "INSERT INTO tab_gl_genc4 (GL_GENC4_COMPTES,GL_GENC4_DATE,GL_GENC4_JL,GL_GENC4_REF,GL_GENC4_LIBELLE,GL_GENC4_LEFT,GL_GENC4_DEBIT,GL_GENC4_CREDIT,GL_GENC4_SOLDE,GL_GENC4_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC4_CHOIX_ANNEE,GL_GENC4_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','K- D&eacute;biteurs et cr&eacute;diteurs divers','$mission_id','$entrepriseId','$annee','$fileName','$UTIL_ID')";
		$bdd->query($sqlK);
		$file = '../fichier/save_mission/mission.sql';
