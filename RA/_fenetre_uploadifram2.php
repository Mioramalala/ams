...
<html>
	...
	<?php 
			...
			$e='N';
				...
				$reponse4444444=$bdd->query("SELECT GL_GENC7_DOCUMENT FROM tab_gl_genc7 WHERE MISSION_ID=".$mission_id);
				$glgenN7="";
		...
		<table class="table_upload">
			...
			<tr>
				...
				<td class="td_upload">
					<form method = "post" enctype="multipart/form-data" action = "import_Excel.php?mission_id=<?php echo $mission_id;?>">
						<input type = "file" onchange="" accept="application/vnd.ms-excel" id = "file_Import"  name = "file_Import"/>&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
			...
			<tr>
				...
				<td class="td_upload">
					<form method = "post" enctype="multipart/form-data" action = "bal_aux_ExcelN1.php">
			...
			<tr>
				...
				<td class="td_upload">
					<form method = "post" enctype="multipart/form-data" action = "gl_gen_ExcelC2.php">
			...
			<tr>
				...
				<td class="td_upload">
					<form method = "post" enctype="multipart/form-data" action = "gl_gen_ExcelC3.php">
			...
			<tr>
				...
				<td class="td_upload">
					<form method = "post" enctype="multipart/form-data" action = "gl_gen_ExcelC4.php">
			...
			<tr>
				...
				<td class="td_upload">
					<form method = "post" enctype="multipart/form-data" action = "gl_gen_ExcelC5.php">
						<input type = "file" onchange="" id = "file_gl_genC5" accept="application/vnd.ms-excel"  name = "file_gl_genC5"/>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;				
			...
			<tr>
				...
				<td class="td_upload">
					<form method = "post" enctype="multipart/form-data" action = "gl_gen_ExcelC6.php">
			...
			<tr>
				...
				<td class="td_upload">
					<form method = "post" enctype="multipart/form-data" action = "gl_gen_ExcelC7.php">
				...
				<td><?php echo '<a class="lien_upload" href="archive/'.$glgenN7.'" target="_blank">'.$glgenN7.'</a>'; ?></td>
			</tr>
			<!-------------------------------------------------------------------------------------------->
			<!-------------------------------GL AUX classe 1---------------------------------------------->	
<!-- 			<tr>				
...
<!-- 			<tr>				
			...
			<tr>				
				...
				<td class="td_upload">
					<form method = "post" enctype="multipart/form-data" action = "gl_aux_ExcelC4.php">
			...
			<tr>				
				...
				<td class="td_upload">
					<form method = "post" enctype="multipart/form-data" action = "gl_aux_ExcelC5.php">
			...
			<tr>				
				...
				<td class="td_upload">
					<form method = "post" enctype="multipart/form-data" action = "gl_aux_ExcelC6.php">
			...
			<tr>				
				...
				<td class="td_upload">
					<form method = "post" enctype="multipart/form-data" action = "gl_aux_ExcelC7.php">
