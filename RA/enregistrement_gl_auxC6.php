 <?php
		...
		$sqlA = "INSERT INTO tab_gl_auxc6 (GL_AUXC6_COMPTE,GL_AUXC6_CODE,GL_AUXC6_DATE,GL_AUXC6_JL,GL_AUXC6_LIGNE,GL_AUXC6_REF, 	 	 	GL_AUXC6_LIBELLE,GL_AUXC6_ECHEANCE,GL_AUXC6_LETTRAGE,GL_AUXC6_DEBIT,GL_AUXC6_CREDIT,GL_AUXC6_SOLDE,GL_AUXC6_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC6_CHOIX_ANNEE,GL_AUXC6_DOCUMENT,UTIL_ID) VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]','$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]','A- Fonds propres','$mission_id','$entrepriseId','$annee','$fileName','$UTIL_ID')";
		$bdd->query($sqlA);
		...
		$sqlJ = "INSERT INTO tab_gl_auxc6 (GL_AUXC6_COMPTE,GL_AUXC6_CODE,GL_AUXC6_DATE,GL_AUXC6_JL,GL_AUXC6_LIGNE,GL_AUXC6_REF, 	 	 	GL_AUXC6_LIBELLE,GL_AUXC6_ECHEANCE,GL_AUXC6_LETTRAGE,GL_AUXC6_DEBIT,GL_AUXC6_CREDIT,GL_AUXC6_SOLDE,GL_AUXC6_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC6_CHOIX_ANNEE,GL_AUXC6_DOCUMENT,UTIL_ID) 
		...
		$sqlB = "INSERT INTO tab_gl_auxc6 (GL_AUXC6_COMPTE,GL_AUXC6_CODE,GL_AUXC6_DATE,GL_AUXC6_JL,GL_AUXC6_LIGNE,GL_AUXC6_REF, 	 	 	GL_AUXC6_LIBELLE,GL_AUXC6_ECHEANCE,GL_AUXC6_LETTRAGE,GL_AUXC6_DEBIT,GL_AUXC6_CREDIT,GL_AUXC6_SOLDE,GL_AUXC6_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC6_CHOIX_ANNEE,GL_AUXC6_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlC = "INSERT INTO tab_gl_auxc6 (GL_AUXC6_COMPTE,GL_AUXC6_CODE,GL_AUXC6_DATE,GL_AUXC6_JL,GL_AUXC6_LIGNE,GL_AUXC6_REF, 	 	 	GL_AUXC6_LIBELLE,GL_AUXC6_ECHEANCE,GL_AUXC6_LETTRAGE,GL_AUXC6_DEBIT,GL_AUXC6_CREDIT,GL_AUXC6_SOLDE,GL_AUXC6_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC6_CHOIX_ANNEE,GL_AUXC6_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlD = "INSERT INTO tab_gl_auxc6 (GL_AUXC6_COMPTE,GL_AUXC6_CODE,GL_AUXC6_DATE,GL_AUXC6_JL,GL_AUXC6_LIGNE,GL_AUXC6_REF, 	 	 	GL_AUXC6_LIBELLE,GL_AUXC6_ECHEANCE,GL_AUXC6_LETTRAGE,GL_AUXC6_DEBIT,GL_AUXC6_CREDIT,GL_AUXC6_SOLDE,GL_AUXC6_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC6_CHOIX_ANNEE,GL_AUXC6_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlE = "INSERT INTO tab_gl_auxc6 (GL_AUXC6_COMPTE,GL_AUXC6_CODE,GL_AUXC6_DATE,GL_AUXC6_JL,GL_AUXC6_LIGNE,GL_AUXC6_REF, 	 	 	GL_AUXC6_LIBELLE,GL_AUXC6_ECHEANCE,GL_AUXC6_LETTRAGE,GL_AUXC6_DEBIT,GL_AUXC6_CREDIT,GL_AUXC6_SOLDE,GL_AUXC6_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC6_CHOIX_ANNEE,GL_AUXC6_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlF = "INSERT INTO tab_gl_auxc6 (GL_AUXC6_COMPTE,GL_AUXC6_CODE,GL_AUXC6_DATE,GL_AUXC6_JL,GL_AUXC6_LIGNE,GL_AUXC6_REF, 	 	 	GL_AUXC6_LIBELLE,GL_AUXC6_ECHEANCE,GL_AUXC6_LETTRAGE,GL_AUXC6_DEBIT,GL_AUXC6_CREDIT,GL_AUXC6_SOLDE,GL_AUXC6_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC6_CHOIX_ANNEE,GL_AUXC6_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlG = "INSERT INTO tab_gl_auxc6 (GL_AUXC6_COMPTE,GL_AUXC6_CODE,GL_AUXC6_DATE,GL_AUXC6_JL,GL_AUXC6_LIGNE,GL_AUXC6_REF, 	 	 	GL_AUXC6_LIBELLE,GL_AUXC6_ECHEANCE,GL_AUXC6_LETTRAGE,GL_AUXC6_DEBIT,GL_AUXC6_CREDIT,GL_AUXC6_SOLDE,GL_AUXC6_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC6_CHOIX_ANNEE,GL_AUXC6_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlH = "INSERT INTO tab_gl_auxc6 (GL_AUXC6_COMPTE,GL_AUXC6_CODE,GL_AUXC6_DATE,GL_AUXC6_JL,GL_AUXC6_LIGNE,GL_AUXC6_REF, 	 	 	GL_AUXC6_LIBELLE,GL_AUXC6_ECHEANCE,GL_AUXC6_LETTRAGE,GL_AUXC6_DEBIT,GL_AUXC6_CREDIT,GL_AUXC6_SOLDE,GL_AUXC6_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC6_CHOIX_ANNEE,GL_AUXC6_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlI = "INSERT INTO tab_gl_auxc6 (GL_AUXC6_COMPTE,GL_AUXC6_CODE,GL_AUXC6_DATE,GL_AUXC6_JL,GL_AUXC6_LIGNE,GL_AUXC6_REF, 	 	 	GL_AUXC6_LIBELLE,GL_AUXC6_ECHEANCE,GL_AUXC6_LETTRAGE,GL_AUXC6_DEBIT,GL_AUXC6_CREDIT,GL_AUXC6_SOLDE,GL_AUXC6_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC6_CHOIX_ANNEE,GL_AUXC6_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlK = "INSERT INTO tab_gl_auxc6 (GL_AUXC6_COMPTE,GL_AUXC6_CODE,GL_AUXC6_DATE,GL_AUXC6_JL,GL_AUXC6_LIGNE,GL_AUXC6_REF, 	 	 	GL_AUXC6_LIBELLE,GL_AUXC6_ECHEANCE,GL_AUXC6_LETTRAGE,GL_AUXC6_DEBIT,GL_AUXC6_CREDIT,GL_AUXC6_SOLDE,GL_AUXC6_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC6_CHOIX_ANNEE,GL_AUXC6_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
