...
{ 
	$NameFileko=$_SESSION['nom_entreprise'].$mission_id.$_FILES['file_Import_immofi']['name'];
	echo $NameFileko;
?>	
	
<?php	
	$loader=$_SERVER['DOCUMENT_ROOT']."/RA/immofi/uploads/".$NameFileko;
	$sourceDoc="/RA/immofi/uploads/".$NameFileko;
