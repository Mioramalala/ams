 <?php
		...
		$sqlA = "INSERT INTO tab_gl_gen(GL_GEN_COMPTES,GL_GEN_DATE,GL_GEN_JL,GL_GEN_REF,GL_GEN_LIBELLE,GL_GEN_LEFT,GL_GEN_DEBIT,GL_GEN_CREDIT,GL_GEN_SOLDE,GL_GEN_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GEN_CHOIX_ANNEE,GL_GEN_DOCUMENT,UTIL_ID)VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]','$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','A- Fonds propres','$mission_id','$entrepriseId','$annee','$fileName','$UTIL_ID')";
		//echo $sqlA;
		$bdd->query($sqlA);
		...
		$sqlJ = "INSERT INTO tab_gl_gen (GL_GEN_COMPTES,GL_GEN_DATE,GL_GEN_JL,GL_GEN_REF,GL_GEN_LIBELLE,GL_GEN_LEFT, 	 	GL_GEN_DEBIT,GL_GEN_CREDIT,GL_GEN_SOLDE,GL_GEN_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GEN_CHOIX_ANNEE,GL_GEN_DOCUMENT,UTIL_ID) 
		...
		$sqlB = "INSERT INTO tab_gl_gen (GL_GEN_COMPTES,GL_GEN_DATE,GL_GEN_JL,GL_GEN_REF,GL_GEN_LIBELLE,GL_GEN_LEFT, 	 	GL_GEN_DEBIT,GL_GEN_CREDIT,GL_GEN_SOLDE,GL_GEN_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GEN_CHOIX_ANNEE,GL_GEN_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlC = "INSERT INTO tab_gl_gen (GL_GEN_COMPTES,GL_GEN_DATE,GL_GEN_JL,GL_GEN_REF,GL_GEN_LIBELLE,GL_GEN_LEFT, 	 	GL_GEN_DEBIT,GL_GEN_CREDIT,GL_GEN_SOLDE,GL_GEN_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GEN_CHOIX_ANNEE,GL_GEN_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlD = "INSERT INTO tab_gl_gen (GL_GEN_COMPTES,GL_GEN_DATE,GL_GEN_JL,GL_GEN_REF,GL_GEN_LIBELLE,GL_GEN_LEFT, 	 	GL_GEN_DEBIT,GL_GEN_CREDIT,GL_GEN_SOLDE,GL_GEN_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GEN_CHOIX_ANNEE,GL_GEN_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlE = "INSERT INTO tab_gl_gen (GL_GEN_COMPTES,GL_GEN_DATE,GL_GEN_JL,GL_GEN_REF,GL_GEN_LIBELLE,GL_GEN_LEFT, 	 	GL_GEN_DEBIT,GL_GEN_CREDIT,GL_GEN_SOLDE,GL_GEN_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GEN_CHOIX_ANNEE,GL_GEN_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlF = "INSERT INTO tab_gl_gen (GL_GEN_COMPTES,GL_GEN_DATE,GL_GEN_JL,GL_GEN_REF,GL_GEN_LIBELLE,GL_GEN_LEFT, 	 	GL_GEN_DEBIT,GL_GEN_CREDIT,GL_GEN_SOLDE,GL_GEN_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GEN_CHOIX_ANNEE,GL_GEN_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlG = "INSERT INTO tab_gl_gen (GL_GEN_COMPTES,GL_GEN_DATE,GL_GEN_JL,GL_GEN_REF,GL_GEN_LIBELLE,GL_GEN_LEFT, 	 	GL_GEN_DEBIT,GL_GEN_CREDIT,GL_GEN_SOLDE,GL_GEN_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GEN_CHOIX_ANNEE,GL_GEN_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlH = "INSERT INTO tab_gl_gen (GL_GEN_COMPTES,GL_GEN_DATE,GL_GEN_JL,GL_GEN_REF,GL_GEN_LIBELLE,GL_GEN_LEFT, 	 	GL_GEN_DEBIT,GL_GEN_CREDIT,GL_GEN_SOLDE,GL_GEN_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GEN_CHOIX_ANNEE,GL_GEN_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlI = "INSERT INTO tab_gl_gen (GL_GEN_COMPTES,GL_GEN_DATE,GL_GEN_JL,GL_GEN_REF,GL_GEN_LIBELLE,GL_GEN_LEFT, 	 	GL_GEN_DEBIT,GL_GEN_CREDIT,GL_GEN_SOLDE,GL_GEN_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GEN_CHOIX_ANNEE,GL_GEN_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlK = "INSERT INTO tab_gl_gen (GL_GEN_COMPTES,GL_GEN_DATE,GL_GEN_JL,GL_GEN_REF,GL_GEN_LIBELLE,GL_GEN_LEFT, 	 	GL_GEN_DEBIT,GL_GEN_CREDIT,GL_sGEN_SOLDE,GL_GEN_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GEN_CHOIX_ANNEE,GL_GEN_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
