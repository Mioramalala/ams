...
<script>
	$(function(){
			$("#listForm").submit(function(){
				 $.ajax({
				  type:"POST",
				  url:"RA/circularisation/banque/export_word.php",
                  data: $(this).serialize(),
				  success:function(e){
                        $('#contenue').html(e);
    				   // $('#contenue').load("RA/circularisation/banque/export_word.php");
    				}
                });
			});
...
<table width="100%" height="50" bgcolor="#00698d" style="text-align:left;">
	<tr>
		<td style="color:white"><center>BANQUE</center></td>
	</tr>
</table>
 ...
 <div id="corps_avocat">
    <form id="listForm" onsubmit="return false">
	  <table width="900">
	  <tr id="tettd">
			<td width="200px">Nom de la banque</td>
