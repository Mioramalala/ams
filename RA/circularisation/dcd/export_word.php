            ...
            $(function () {
                $(".export").submit(function(){
                    ...
                    $.ajax({
                        ...
                        success:function(e){
                            // alert(id);
                            // $("#input-"+id).append('<a href="RA/circularisation/dcd/dcd-'+id+'.docx">Telecharger</a>');
                            $("#form-"+id+" #btnSubmit").replaceWith('<a href="RA/circularisation/dcd/dcd-'+id+'.docx">Telecharger</a>');
                            // $(this).find($('a')).click();
                        }
                    });
                });
                ...
                $("#btn_retour").click(function(){
                  $('#contenue').load("/RA/circularisation/dcd/table_new_dcd.php");
               });
            });
        </script>
</head>
<body>
    ...
    <form method="post" class='export' action="/RA/circularisation/frns/exportgatway.php" onsubmit="return false">
        <div id="lettre">
           	<br/>
