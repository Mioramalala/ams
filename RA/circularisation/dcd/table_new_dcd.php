...
<script>
	$(function(){
			...
			// 	 $.ajax({
			// 	  type:"POST",
			// 	  url:"RA/circularisation/dcd/export_word.php",
			// 	  success:function(e){
			// 	   $('#contenue').load("RA/circularisation/dcd/export_word.php");
			// 	}
   ...
   $("#btn_retour").click(function(){
      $('#contenue').load("/RA/circularisation/dcd/dcd.php");
   });
});
</script>
 ...
 <table width="100%" height="50" bgcolor="#00698d" style="text-align:left;">
	<tr>
		<td style="color:white"><center>DEBITEURS ET CREDITEURS DIVERS</center></td>
	</tr>
</table>
<div id="corps_avocat">
   <form id="listForm" onsubmit="return false">
      <table width="900">
	   ...
	   <?php 
		...
		// where ECH_BAL_AUX_CYCLE='dcd' AND MISSION_ID=".$mission_id);
		// $compte=0;
