...
$(function(){
   ...
   // 	 $.ajax({
   // 	  type:"POST",
   // 	  url:"RA/circularisation/frns/export_word.php",
   // 	  success:function(e){
   // 	   $('#contenue').load("RA/circularisation/frns/export_word.php");
   // 	}
 ...
 <table width="100%" height="50" bgcolor="#00698d" style="text-align:left;">
	<tr>
		<td style="color:white"><center>FOURNISSEURS</center></td>
	</tr>
</table>
<div id="corps_avocat">
   <form id="listForm" onsubmit="return false">
      <table width="900">
         <tr id="tettd">
            <td width="200px">Nom du fournisseur</td>
    ...
    // where ECH_BAL_AUX_CYCLE='banque' AND MISSION_ID=".$mission_id);
    // $compte=0;
