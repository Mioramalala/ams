...
$nomfichier = 'avocat_' . str_replace(' ', '_', $nom) . '.docx';
...
$sql = "INSERT INTO `tmsconsuams`.`tab_circularisation_fichier` 
			...
			VALUES ('', '" . $nomfichier . "', '" . $mission_id . "', '" . $nom . "', '" . $adresse . "', 'avocat', NOW());";
$bdd->query($sql);
// header("Content-Type: application/vnd.ms-word");
// header("Expires: 0");
// header("Cache-Control: must-revalidate, post-check=0, pre-check=0");
// header("content-disposition: attachment;filename=lettre_avocat.doc");
