...
include '../connexion.php';
	...
	STRUCTURE_EVALUATION_CORRECTE_RA,STRUCTURE_ENREGISTREMENT_BONNE_PERIODE_RA,STRUCTURE_IMPUTATION_CORRECTE_RA,MISSION_ID) VALUE 
	("'.$choix.'","'.$choix1.'","'.$choix2.'","'.$choix3.'","'.$choix4.'","'.$choix5.'","'.$choix6.'","'.$mission_id.'")');
