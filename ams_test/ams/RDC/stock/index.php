		...
		<script>
			$(function(){
					$("#coherence").click(function(){
						waiting();$("#contenue").load("RDC/stock/A_coherence/coherence.php",stopWaiting);
					});	
					$("#existence").click(function(){
						waiting();$("#contenue").load("RDC/stock/B_existence/existence1.php",stopWaiting);
					});	
					$("#evaluation").click(function(){
						waiting();$("#contenue").load("RDC/stock/C_evaluation/evaluation1.php",stopWaiting);
					});
					$("#rattachement").click(function(){
						waiting();$("#contenue").load("RDC/stock/D_rattachement/rattachement1.php",stopWaiting);
					});
					$("#juridique").click(function(){
						waiting();$("#contenue").load("RDC/stock/E_juridique/juridique1.php",stopWaiting);
					});		
					$("#information").click(function(){
						waiting();$("#contenue").load("RDC/stock/F_information/information1.php",stopWaiting);
					});						
					$('#bt_retour').click(function(){
						waiting();$("#contenue").load("RDC/index.php",stopWaiting);
					});				
					$('#bt_feuille_maitresse').click(function(){
						waiting();$("#contenue").load("RDC/stock/feuille_maitresse.php",stopWaiting);
					});			
