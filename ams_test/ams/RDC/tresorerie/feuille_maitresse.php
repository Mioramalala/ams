...
<script>
	...
	$(function(){
		...
		$('#synthese_feuille').click(function(){
			waiting();$('#contenue').load("RDC/tresorerie/synthese_tresorerie.php",stopWaiting);
		});
		$('#coh1').click(function(){
			waiting();$('#contenue').load("RDC/tresorerie/A_coherence/coherence1.php?coherence_visible=OK",stopWaiting);
		});
		$('#coh11').click(function(){
			waiting();$('#contenue').load("RDC/tresorerie/A_coherence/coherence1.php?coherence_visible=OK",stopWaiting);
		});
		$('#coh2').click(function(){
			waiting();$('#contenue').load("RDC/tresorerie/A_coherence/coherence2.php?coherence_visible=OK",stopWaiting);
		});
		$('#reg1').click(function(){
			waiting();$('#contenue').load("RDC/tresorerie/B_regularite/regularite1.php?regularite_visible=OK",stopWaiting);
		});
		$('#reg2').click(function(){
			waiting();$('#contenue').load("RDC/tresorerie/B_regularite/regularite2.php?regularite_visible=OK",stopWaiting);
		});
		$('#reg3').click(function(){
			waiting();$('#contenue').load("RDC/tresorerie/B_regularite/regularite3.php?regularite_visible=OK",stopWaiting);
		});
		$('#reg33').click(function(){
			waiting();$('#contenue').load("RDC/tresorerie/B_regularite/regularite3.php?regularite_visible=OK",stopWaiting);
		});
		$('#exist1').click(function(){
			waiting();$('#contenue').load("RDC/tresorerie/C_existence/existence1.php?existence_visible=OK",stopWaiting);
		});
		...
		$('#exist2').click(function(){
			waiting();$('#contenue').load("RDC/tresorerie/C_existence/existence2.php?existence_visible=OK",stopWaiting);
		});
		...
		$('#exist3').click(function(){
			waiting();$('#contenue').load("RDC/tresorerie/C_existence/existence3.php?existence_visible=OK",stopWaiting);
		});
		...
		$('#exist4').click(function(){
			waiting();$('#contenue').load("RDC/tresorerie/C_existence/existence4.php?existence_visible=OK",stopWaiting);
		});
		$('#exist5').click(function(){
			waiting();$('#contenue').load("RDC/tresorerie/C_existence/existence5.php?existence_visible=OK",stopWaiting);
		});
		$('#exist55').click(function(){
			waiting();$('#contenue').load("RDC/tresorerie/C_existence/existence5.php?existence_visible=OK",stopWaiting);
		});
		$('#exist6').click(function(){
			waiting();$('#contenue').load("RDC/tresorerie/C_existence/existence6.php?existence_visible=OK",stopWaiting);
		});
		$('#rattach1').click(function(){
			waiting();$('#contenue').load("RDC/tresorerie/D_rattachement/rattachement1.php?rattachement_visible=OK",stopWaiting);
		});
		$('#rattach11').click(function(){
			waiting();$('#contenue').load("RDC/tresorerie/D_rattachement/rattachement1.php?rattachement_visible=OK",stopWaiting);
		});
		$('#jurid1').click(function(){
			waiting();$('#contenue').load("RDC/tresorerie/E_juridique/juridique1.php?juridique_visible=OK",stopWaiting);
		});
		$('#info1').click(function(){
			waiting();$('#contenue').load("RDC/tresorerie/F_information/information1.php?information_visible=OK",stopWaiting);
		});
		...
		$('#info2').click(function(){
			waiting();$('#contenue').load("RDC/tresorerie/F_information/information2.php?information_visible=OK",stopWaiting);
		});
