<html>
	<head>
		...
		<script>
			$(function(){
				$("#AED").click(function(){
					waiting();$("#contenue").load("RDC/emprunt/empruntA/objetAED1.php",stopWaiting);
				});
				$("#BED").click(function(){
					waiting();$("#contenue").load("RDC/emprunt/empruntB/objetBED1.php",stopWaiting);
				});
				$("#CED").click(function(){
					waiting();$("#contenue").load("RDC/emprunt/empruntC/objetCED1.php",stopWaiting);
				});
				$("#DED").click(function(){
					waiting();$("#contenue").load("RDC/emprunt/empruntD/objetDED1.php",stopWaiting);
				});
				$("#RIT").click(function(){
					waiting();$("#contenue").load("RDC/index.php",stopWaiting);
				});
				$("#FM").click(function(){
					waiting();$("#contenue").load("RDC/emprunt/feuille.php",stopWaiting);
				});
			});
