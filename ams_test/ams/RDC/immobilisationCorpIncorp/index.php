		...
		<script>
			$(function(){
					$("#coherence").click(function(){
						waiting();$("#contenue").load("RDC/immobilisationCorpIncorp/A_coherence/coherence1.php",stopWaiting);					
					});				
					$("#exhaustivite").click(function(){
						waiting();$("#contenue").load("RDC/immobilisationCorpIncorp/B_exhaustivite/exhaustivite1.php",stopWaiting);					
					});	
					$("#regularite").click(function(){
						waiting();$("#contenue").load("RDC/immobilisationCorpIncorp/C_regularite/regularite1.php",stopWaiting);					
					});
					$("#existence").click(function(){
						waiting();$("#contenue").load("RDC/immobilisationCorpIncorp/D_existence/existence1.php",stopWaiting);					
					});
					$("#evaluation").click(function(){
						waiting();$("#contenue").load("RDC/immobilisationCorpIncorp/E_evaluation/evaluation1.php",stopWaiting);					
					});
					$("#rattachement").click(function(){
						waiting();$("#contenue").load("RDC/immobilisationCorpIncorp/F_rattachement/rattachement1.php",stopWaiting);					
					});
					$("#juridique").click(function(){
						waiting();$("#contenue").load("RDC/immobilisationCorpIncorp/G_juridique/juridique1.php",stopWaiting);					
					});
					$("#information").click(function(){
						waiting();$("#contenue").load("RDC/immobilisationCorpIncorp/H_information/information1.php",stopWaiting);					
					});
					...
					$('#bt_feuille_maitresse').click(function(){
						waiting();$("#contenue").load("RDC/immobilisationCorpIncorp/feuille_maitresse.php",stopWaiting);
					});
