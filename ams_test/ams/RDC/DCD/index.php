		...
		<script>
			$(function(){
				$("#coherence").click(function(){
					waiting();$("#contenue").load("RDC/DCD/A_coherence/coherence1.php",stopWaiting);					
				});				
				$("#exhaustivite").click(function(){
					waiting();$("#contenue").load("RDC/DCD/B_exhaustivite/exhaustivite1.php",stopWaiting);					
				});	
				$("#regularite").click(function(){
					waiting();$("#contenue").load("RDC/DCD/C_regularite/regularite1.php",stopWaiting);					
				});
				$("#existence").click(function(){
					waiting();$("#contenue").load("RDC/DCD/D_existence/existence1.php",stopWaiting);					
				});
				$("#evaluation").click(function(){
					waiting();$("#contenue").load("RDC/DCD/E_evaluation/evaluation1.php",stopWaiting);					
				});		
				$("#juridique").click(function(){
					waiting();$("#contenue").load("RDC/DCD/F_juridique/juridique1.php",stopWaiting);					
				});
				$("#information").click(function(){
					waiting();$("#contenue").load("RDC/DCD/G_information/information1.php",stopWaiting);					
				});
				...
				$('#bt_feuille_maitresse').click(function(){
					waiting();$("#contenue").load("RDC/DCD/feuille_maitresse.php",stopWaiting);
				});
