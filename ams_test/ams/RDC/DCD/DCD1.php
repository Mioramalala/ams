...
<script>
	...
	$(function(){
		$('#bt_retour').click(function(){
			...
			waiting();$("#contenue").load("RDC/DCD/DCD1.php",stopWaiting);
		});
		...
		$('#revue').click(function(){
			$('#bt_suivant').show();
			$('#contenue_rdc').show();
			waiting();$('#contenue_travail').load("RDC/DCD/table_B1.php",stopWaiting);
		});
		...
		$('#bt_suivant').click(function(){
			...
			waiting();$('#contenue').load("RDC/DCD/coherence2.php",stopWaiting);
		});
