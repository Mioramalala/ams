<html>
	<head>
		...
		<script>
			$(function(){
				$("#APP").click(function(){
					waiting();$("#contenue").load("RDC/paie/paieA/cohPrComAPP1.php",stopWaiting);
				});
				$("#BPP").click(function(){
					waiting();$("#contenue").load("RDC/paie/paieB/cohPrComBPP1.php",stopWaiting);
				});
				$("#CPP").click(function(){
					waiting();$("#contenue").load("RDC/paie/paieC/cohPrComCPP1.php",stopWaiting);
				});
				$("#DPP").click(function(){
					waiting();$("#contenue").load("RDC/paie/paieD/cohPrComDPP1.php",stopWaiting);
				});
				$("#EPP").click(function(){
					waiting();$("#contenue").load("RDC/paie/paieE/cohPrComEPP1.php",stopWaiting);
				});
				$("#FPP").click(function(){
					waiting();$("#contenue").load("RDC/paie/paieF/cohPrComFPP1.php",stopWaiting);
				});
				$("#GPP").click(function(){
					waiting();$("#contenue").load("RDC/paie/paieG/cohPrComGPP1.php",stopWaiting);
				});
				$("#HPP").click(function(){
					waiting();$("#contenue").load("RDC/paie/paieH/cohPrComHPP1.php",stopWaiting);
				});
				$("#RPP").click(function(){
					waiting();$("#contenue").load("RDC/index.php",stopWaiting);
				});
				$("#FM").click(function(){
					waiting();$("#contenue").load("RDC/paie/feuille.php",stopWaiting);
				});
			});
