...
<script>
	...
	$('#synthese_feuille').click(function(){
		waiting();$('#contenue').load("RDC/fond_propre/synthese_fond.php",stopWaiting);
	});
	
	$('#coh1').click(function(){
		waiting();$('#contenue').load("RDC/fond_propre/CohPriCo/TabRA.php",stopWaiting);
	});
	...
	$('#coh2').click(function(){
		waiting();$('#contenue').load("RDC/fond_propre/CohPriCo/TabRA2.php",stopWaiting);
	});
	...
	$('#reg1').click(function(){
		waiting();$('#contenue').load("RDC/fond_propre/B/Feuill_B1.php",stopWaiting);
	});
	
	$('#reg2').click(function(){
		waiting();$('#contenue').load("RDC/fond_propre/B/Feuill_B2.php",stopWaiting);
	});
	...
	$('#reg3').click(function(){
		waiting();$('#contenue').load("RDC/fond_propre/B/Feuill_B3.php",stopWaiting);
	});
	
	$('#exist1').click(function(){
		waiting();$('#contenue').load("RDC/fond_propre/C/Feuill_C1.php",stopWaiting);
	});
	
	$('#exist2').click(function(){
		waiting();$('#contenue').load("RDC/fond_propre/C/Feuill_C2.php",stopWaiting);
	});
	
	$('#jurid1').click(function(){
		waiting();$('#contenue').load("RDC/fond_propre/D/Feuill_D1.php",stopWaiting);
	});
	
	$('#jurid2').click(function(){
		waiting();$('#contenue').load("RDC/fond_propre/D/Feuill_D2.php",stopWaiting);
	});
	...
	$('#info1').click(function(){
		waiting();$('#contenue').load("RDC/fond_propre/E/Feuill_E.php",stopWaiting);
	});
