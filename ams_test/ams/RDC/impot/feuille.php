	...
	<head>
		...
		<script type="text/javascript">
			...
			$('#synthese_feuille').click(function(){
				waiting();$('#contenue').load("RDC/impot/synthese_impot.php",stopWaiting);
			});
			$('#coh1').click(function(){
				waiting();$('#contenue').load("RDC/impot/impotA/objetAIT1.php?coherence_visible=OK",stopWaiting);
			});
			$('#coh11').click(function(){
				waiting();$('#contenue').load("RDC/impot/impotA/objetAIT1.php?coherence_visible=OK",stopWaiting);
			});
			$('#coh12').click(function(){
				waiting();$('#contenue').load("RDC/impot/impotA/objetAIT2.php?coherence_visible=OK",stopWaiting);
			});
			$('#exhaust1').click(function(){
				waiting();$('#contenue').load("RDC/impot/impotB/objetBIT1.php?exhaustivite_visible=OK",stopWaiting);
			});
			$('#reg1').click(function(){
				waiting();$('#contenue').load("RDC/impot/impotC/objetCIT1.php?regularite_visible=OK",stopWaiting);
			});
			$('#reg11').click(function(){
				waiting();$('#contenue').load("RDC/impot/impotC/objetCIT1.php?regularite_visible=OK",stopWaiting);
			});
			$('#reg2').click(function(){
				waiting();$('#contenue').load("RDC/impot/impotC/objetCIT2.php?regularite_visible=OK",stopWaiting);
			});
			$('#reg22').click(function(){
				waiting();$('#contenue').load("RDC/impot/impotC/objetCIT2.php?regularite_visible=OK",stopWaiting);
			});
			$('#exist1').click(function(){
				waiting();$('#contenue').load("RDC/impot/impotD/objetDIT1.php?existence_visible=OK",stopWaiting);
			});
			...
			$('#eval1').click(function(){
				waiting();$('#contenue').load("RDC/impot/impotE/objetEIT1.php?evaluation_visible=OK",stopWaiting);
			});
			$('#eval11').click(function(){
				waiting();$('#contenue').load("RDC/impot/impotE/objetEIT1.php?evaluation_visible=OK",stopWaiting);
			});
			$('#rattach1').click(function(){
				waiting();$('#contenue').load("RDC/impot/impotF/objetFIT1.php?rattachement_visible=OK",stopWaiting);
			});
			$('#rattach2').click(function(){
				waiting();$('#contenue').load("RDC/impot/impotF/objetFIT2.php?rattachement_visible=OK",stopWaiting);
			});
			...
			$('#jurid1').click(function(){
				waiting();$('#contenue').load("RDC/impot/impotG/objetGIT1.php?juridique_visible=OK",stopWaiting);
			});
			$('#jurid2').click(function(){
				waiting();$('#contenue').load("RDC/impot/impotG/objetGIT2.php?juridique_visible=OK",stopWaiting);
			});
			...
			$('#info1').click(function(){
				waiting();$('#contenue').load("RDC/impot/impotH/objetHIT1.php?information_visible=OK",stopWaiting);
			});
			$('#info11').click(function(){
				waiting();$('#contenue').load("RDC/impot/impotH/objetHIT1.php?information_visible=OK",stopWaiting);
			});
			$('#info2').click(function(){
				waiting();$('#contenue').load("RDC/impot/impotH/objetHIT2a.php?information_visible=OK",stopWaiting);
			});
			$('#info3').click(function(){
				waiting();$('#contenue').load("RDC/impot/impotH/objetHIT2b.php?information_visible=OK",stopWaiting);
			});
