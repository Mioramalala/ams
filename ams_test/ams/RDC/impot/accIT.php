	...
	<head>
		...
		<script>
			$(function(){
				...
				$("#BIT").click(function(){
					waiting();$("#contenue").load("RDC/impot/impotB/objetBIT1.php",stopWaiting);
				});
				$("#CIT").click(function(){
					waiting();$("#contenue").load("RDC/impot/impotC/objetCIT1.php",stopWaiting);
				});
				$("#DIT").click(function(){
					waiting();$("#contenue").load("RDC/impot/impotD/objetDIT1.php",stopWaiting);
				});
				$("#EIT").click(function(){
					waiting();$("#contenue").load("RDC/impot/impotE/objetEIT1.php",stopWaiting);
				});
				$("#FIT").click(function(){
					waiting();$("#contenue").load("RDC/impot/impotF/objetFIT1.php",stopWaiting);
				});
				$("#GIT").click(function(){
					waiting();$("#contenue").load("RDC/impot/impotG/objetGIT1.php",stopWaiting);
				});
				$("#HIT").click(function(){
					waiting();$("#contenue").load("RDC/impot/impotH/objetHIT1.php",stopWaiting);
				});
				$("#RIT").click(function(){
					waiting();$("#contenue").load("RDC/index.php",stopWaiting);
				});
				$("#FM").click(function(){
					waiting();$("#contenue").load("RDC/impot/feuille.php",stopWaiting);
				});
			});
