...
<script>
	...
	$(function(){
		...
		$('#synthese_feuille').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/synthese_charge.php",stopWaiting);
		});
		$('#coh1').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/A_coherence/coherence1.php?coherence_visible=OK",stopWaiting);
		});
		$('#coh11').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/A_coherence/coherence1.php?coherence_visible=OK",stopWaiting);
		});
		$('#coh2').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/A_coherence/coherence2.php?coherence_visible=OK",stopWaiting);
		});
		$('#coh3').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/A_coherence/coherence3.php?coherence_visible=OK",stopWaiting);
		});
		$('#coh33').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/A_coherence/coherence3.php?coherence_visible=OK",stopWaiting);
		});
		$('#coh4').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/A_coherence/coherence4.php?coherence_visible=OK",stopWaiting);
		});
		$('#coh44').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/A_coherence/coherence4.php?coherence_visible=OK",stopWaiting);
		});
		$('#coh5').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/A_coherence/coherence5.php?coherence_visible=OK",stopWaiting);
		});
		$('#coh55').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/A_coherence/coherence5.php?coherence_visible=OK",stopWaiting);
		});
		$('#coh6').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/A_coherence/coherence6.php?coherence_visible=OK",stopWaiting);
		});
		$('#coh7').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/A_coherence/coherence7.php?coherence_visible=OK",stopWaiting);
		});
		...
		$('#exhaust1').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/B_exhaustivite/exhaustivite1.php?exhaustivite_visible=OK",stopWaiting);
		});
		$('#reg1').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/C_regularite/regularite1.php?regularite_visible=OK",stopWaiting);
		});
		$('#reg11').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/C_regularite/regularite1.php?regularite_visible=OK",stopWaiting);
		});
		$('#reg2').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/C_regularite/regularite2.php?regularite_visible=OK",stopWaiting);
		});
		$('#reg3').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/C_regularite/regularite3.php?regularite_visible=OK",stopWaiting);
		});
		$('#reg33').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/C_regularite/regularite3.php?regularite_visible=OK",stopWaiting);
		});
		$('#exist1').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/D_existence/existence1.php?existence_visible=OK",stopWaiting);
		});
		$('#exist11').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/D_existence/existence1.php?existence_visible=OK",stopWaiting);
		});
		$('#exist2').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/D_existence/existence2.php?existence_visible=OK",stopWaiting);
		});
		$('#exist22').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/D_existence/existence2.php?existence_visible=OK",stopWaiting);
		});
		$('#evaluat1').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/E_evaluation/evaluation1.php?evaluation_visible=OK",stopWaiting);
		});
		$('#evaluat11').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/E_evaluation/evaluation1.php?evaluation_visible=OK",stopWaiting);
		});
		$('#evaluat2').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/E_evaluation/evaluation2.php?evaluation_visible=OK",stopWaiting);
		});
		$('#evaluat22').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/E_evaluation/evaluation2.php?evaluation_visible=OK",stopWaiting);
		});
		$('#evaluat3').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/E_evaluation/evaluation3.php?evaluation_visible=OK",stopWaiting);
		});
		...
		$('#rattach1').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/F_rattachement/rattachement1.php?rattachement_visible=OK",stopWaiting);
		});
		$('#rattach2').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/F_rattachement/rattachement2.php?rattachement_visible=OK",stopWaiting);
		});
		$('#jurid1').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/G_juridique/juridique1.php?juridique_visible=OK",stopWaiting);
		});
		$('#jurid1_2').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/G_juridique/juridique1_part2.php?juridique_visible=OK",stopWaiting);
		});
		$('#jurid1_22').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/G_juridique/juridique1_part2.php?juridique_visible=OK",stopWaiting);
		});
		$('#jurid2').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/G_juridique/juridique2.php?juridique_visible=OK",stopWaiting);
		});
		$('#jurid2_2').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/G_juridique/juridique2_part2.php?juridique_visible=OK",stopWaiting);
		});
		$('#info1').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/H_information/information1.php?information_visible=OK",stopWaiting);
		});
		$('#info2').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/H_information/information2.php?information_visible=OK",stopWaiting);
		});
		$('#info3').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/H_information/information3.php?information_visible=OK",stopWaiting);
		});
		$('#info4').click(function(){
			waiting();$('#contenue').load("RDC/charge_fournisseur/H_information/information4.php?information_visible=OK",stopWaiting);
		});
