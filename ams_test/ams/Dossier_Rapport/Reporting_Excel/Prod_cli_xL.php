...
$lienRDC="http://".$_SERVER['HTTP_HOST']."/RDC_liengenerer.php?lien=PRODUIT_CLIENTS/".$idMission;
$feuille->setCellValue('G1', $lienRDC);

$feuille->setCellValue('F8', $lienRDC."/A_coherence1");
$feuille->setCellValue('F9', $lienRDC."/A_coherence1");
$feuille->setCellValue('F10', $lienRDC."/A_coherence2");

$feuille->setCellValue('F21', $lienRDC."/C_regularite1");
$feuille->setCellValue('F22', $lienRDC."/C_regularite1");

$feuille->setCellValue('F22', $lienRDC."/C_regularite2");
$feuille->setCellValue('F24', $lienRDC."/D_existence1");
$feuille->setCellValue('F25', $lienRDC."/D_existence1");

$feuille->setCellValue('F34', $lienRDC."/E_evaluation4");
$feuille->setCellValue('F35', $lienRDC."/F_rattachement1");

$feuille->setCellValue('F42', $lienRDC."/G_juridique1");

$feuille->setCellValue('F43', $lienRDC."/G_juridique1");

$feuille->setCellValue('F44', $lienRDC."/G_juridique1");

$feuille->setCellValue('F50', $lienRDC."/H_information4");
...
echo '<a id="icone_Produits_clients" href="includes/google_docs_viewer.php?id=Dossier_Rapport/Sauvegarde_sortie/Excel/Produits_clients('.$date_font.').xls&amp;nomfichier=" TARGET="_BLANK"><img src="Dossier_Rapport/img/Excel.png" height="28px" width="28px"/></a>';
