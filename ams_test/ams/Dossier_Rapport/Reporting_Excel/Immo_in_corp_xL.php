...
$lienRDC="http://".$_SERVER['HTTP_HOST']."/RDC_liengenerer.php?lien=IMMO_CORP_INCORP/".$idMission;
$feuille->setCellValue('E1',$lienRDC);

$feuille->setCellValue('G1',$lienRDC);
$feuille->setCellValue('E9',$lienRDC."/A_coherence1");
$feuille->setCellValue('E10',$lienRDC."/A_coherence1");
$feuille->setCellValue('E11',$lienRDC."/A_coherence2");
$feuille->setCellValue('E14',$lienRDC."/A_coherence3");
$feuille->setCellValue('E17',$lienRDC."/A_coherence4");
$feuille->setCellValue('E20',$lienRDC."/A_coherence5");
$feuille->setCellValue('E27',$lienRDC."/A_coherence5");
$feuille->setCellValue('E31',$lienRDC."/A_coherence5");
$feuille->setCellValue('E36',$lienRDC."/B_exhaustivite");
$feuille->setCellValue('E39',$lienRDC."/C_regularite1");

$feuille->setCellValue('E40',$lienRDC."/A_coherence5");
$feuille->setCellValue('E41',$lienRDC."/C_regularite1");
$feuille->setCellValue('E42',$lienRDC."/A_coherence5");
$feuille->setCellValue('E45',$lienRDC."/C_regularite1");

$feuille->setCellValue('E50',$lienRDC."/A_coherence2");
$feuille->setCellValue('E51',$lienRDC."/A_coherence2");


$feuille->setCellValue('E51',$lienRDC."/A_coherence2");
$feuille->setCellValue('E52',$lienRDC."/A_coherence7");
$feuille->setCellValue('E53',$lienRDC."/A_coherence8");

$feuille->setCellValue('E80',$lienRDC."/H_information1");
...
echo '<a id="icone_immoCorp" href="includes/google_docs_viewer.php?id=Dossier_Rapport/Sauvegarde_sortie/Excel/Immo_in_corp('.$date_font.').xls&amp;nomfichier=" TARGET="_BLANK"><img src="Dossier_Rapport/img/Excel.png" height="28px" width="28px"/></a>';
