...
$lienRDC="http://".$_SERVER['HTTP_HOST']."/RDC_liengenerer.php?lien=TRESORERIE/".$idMission;
...
$feuille->setCellValue('F15', $lienRDC."/A_coherence2");
$feuille->setCellValue('F16', $lienRDC."/B_regularite1");
$feuille->setCellValue('F18', $lienRDC."/B_regularite2");
$feuille->setCellValue('F19', $lienRDC."/B_regularite2");
$feuille->setCellValue('F20', $lienRDC."/B_regularite3");
$feuille->setCellValue('F21', $lienRDC."/C_existence1");
$feuille->setCellValue('F26', $lienRDC."/C_existence1");
$feuille->setCellValue('F28', $lienRDC."/C_existence1");
$feuille->setCellValue('F30', $lienRDC."/C_existence1");
$feuille->setCellValue('F33', $lienRDC."/C_existence2");
...
echo '<a id="icone_treso" href="includes/google_docs_viewer.php?id=Dossier_Rapport/Sauvegarde_sortie/Excel/Tresorerie('.$date_font.').xls&amp;nomfichier=" TARGET="_BLANK"><img src="Dossier_Rapport/img/Excel.png" height="28px" width="28px"/></a>';
