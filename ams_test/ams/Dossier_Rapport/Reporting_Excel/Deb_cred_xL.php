...
$lienRDC="http://".$_SERVER['HTTP_HOST']."/RDC_liengenerer.php?lien=DEBIT_CREDIT_DIVERS/".$idMission;
...
$feuille->setCellValue('F16',$lienRDC."/B_exhaustivite");
$feuille->setCellValue('F19',$lienRDC."/B_exhaustivite");
$feuille->setCellValue('F20',$lienRDC."/B_exhaustivite");
$feuille->setCellValue('F21',$lienRDC."/B_exhaustivite");
$feuille->setCellValue('F34',$lienRDC."/G_information");
...
echo '<a id="icone_Debiteurs_crediteurs" href="includes/google_docs_viewer.php?id=Dossier_Rapport/Sauvegarde_sortie/Excel/Debiteurs_crediteurs('.$date_font.').xls&amp;nomfichier=" TARGET="_BLANK"><img src="Dossier_Rapport/img/Excel.png" height="28px" width="28px"/></a>';
