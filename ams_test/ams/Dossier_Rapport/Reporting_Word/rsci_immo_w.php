...
$Auditeur=getAuditeurs($ID_mission, "C2 - Immobilisations");
$Superviseur=getSuperviseurs($ID_mission, "C2 - Immobilisations");		
...
$lienRSCI="http://".$_SERVER['HTTP_HOST']."/RSCISynthese_.php?lien=IMMOBILIER/".$idMission;
...
//=========================================================================
syntheseFinale($document, "immobilisation", $ID_mission);
...
echo '<a id="icone_immo" href="includes/google_docs_viewer.php?id=Dossier_Rapport/Sauvegarde_sortie/Word/RSCI_Cycle_Immobilisation('.$DATE_achat.').docx&amp;nomfichier=" TARGET="_BLANK"><img src="Dossier_Rapport/img/telecharger.png" height="28px" width="28px"/></a>';
