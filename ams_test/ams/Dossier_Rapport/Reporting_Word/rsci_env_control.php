...
$lienRSCI="http://".$_SERVER['HTTP_HOST']."/RSCISynthese_.php?lien=ENVIRONMNT_CONTROL/".$idMission;
...
echo '<a id="icone_env" href="includes/google_docs_viewer.php?id=Dossier_Rapport/Sauvegarde_sortie/Word/RSCI_Environnement_Control('.$DATE_control.').docx&amp;nomfichier=" TARGET="_BLANK"><img src="Dossier_Rapport/img/telecharger.png" height="28px" width="28px"/></a>';
