...
$lienRSCI="http://".$_SERVER['HTTP_HOST']."/RSCISynthese_.php?lien=SYNTHESE_RSC/".$idMission;
...
echo '<a id="icone_synthese" href="includes/google_docs_viewer.php?id=Dossier_Rapport/Sauvegarde_sortie/Word/RSCI_SYNTHESE(' . $DATE_GENERATION . ').docx&amp;nomfichier=" TARGET="_BLANK"><img src="Dossier_Rapport/img/telecharger.png" height="28px" width="28px"/></a>';
