...
$lienRSCI="http://".$_SERVER['HTTP_HOST']."/RSCISynthese_.php?lien=SYSTEM_INFOS/".$idMission;
...
echo '<a id="icone_info" href="includes/google_docs_viewer.php?id=Dossier_Rapport/Sauvegarde_sortie/Word/RSCI_Systeme_information('.$DATE_SI.').docx&amp;nomfichier=" TARGET="_BLANK"><img src="Dossier_Rapport/img/telecharger.png" height="28px" width="28px"/></a>';
