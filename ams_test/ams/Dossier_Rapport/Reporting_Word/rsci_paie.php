...
$Auditeur=getAuditeurs($ID_mission, "C4-paie");
$Superviseur=getSuperviseurs($ID_mission, "C4-paie");
...
$lienRSCI="http://".$_SERVER['HTTP_HOST']."/RSCISynthese_.php?lien=PAIE/".$idMission;
...
syntheseFinale($document, "paie_personnel", $ID_mission);
...
echo '<a id="icone_paie" href="includes/google_docs_viewer.php?id=Dossier_Rapport/Sauvegarde_sortie/Word/RSCI_Cycle_Paie('.$DATE_paie.').docx&nomfichier=" TARGET="_BLANK"><img src="Dossier_Rapport/img/telecharger.png" height="28px" width="28px"/></a>';
