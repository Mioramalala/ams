...
$lienRA="http://".$_SERVER['HTTP_HOST']."/RA_liengenerer.php?lien=Seuil_de_signification/".$idMission;
...
echo '<a id="icone_seuil" href="includes/google_docs_viewer.php?id=Dossier_Rapport/Sauvegarde_sortie/Word/SEUIL_SIGNIFICATION(' . $DATE_GENERATION . ').docx&amp;nomfichier=" TARGET="_BLANK"><img src="Dossier_Rapport/img/telecharger.png" height="28px" width="28px"/></a>';
?>