...
<?php
	function afficherLien($nom, $idLien){
		...
		//echo "lien:".$lien1;
		if(!empty($lien1)) { 
		echo "<a id='".$idLien."' href=Dossier_Rapport/Sauvegarde_sortie/Excel/".$lien1." TARGET='_BLANK'><img src='../Dossier_Rapport/img/Excel.png' height='28px' width='28px'/></a>";                        	
		}
	}
?>
...
<div id="gauche" style="padding-top:20px; padding-left:50px;">
	<table >
		...
		<tr>
			...
			<td class="Rap_rond" id="Rap_L_direc">Lettre à la direction</td>
                ...
                <div id="Sous_Memorandum" style="display:none" class="rapIntermediaire">
                            <table style="background:url('Dossier_Rapport/img/fong_img.png'); background-repeat:no-repeat"  width="485" height="112" border="0"  >
                                ...
                                <tr class="s_slash">
                                    ...
                                    <td align="center"><strong >Générer</strong></td>
                                    <td><div align="center" id="ltr_affirm"></div></td>
                                </tr>
			...
			<table style="background:url('Dossier_Rapport/img/fong_img.png'); background-repeat:no-repeat"  width="485" height="112" border="0"  >
				...
				<tr class="s_slash" style="margin-top: 5px;">
					...
					<td><div align="center" id="ltr_cycle_achat">
						...
						if(!empty($lien1)) { ?>
						<a id="icone_achat" href=<?php echo "Dossier_Rapport/Sauvegarde_sortie/Word/".$lien1;?> TARGET="_BLANK"><img src="../Dossier_Rapport/img/telecharger.png" height="28px" width="28px"/></a>                        
						<?php
						}
						?>    
					</div></td>
				...
				<tr class="s_slash">
					...
					<td><div align="center" id="ltr_cycle_immo">
						...
						if(!empty($lien2)) { ?>
						<a id="icone_immo" href=<?php echo "Dossier_Rapport/Sauvegarde_sortie/Word/".$lien2;?> TARGET="_BLANK"><img src="../Dossier_Rapport/img/telecharger.png" height="28px" width="28px"/></a>                        
						<?php
						}
						?>                          
					</div></td>
				...
				<tr class="s_slash">
					...
					<td><div align="center" id="ltr_rsci_stocks">
					  <?php $lien3 = verifRapportExistant($utilisateur,"RSCI_Cycle_Stocks",$_SESSION['idMission']);
						if(!empty($lien3)) {
						?>
						<a id="icone_stock" href=<?php echo "Dossier_Rapport/Sauvegarde_sortie/Word/".$lien3;?> TARGET="_BLANK"><img src="../Dossier_Rapport/img/telecharger.png" height="28px" width="28px"/></a>                        
						<?php
						}
						?>                               
					</div></td>
				...
				<tr class="s_slash">
					...
					<?php $lien4 = verifRapportExistant($utilisateur,"RSCI_Cycle_Paie",$_SESSION['idMission']);
						if(!empty($lien4)) { 
					?>
						<a id="icone_paie" href=<?php echo "Dossier_Rapport/Sauvegarde_sortie/Word/".$lien4;?> TARGET="_BLANK"><img src="../Dossier_Rapport/img/telecharger.png" height="28px" width="28px"/></a>                        
					<?php
						}
					?>
					</div>
				...
				<tr class="s_slash">
					...
					<?php $lien5 = verifRapportExistant($utilisateur,"RSCI_Cycle_Recette",$_SESSION['idMission']);
						if(!empty($lien5)) { 
					?>
						<a id="icone_recette" href=<?php echo "Dossier_Rapport/Sauvegarde_sortie/Word/".$lien5;?> TARGET="_BLANK"><img src="../Dossier_Rapport/img/telecharger.png" height="28px" width="28px"/></a>                        
					<?php
						}
					?>
					</div></td>
				...
				<tr class="s_slash">
					...
					<?php $lien6 = verifRapportExistant($utilisateur,"RSCI_Cycle_Depense",$_SESSION['idMission']);
						if(!empty($lien6)) { 
					?>
						<a id="icone_depense" href=<?php echo "Dossier_Rapport/Sauvegarde_sortie/Word/".$lien6;?> TARGET="_BLANK"><img src="../Dossier_Rapport/img/telecharger.png" height="28px" width="28px"/></a>                        
					<?php
						}
					?>
					</div>
				...
				<tr class="s_slash">
					...
					<?php $lien7 = verifRapportExistant($utilisateur,"RSCI_Cycle_Ventes",$_SESSION['idMission']);
						if(!empty($lien7)) { 
					?>
						<a id="icone_vente" href=<?php echo "Dossier_Rapport/Sauvegarde_sortie/Word/".$lien7;?> TARGET="_BLANK"><img src="../Dossier_Rapport/img/telecharger.png" height="28px" width="28px"/></a>                        
					<?php
						}
					?>
					</div></td>
				...
				<tr class="s_slash">
					...
					<?php $lien8 = verifRapportExistant($utilisateur,"RSCI_Environnement_Control",$_SESSION['idMission']);
						if(!empty($lien8)) { 
					?>
						<a id="icone_env" href=<?php echo "Dossier_Rapport/Sauvegarde_sortie/Word/".$lien8;?> TARGET="_BLANK"><img src="../Dossier_Rapport/img/telecharger.png" height="28px" width="28px"/></a>                        
					<?php
						}
					?>
					</div></td>
				...
				<tr class="s_slash">
					...
					<?php $lien9 = verifRapportExistant($utilisateur,"RSCI_Systeme_information",$_SESSION['idMission']);
						if(!empty($lien9)) { 
					?>
						<a id="icone_info" href=<?php echo "Dossier_Rapport/Sauvegarde_sortie/Word/".$lien9;?> TARGET="_BLANK"><img src="../Dossier_Rapport/img/telecharger.png" height="28px" width="28px"/></a>                        
					<?php
						}
					?>
					</div></td>
				...
				<tr class="s_slash">
					...
					<?php $lien10 = verifRapportExistant($utilisateur,"RSCI_SYNTHESE",$_SESSION['idMission']);
						if(!empty($lien10)) { 
					?>
						<a id="icone_synthese" href=<?php echo "Dossier_Rapport/Sauvegarde_sortie/Word/".$lien10;?> TARGET="_BLANK"><img src="../Dossier_Rapport/img/telecharger.png" height="28px" width="28px"/></a>                        
					<?php
						}
					?>
					</div></td>
			...
			<table style="background:url('Dossier_Rapport/img/fong_img.png'); background-repeat:no-repeat"  width="485" height="112" border="0"  >
				...
				<tr class="s_slash">
					...
					<td><div align="center" id="synthese_risque">
						...
						if(!empty($lien1)) { ?>
						<a id="icone_risque" href=<?php echo "Dossier_Rapport/Sauvegarde_sortie/Word/".$lien1;?> TARGET="_BLANK"><img src="../Dossier_Rapport/img/telecharger.png" height="28px" width="28px"/></a>                        
						<?php
						}
						?>                           
					</div></td>
				...
				<tr class="s_slash">
					...
					<td><div align="center" id="incidences">
						...
						if(!empty($lien1)) { ?>
						<a id="icone_incidences" href=<?php echo "Dossier_Rapport/Sauvegarde_sortie/Word/".$lien1;?> TARGET="_BLANK"><img src="../Dossier_Rapport/img/telecharger.png" height="28px" width="28px"/></a>                        
						<?php
						}
						?>                              
					</div></td>
				...
				<tr class="s_slash">
					...
					<td><div align="center" id="seuil_signification">
						...
						if(!empty($lien1)) { ?>
						<a id="icone_seuil" href=<?php echo "Dossier_Rapport/Sauvegarde_sortie/Word/".$lien1;?> TARGET="_BLANK"><img src="../Dossier_Rapport/img/telecharger.png" height="28px" width="28px"/></a>                        
						<?php
						}
						?>                           
					</div></td>
				...
				<tr class="s_slash">
					...
					<td><div align="center" id="taux_sondage">
						...
						if(!empty($lien1)) { ?>
						<a id="icone_sondage" href=<?php echo "Dossier_Rapport/Sauvegarde_sortie/Word/".$lien1;?> TARGET="_BLANK"><img src="../Dossier_Rapport/img/telecharger.png" height="28px" width="28px"/></a>                        
						<?php
						}
						?>                                
					</div></td>
				...
				<tr class="s_slash">
					...
					<td><div align="center" id="planification_generale">
						...
						if(!empty($lien1)) { ?>
						<a id="icone_planif" href=<?php echo "Dossier_Rapport/Sauvegarde_sortie/Word/".$lien1;?> TARGET="_BLANK"><img src="../Dossier_Rapport/img/telecharger.png" height="28px" width="28px"/></a>                        
						<?php
						}
						?>   
					</div></td>
				...
				<tr class="s_slash">
					...
					<td><div align="center" id="revues_analytique">
						...
						if(!empty($lien1)) { ?>
						<a id="icone_ra" href=<?php echo "Dossier_Rapport/Sauvegarde_sortie/Excel/".$lien1;?> TARGET="_BLANK"><img src="../Dossier_Rapport/img/Excel.png" height="28px" width="28px"/></a>                        
						<?php
						}
						?>                             
					</div></td>
		...
		<div id="Sous_Rap_In_mission">
			<table style="background:url('Dossier_Rapport/img/fong_img.png'); background-repeat:no-repeat"  width="485" height="112" border="0"  >
				...
				<tr class="s_slash">
					...
					<td align="center">
   <strong id="btn_ltr_affirm" onClick="enregistrerGeneration(<?php print $_SESSION['idMission']; ?>,'affirmation');">Générer</strong></td>
					<td><div align="center" id="ltr_affirm"></div></td>
				</tr>
				<tr class="s_slash">
				...
				<tr class="s_slash">
					...
					<td><div align="center" id="ltr_repartition"></div></td>
				</tr>
