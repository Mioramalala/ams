				...
				success:function(e){
					...
					if(e){
						...
						for(var i=0;i<longuer;i++){
							...
							if(res==25){
								$('div#validate_de').find('#font_label').empty();
								$('div#validate_dd').css({"width":"55px"});
								$('td#validate_de').css({"background-color":"#65c122","background-image":"url(img/CHECK.png)","background-repeat":"no-repeat","background-position":"center"});
							...
							$.ajax({
								...
								success:function(e){
									...
									if(e==15){
										...
										// sao dia mila decommentene ity ?? tinay
...
<div id="fond_Index" align="center">
	...
	<?php 
		require_once($_SERVER["DOCUMENT_ROOT"]."/RSCI/layout/modal/modal-flowchart-upload-depense.php") ;
	?>
	...
	<div id="mess_vide_depense"><?php include $_SERVER["DOCUMENT_ROOT"].'/cycleDepense/Depenseb/sms/mess_non_db.php'; ?></div>
</div>
</body>