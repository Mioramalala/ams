...
$req = $bdd->prepare('UPDATE  tab_utilisateur SET STATUT_CONNEXION = :stat WHERE UTIL_ID ='.$id);
		$req->execute(array(
		'stat' => $zero
	...
	<table id="listUser">
						...
						?>
									<tr height="50px" id="ligne<?php echo $compt;?>"  onclick="radier(<?php echo $idUtil;?>)">
										...
										<td> <img src="icone/btn_power.png" class="deconUser" alt="<?php echo $idUtil;?>" title="Déconnecter" onclick="decon(<?php echo $idUtil;?>)"/> </td>
									</tr>
						<?php	
									$compt++;
								}
