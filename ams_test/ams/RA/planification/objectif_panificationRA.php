...
/////////////////////////////////CHECK ROLE by Sitraka/////////////////////////////
								var RA_PLANIF = "<?php echo $PLANIF_CYCLE ?>";
								switch(RA_PLANIF){
									case "fond":
										checkRole(48, RA_PLANIF);
										break;
									case "immo":
										checkRole(9, RA_PLANIF);
										break;
									case "immofi":
										checkRole(10, RA_PLANIF);
										break;
									case "stock":
										checkRole(18, RA_PLANIF);
										break;
									case "tresorerie":
										checkRole(29, RA_PLANIF);
										break;
									case "charge":
										checkRole(4, RA_PLANIF);
										break;
									case "vente":
										checkRole(39, RA_PLANIF);
										break;
									case "paie":
										checkRole(23, RA_PLANIF);
										break;
									case "impot":
										checkRole(51, RA_PLANIF);
										break;
									case "emprunt":
										checkRole(54, RA_PLANIF);
										break;
									case "dcd":
										checkRole(58, RA_PLANIF);
										break;
