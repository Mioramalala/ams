 <?php
		...
		$sqlA = "INSERT INTO tab_gl_auxc4 (GL_AUXC4_COMPTE,GL_AUXC4_CODE,GL_AUXC4_DATE,GL_AUXC4_JL,GL_AUXC4_LIGNE,GL_AUXC4_REF, 	 	 	GL_AUXC4_LIBELLE,GL_AUXC4_ECHEANCE,GL_AUXC4_LETTRAGE,GL_AUXC4_DEBIT,GL_AUXC4_CREDIT,GL_AUXC4_SOLDE,GL_AUXC4_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC4_CHOIX_ANNEE,GL_AUXC4_DOCUMENT,UTIL_ID) VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]','$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]','A- Fonds propres','$mission_id','$entrepriseId','$annee','$fileName','$UTIL_ID')";
		$bdd->query($sqlA);
		...
		$sqlJ = "INSERT INTO tab_gl_auxc4 (GL_AUXC4_COMPTE,GL_AUXC4_CODE,GL_AUXC4_DATE,GL_AUXC4_JL,GL_AUXC4_LIGNE,GL_AUXC4_REF, 	 	 	GL_AUXC4_LIBELLE,GL_AUXC4_ECHEANCE,GL_AUXC4_LETTRAGE,GL_AUXC4_DEBIT,GL_AUXC4_CREDIT,GL_AUXC4_SOLDE,GL_AUXC4_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC4_CHOIX_ANNEE,GL_AUXC4_DOCUMENT,UTIL_IDD) 
		...
		$sqlB = "INSERT INTO tab_gl_auxc4 (GL_AUXC4_COMPTE,GL_AUXC4_CODE,GL_AUXC4_DATE,GL_AUXC4_JL,GL_AUXC4_LIGNE,GL_AUXC4_REF, 	 	 	GL_AUXC4_LIBELLE,GL_AUXC4_ECHEANCE,GL_AUXC4_LETTRAGE,GL_AUXC4_DEBIT,GL_AUXC4_CREDIT,GL_AUXC4_SOLDE,GL_AUXC4_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC4_CHOIX_ANNEE,GL_AUXC4_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlC = "INSERT INTO tab_gl_auxc4 (GL_AUXC4_COMPTE,GL_AUXC4_CODE,GL_AUXC4_DATE,GL_AUXC4_JL,GL_AUXC4_LIGNE,GL_AUXC4_REF, 	 	 	GL_AUXC4_LIBELLE,GL_AUXC4_ECHEANCE,GL_AUXC4_LETTRAGE,GL_AUXC4_DEBIT,GL_AUXC4_CREDIT,GL_AUXC4_SOLDE,GL_AUXC4_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC4_CHOIX_ANNEE,GL_AUXC4_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlD = "INSERT INTO tab_gl_auxc4 (GL_AUXC4_COMPTE,GL_AUXC4_CODE,GL_AUXC4_DATE,GL_AUXC4_JL,GL_AUXC4_LIGNE,GL_AUXC4_REF, 	 	 	GL_AUXC4_LIBELLE,GL_AUXC4_ECHEANCE,GL_AUXC4_LETTRAGE,GL_AUXC4_DEBIT,GL_AUXC4_CREDIT,GL_AUXC4_SOLDE,GL_AUXC4_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC4_CHOIX_ANNEE,GL_AUXC4_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlE = "INSERT INTO tab_gl_auxc4 (GL_AUXC4_COMPTE,GL_AUXC4_CODE,GL_AUXC4_DATE,GL_AUXC4_JL,GL_AUXC4_LIGNE,GL_AUXC4_REF, 	 	 	GL_AUXC4_LIBELLE,GL_AUXC4_ECHEANCE,GL_AUXC4_LETTRAGE,GL_AUXC4_DEBIT,GL_AUXC4_CREDIT,GL_AUXC4_SOLDE,GL_AUXC4_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC4_CHOIX_ANNEE,GL_AUXC4_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlF = "INSERT INTO tab_gl_auxc4 (GL_AUXC4_COMPTE,GL_AUXC4_CODE,GL_AUXC4_DATE,GL_AUXC4_JL,GL_AUXC4_LIGNE,GL_AUXC4_REF, 	 	 	GL_AUXC4_LIBELLE,GL_AUXC4_ECHEANCE,GL_AUXC4_LETTRAGE,GL_AUXC4_DEBIT,GL_AUXC4_CREDIT,GL_AUXC4_SOLDE,GL_AUXC4_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC4_CHOIX_ANNEE,GL_AUXC4_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlG = "INSERT INTO tab_gl_auxc4 (GL_AUXC4_COMPTE,GL_AUXC4_CODE,GL_AUXC4_DATE,GL_AUXC4_JL,GL_AUXC4_LIGNE,GL_AUXC4_REF, 	 	 	GL_AUXC4_LIBELLE,GL_AUXC4_ECHEANCE,GL_AUXC4_LETTRAGE,GL_AUXC4_DEBIT,GL_AUXC4_CREDIT,GL_AUXC4_SOLDE,GL_AUXC4_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC4_CHOIX_ANNEE,GL_AUXC4_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlH = "INSERT INTO tab_gl_auxc4 (GL_AUXC4_COMPTE,GL_AUXC4_CODE,GL_AUXC4_DATE,GL_AUXC4_JL,GL_AUXC4_LIGNE,GL_AUXC4_REF, 	 	 	GL_AUXC4_LIBELLE,GL_AUXC4_ECHEANCE,GL_AUXC4_LETTRAGE,GL_AUXC4_DEBIT,GL_AUXC4_CREDIT,GL_AUXC4_SOLDE,GL_AUXC4_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC4_CHOIX_ANNEE,GL_AUXC4_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlI = "INSERT INTO tab_gl_auxc4 (GL_AUXC4_COMPTE,GL_AUXC4_CODE,GL_AUXC4_DATE,GL_AUXC4_JL,GL_AUXC4_LIGNE,GL_AUXC4_REF, 	 	 	GL_AUXC4_LIBELLE,GL_AUXC4_ECHEANCE,GL_AUXC4_LETTRAGE,GL_AUXC4_DEBIT,GL_AUXC4_CREDIT,GL_AUXC4_SOLDE,GL_AUXC4_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC4_CHOIX_ANNEE,GL_AUXC4_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlK = "INSERT INTO tab_gl_auxc4 (GL_AUXC4_COMPTE,GL_AUXC4_CODE,GL_AUXC4_DATE,GL_AUXC4_JL,GL_AUXC4_LIGNE,GL_AUXC4_REF, 	 	 	GL_AUXC4_LIBELLE,GL_AUXC4_ECHEANCE,GL_AUXC4_LETTRAGE,GL_AUXC4_DEBIT,GL_AUXC4_CREDIT,GL_AUXC4_SOLDE,GL_AUXC4_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC4_CHOIX_ANNEE,GL_AUXC4_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
