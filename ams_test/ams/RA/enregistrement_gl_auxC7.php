 <?php
		...
		$sqlA = "INSERT INTO tab_gl_auxc7 (GL_AUXC7_COMPTE,GL_AUXC7_CODE,GL_AUXC7_DATE,GL_AUXC7_JL,GL_AUXC7_LIGNE,GL_AUXC7_REF, 	 	 	GL_AUXC7_LIBELLE,GL_AUXC7_ECHEANCE,GL_AUXC7_LETTRAGE,GL_AUXC7_DEBIT,GL_AUXC7_CREDIT,GL_AUXC7_SOLDE,GL_AUXC7_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC7_CHOIX_ANNEE,GL_AUXC7_DOCUMENT,UTIL_ID) VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]','$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]','A- Fonds propres','$mission_id','$entrepriseId','$annee','$fileName','$UTIL_ID')";
		$bdd->query($sqlA);
		...
		$sqlJ = "INSERT INTO tab_gl_auxc7 (GL_AUXC7_COMPTE,GL_AUXC7_CODE,GL_AUXC7_DATE,GL_AUXC7_JL,GL_AUXC7_LIGNE,GL_AUXC7_REF, 	 	 	GL_AUXC7_LIBELLE,GL_AUXC7_ECHEANCE,GL_AUXC7_LETTRAGE,GL_AUXC7_DEBIT,GL_AUXC7_CREDIT,GL_AUXC7_SOLDE,GL_AUXC7_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC7_CHOIX_ANNEE,GL_AUXC7_DOCUMENT,UTIL_ID) 
		...
		$sqlB = "INSERT INTO tab_gl_auxc7 (GL_AUXC7_COMPTE,GL_AUXC7_CODE,GL_AUXC7_DATE,GL_AUXC7_JL,GL_AUXC7_LIGNE,GL_AUXC7_REF, 	 	 	GL_AUXC7_LIBELLE,GL_AUXC7_ECHEANCE,GL_AUXC7_LETTRAGE,GL_AUXC7_DEBIT,GL_AUXC7_CREDIT,GL_AUXC7_SOLDE,GL_AUXC7_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC7_CHOIX_ANNEE,GL_AUXC7_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlC = "INSERT INTO tab_gl_auxc7 (GL_AUXC7_COMPTE,GL_AUXC7_CODE,GL_AUXC7_DATE,GL_AUXC7_JL,GL_AUXC7_LIGNE,GL_AUXC7_REF, 	 	 	GL_AUXC7_LIBELLE,GL_AUXC7_ECHEANCE,GL_AUXC7_LETTRAGE,GL_AUXC7_DEBIT,GL_AUXC7_CREDIT,GL_AUXC7_SOLDE,GL_AUXC7_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC7_CHOIX_ANNEE,GL_AUXC7_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlD = "INSERT INTO tab_gl_auxc7 (GL_AUXC7_COMPTE,GL_AUXC7_CODE,GL_AUXC7_DATE,GL_AUXC7_JL,GL_AUXC7_LIGNE,GL_AUXC7_REF, 	 	 	GL_AUXC7_LIBELLE,GL_AUXC7_ECHEANCE,GL_AUXC7_LETTRAGE,GL_AUXC7_DEBIT,GL_AUXC7_CREDIT,GL_AUXC7_SOLDE,GL_AUXC7_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC7_CHOIX_ANNEE,GL_AUXC7_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlE = "INSERT INTO tab_gl_auxc7 (GL_AUXC7_COMPTE,GL_AUXC7_CODE,GL_AUXC7_DATE,GL_AUXC7_JL,GL_AUXC7_LIGNE,GL_AUXC7_REF, 	 	 	GL_AUXC7_LIBELLE,GL_AUXC7_ECHEANCE,GL_AUXC7_LETTRAGE,GL_AUXC7_DEBIT,GL_AUXC7_CREDIT,GL_AUXC7_SOLDE,GL_AUXC7_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC7_CHOIX_ANNEE,GL_AUXC7_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlF = "INSERT INTO tab_gl_auxc7 (GL_AUXC7_COMPTE,GL_AUXC7_CODE,GL_AUXC7_DATE,GL_AUXC7_JL,GL_AUXC7_LIGNE,GL_AUXC7_REF, 	 	 	GL_AUXC7_LIBELLE,GL_AUXC7_ECHEANCE,GL_AUXC7_LETTRAGE,GL_AUXC7_DEBIT,GL_AUXC7_CREDIT,GL_AUXC7_SOLDE,GL_AUXC7_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC7_CHOIX_ANNEE,GL_AUXC7_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlG = "INSERT INTO tab_gl_auxc7 (GL_AUXC7_COMPTE,GL_AUXC7_CODE,GL_AUXC7_DATE,GL_AUXC7_JL,GL_AUXC7_LIGNE,GL_AUXC7_REF, 	 	 	GL_AUXC7_LIBELLE,GL_AUXC7_ECHEANCE,GL_AUXC7_LETTRAGE,GL_AUXC7_DEBIT,GL_AUXC7_CREDIT,GL_AUXC7_SOLDE,GL_AUXC7_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC7_CHOIX_ANNEE,GL_AUXC7_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlH = "INSERT INTO tab_gl_auxc7 (GL_AUXC7_COMPTE,GL_AUXC7_CODE,GL_AUXC7_DATE,GL_AUXC7_JL,GL_AUXC7_LIGNE,GL_AUXC7_REF, 	 	 	GL_AUXC7_LIBELLE,GL_AUXC7_ECHEANCE,GL_AUXC7_LETTRAGE,GL_AUXC7_DEBIT,GL_AUXC7_CREDIT,GL_AUXC7_SOLDE,GL_AUXC7_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC7_CHOIX_ANNEE,GL_AUXC7_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlI = "INSERT INTO tab_gl_auxc7 (GL_AUXC7_COMPTE,GL_AUXC7_CODE,GL_AUXC7_DATE,GL_AUXC7_JL,GL_AUXC7_LIGNE,GL_AUXC7_REF, 	 	 	GL_AUXC7_LIBELLE,GL_AUXC7_ECHEANCE,GL_AUXC7_LETTRAGE,GL_AUXC7_DEBIT,GL_AUXC7_CREDIT,GL_AUXC7_SOLDE,GL_AUXC7_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC7_CHOIX_ANNEE,GL_AUXC7_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlK = "INSERT INTO tab_gl_auxc7 (GL_AUXC7_COMPTE,GL_AUXC7_CODE,GL_AUXC7_DATE,GL_AUXC7_JL,GL_AUXC7_LIGNE,GL_AUXC7_REF, 	 	 	GL_AUXC7_LIBELLE,GL_AUXC7_ECHEANCE,GL_AUXC7_LETTRAGE,GL_AUXC7_DEBIT,GL_AUXC7_CREDIT,GL_AUXC7_SOLDE,GL_AUXC7_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC7_CHOIX_ANNEE,GL_AUXC7_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
