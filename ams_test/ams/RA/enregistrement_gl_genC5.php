 <?php
		...
		$sqlA = "INSERT INTO tab_gl_genc5 (GL_GENC5_COMPTES,GL_GENC5_DATE,GL_GENC5_JL,GL_GENC5_REF,GL_GENC5_LIBELLE,GL_GENC5_LEFT,GL_GENC5_DEBIT,GL_GENC5_CREDIT,GL_GENC5_SOLDE,GL_GENC5_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC5_CHOIX_ANNEE,GL_GENC5_DOCUMENT,UTIL_ID)VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]','$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','A- Fonds propres','$mission_id','$entrepriseId','$annee','$fileName','$UTIL_ID')";
		$bdd->query($sqlA);
		...
		$sqlJ = "INSERT INTO tab_gl_genc5 (GL_GENC5_COMPTES,GL_GENC5_DATE,GL_GENC5_JL,GL_GENC5_REF,GL_GENC5_LIBELLE,GL_GENC5_LEFT,GL_GENC5_DEBIT,GL_GENC5_CREDIT,GL_GENC5_SOLDE,GL_GENC5_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC5_CHOIX_ANNEE,GL_GENC5_DOCUMENT,UTIL_ID) 
		...
		$sqlB = "INSERT INTO tab_gl_genc5 (GL_GENC5_COMPTES,GL_GENC5_DATE,GL_GENC5_JL,GL_GENC5_REF,GL_GENC5_LIBELLE,GL_GENC5_LEFT,GL_GENC5_DEBIT,GL_GENC5_CREDIT,GL_GENC5_SOLDE,GL_GENC5_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC5_CHOIX_ANNEE,GL_GENC5_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlC = "INSERT INTO tab_gl_genc5 (GL_GENC5_COMPTES,GL_GENC5_DATE,GL_GENC5_JL,GL_GENC5_REF,GL_GENC5_LIBELLE,GL_GENC5_LEFT,GL_GENC5_DEBIT,GL_GENC5_CREDIT,GL_GENC5_SOLDE,GL_GENC5_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC5_CHOIX_ANNEE,GL_GENC5_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlD = "INSERT INTO tab_gl_genc5 (GL_GENC5_COMPTES,GL_GENC5_DATE,GL_GENC5_JL,GL_GENC5_REF,GL_GENC5_LIBELLE,GL_GENC5_LEFT,GL_GENC5_DEBIT,GL_GENC5_CREDIT,GL_GENC5_SOLDE,GL_GENC5_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC5_CHOIX_ANNEE,GL_GENC5_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlE = "INSERT INTO tab_gl_genc5 (GL_GENC5_COMPTES,GL_GENC5_DATE,GL_GENC5_JL,GL_GENC5_REF,GL_GENC5_LIBELLE,GL_GENC5_LEFT,GL_GENC5_DEBIT,GL_GENC5_CREDIT,GL_GENC5_SOLDE,GL_GENC5_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC5_CHOIX_ANNEE,GL_GENC5_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlF = "INSERT INTO tab_gl_genc5 (GL_GENC5_COMPTES,GL_GENC5_DATE,GL_GENC5_JL,GL_GENC5_REF,GL_GENC5_LIBELLE,GL_GENC5_LEFT,GL_GENC5_DEBIT,GL_GENC5_CREDIT,GL_GENC5_SOLDE,GL_GENC5_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC5_CHOIX_ANNEE,GL_GENC5_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlG = "INSERT INTO tab_gl_genc5 (GL_GENC5_COMPTES,GL_GENC5_DATE,GL_GENC5_JL,GL_GENC5_REF,GL_GENC5_LIBELLE,GL_GENC5_LEFT,GL_GENC5_DEBIT,GL_GENC5_CREDIT,GL_GENC5_SOLDE,GL_GENC5_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC5_CHOIX_ANNEE,GL_GENC5_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlH = "INSERT INTO tab_gl_genc5 (GL_GENC5_COMPTES,GL_GENC5_DATE,GL_GENC5_JL,GL_GENC5_REF,GL_GENC5_LIBELLE,GL_GENC5_LEFT,GL_GENC5_DEBIT,GL_GENC5_CREDIT,GL_GENC5_SOLDE,GL_GENC5_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC5_CHOIX_ANNEE,GL_GENC5_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlI = "INSERT INTO tab_gl_genc5 (GL_GENC5_COMPTES,GL_GENC5_DATE,GL_GENC5_JL,GL_GENC5_REF,GL_GENC5_LIBELLE,GL_GENC5_LEFT,GL_GENC5_DEBIT,GL_GENC5_CREDIT,GL_GENC5_SOLDE,GL_GENC5_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC5_CHOIX_ANNEE,GL_GENC5_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlK = "INSERT INTO tab_gl_genc5 (GL_GENC5_COMPTES,GL_GENC5_DATE,GL_GENC5_JL,GL_GENC5_REF,GL_GENC5_LIBELLE,GL_GENC5_LEFT,GL_GENC5_DEBIT,GL_GENC5_CREDIT,GL_GENC5_SOLDE,GL_GENC5_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC5_CHOIX_ANNEE,GL_GENC5_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
