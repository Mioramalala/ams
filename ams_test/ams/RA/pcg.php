...
//////////////////////////validation et insertion///////////////////////////	
		...
		<!--form-->
			<table class="table_pcg" width="980">
				...
				<?php
					...
					$reponse = $bdd->query('SELECT id_bal_gen_miss,compt1,compt2,groupBal,cycle FROM tab_bal_gen_mission WHERE id_mission='.$mission_id.' ORDER BY compt1');
					$compte=0;
	...
	else
	{
			...
			if($found == 1){
				...
				$reponse = $bdd->query('SELECT id_bal_gen_miss,compt1,compt2,groupBal,cycle FROM tab_bal_gen_mission WHERE id_mission='.$new_mission_id.' ORDER BY compt1');	
