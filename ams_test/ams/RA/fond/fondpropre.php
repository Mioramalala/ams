...
<html>
	<head>
		...
		$(function()
		{
				...
				$('#bt_synthese_fond').click(function(){
					...
					var user = checkRole(49);
					if(user.superviseur || user.admin || user.tache){
		...
		$(function(){
				$('#bt_conclusion_fond').click(function(){
					//////////////CHECK ROLE by Sitraka/////////////////////////
					var user = checkRole(49);
					if(user.superviseur || user.admin){
		...
		/////////Function Check Role by Sitraka///////////////////////////
	...
	<body>
		...
		<table width="100%"  style="text-align:center;">
					...
					<tr>
						<td height="5" ><label style="color:black; font-size:16px;">Etapes à suivre</label></td>
					</tr>
