 <?php
		...
		$sqlA = "INSERT INTO tab_gl_auxc5 (GL_AUXC5_COMPTE,GL_AUXC5_CODE,GL_AUXC5_DATE,GL_AUXC5_JL,GL_AUXC5_LIGNE,GL_AUXC5_REF, 	 	 	GL_AUXC5_LIBELLE,GL_AUXC5_ECHEANCE,GL_AUXC5_LETTRAGE,GL_AUXC5_DEBIT,GL_AUXC5_CREDIT,GL_AUXC5_SOLDE,GL_AUXC5_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC5_CHOIX_ANNEE,GL_AUXC5_DOCUMENT,UTIL_ID) VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]','$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]','A- Fonds propres','$mission_id','$entrepriseId','$annee','$fileName','$UTIL_ID')";
		$bdd->query($sqlA);
		...
		$sqlJ = "INSERT INTO tab_gl_auxc5 (GL_AUXC5_COMPTE,GL_AUXC5_CODE,GL_AUXC5_DATE,GL_AUXC5_JL,GL_AUXC5_LIGNE,GL_AUXC5_REF, 	 	 	GL_AUXC5_LIBELLE,GL_AUXC5_ECHEANCE,GL_AUXC5_LETTRAGE,GL_AUXC5_DEBIT,GL_AUXC5_CREDIT,GL_AUXC5_SOLDE,GL_AUXC5_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC5_CHOIX_ANNEE,GL_AUXC5_DOCUMENT,UTIL_ID) 
		...
		$sqlB = "INSERT INTO tab_gl_auxc5 (GL_AUXC5_COMPTE,GL_AUXC5_CODE,GL_AUXC5_DATE,GL_AUXC5_JL,GL_AUXC5_LIGNE,GL_AUXC5_REF, 	 	 	GL_AUXC5_LIBELLE,GL_AUXC5_ECHEANCE,GL_AUXC5_LETTRAGE,GL_AUXC5_DEBIT,GL_AUXC5_CREDIT,GL_AUXC5_SOLDE,GL_AUXC5_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC5_CHOIX_ANNEE,GL_AUXC5_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlC = "INSERT INTO tab_gl_auxc5 (GL_AUXC5_COMPTE,GL_AUXC5_CODE,GL_AUXC5_DATE,GL_AUXC5_JL,GL_AUXC5_LIGNE,GL_AUXC5_REF, 	 	 	GL_AUXC5_LIBELLE,GL_AUXC5_ECHEANCE,GL_AUXC5_LETTRAGE,GL_AUXC5_DEBIT,GL_AUXC5_CREDIT,GL_AUXC5_SOLDE,GL_AUXC5_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC5_CHOIX_ANNEE,GL_AUXC5_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlD = "INSERT INTO tab_gl_auxc5 (GL_AUXC5_COMPTE,GL_AUXC5_CODE,GL_AUXC5_DATE,GL_AUXC5_JL,GL_AUXC5_LIGNE,GL_AUXC5_REF, 	 	 	GL_AUXC5_LIBELLE,GL_AUXC5_ECHEANCE,GL_AUXC5_LETTRAGE,GL_AUXC5_DEBIT,GL_AUXC5_CREDIT,GL_AUXC5_SOLDE,GL_AUXC5_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC5_CHOIX_ANNEE,GL_AUXC5_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlE = "INSERT INTO tab_gl_auxc5 (GL_AUXC5_COMPTE,GL_AUXC5_CODE,GL_AUXC5_DATE,GL_AUXC5_JL,GL_AUXC5_LIGNE,GL_AUXC5_REF, 	 	 	GL_AUXC5_LIBELLE,GL_AUXC5_ECHEANCE,GL_AUXC5_LETTRAGE,GL_AUXC5_DEBIT,GL_AUXC5_CREDIT,GL_AUXC5_SOLDE,GL_AUXC5_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC5_CHOIX_ANNEE,GL_AUXC5_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlF = "INSERT INTO tab_gl_auxc5 (GL_AUXC5_COMPTE,GL_AUXC5_CODE,GL_AUXC5_DATE,GL_AUXC5_JL,GL_AUXC5_LIGNE,GL_AUXC5_REF, 	 	 	GL_AUXC5_LIBELLE,GL_AUXC5_ECHEANCE,GL_AUXC5_LETTRAGE,GL_AUXC5_DEBIT,GL_AUXC5_CREDIT,GL_AUXC5_SOLDE,GL_AUXC5_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC5_CHOIX_ANNEE,GL_AUXC5_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlG = "INSERT INTO tab_gl_auxc5 (GL_AUXC5_COMPTE,GL_AUXC5_CODE,GL_AUXC5_DATE,GL_AUXC5_JL,GL_AUXC5_LIGNE,GL_AUXC5_REF, 	 	 	GL_AUXC5_LIBELLE,GL_AUXC5_ECHEANCE,GL_AUXC5_LETTRAGE,GL_AUXC5_DEBIT,GL_AUXC5_CREDIT,GL_AUXC5_SOLDE,GL_AUXC5_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC5_CHOIX_ANNEE,GL_AUXC5_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlH = "INSERT INTO tab_gl_auxc5 (GL_AUXC5_COMPTE,GL_AUXC5_CODE,GL_AUXC5_DATE,GL_AUXC5_JL,GL_AUXC5_LIGNE,GL_AUXC5_REF, 	 	 	GL_AUXC5_LIBELLE,GL_AUXC5_ECHEANCE,GL_AUXC5_LETTRAGE,GL_AUXC5_DEBIT,GL_AUXC5_CREDIT,GL_AUXC5_SOLDE,GL_AUXC5_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC5_CHOIX_ANNEE,GL_AUXC5_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlI = "INSERT INTO tab_gl_auxc5 (GL_AUXC5_COMPTE,GL_AUXC5_CODE,GL_AUXC5_DATE,GL_AUXC5_JL,GL_AUXC5_LIGNE,GL_AUXC5_REF, 	 	 	GL_AUXC5_LIBELLE,GL_AUXC5_ECHEANCE,GL_AUXC5_LETTRAGE,GL_AUXC5_DEBIT,GL_AUXC5_CREDIT,GL_AUXC5_SOLDE,GL_AUXC5_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC5_CHOIX_ANNEE,GL_AUXC5_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
		...
		$sqlK = "INSERT INTO tab_gl_auxc5 (GL_AUXC5_COMPTE,GL_AUXC5_CODE,GL_AUXC5_DATE,GL_AUXC5_JL,GL_AUXC5_LIGNE,GL_AUXC5_REF, 	 	 	GL_AUXC5_LIBELLE,GL_AUXC5_ECHEANCE,GL_AUXC5_LETTRAGE,GL_AUXC5_DEBIT,GL_AUXC5_CREDIT,GL_AUXC5_SOLDE,GL_AUXC5_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_AUXC5_CHOIX_ANNEE,GL_AUXC5_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		'$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','$tableCpt10[$i]','$tableCpt11[$i]','$tableCpt12[$i]',
