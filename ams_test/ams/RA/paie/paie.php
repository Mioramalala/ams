...
//////////////Check Role by Sitraka /////////////////
		$(function(){	
			$("#bt_synthese_paie").bind("click", {id : "#bt_synthese_paie"}, checkRole  );
			$("#bt_conclusion_paie").bind("click", {id : "#bt_conclusion_paie"}, checkRole  );
								...
								function checkRole(event){
									...
									var data = JSON.parse(data.responseText);
										if( 
											( (data.admin || data.superviseur || data.tache) && ( event.data.id == "#bt_synthese_paie" || event.data.id == "#enregistrer_page" ) ) ||
											( (data.admin || data.superviseur) && event.data.id == "#bt_conclusion_paie" ) 
										 ){
