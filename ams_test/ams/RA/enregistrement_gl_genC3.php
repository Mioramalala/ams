 <?php
		...
		$sqlA = "INSERT INTO tab_gl_genc3 (GL_GENC3_COMPTES,GL_GENC3_DATE,GL_GENC3_JL,GL_GENC3_REF,GL_GENC3_LIBELLE,GL_GENC3_LEFT,GL_GENC3_DEBIT,GL_GENC3_CREDIT,GL_GENC3_SOLDE,GL_GENC3_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC3_CHOIX_ANNEE,GL_GENC3_DOCUMENT,UTIL_ID)VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]','$tableCpt7[$i]','$tableCpt8[$i]','$tableCpt9[$i]','A- Fonds propres','$mission_id','$entrepriseId','$annee','$fileName','$UTIL_ID')";
		$bdd->query($sqlA);
		...
		$sqlJ = "INSERT INTO tab_gl_genc3 (GL_GENC3_COMPTES,GL_GENC3_DATE,GL_GENC3_JL,GL_GENC3_REF,GL_GENC3_LIBELLE,GL_GENC3_LEFT,GL_GENC3_DEBIT,GL_GENC3_CREDIT,GL_GENC3_SOLDE,GL_GENC3_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC3_CHOIX_ANNEE,GL_GENC3_DOCUMENT,UTIL_ID) 
		...
		$sqlB = "INSERT INTO tab_gl_genc3 (GL_GENC3_COMPTES,GL_GENC3_DATE,GL_GENC3_JL,GL_GENC3_REF,GL_GENC3_LIBELLE,GL_GENC3_LEFT,GL_GENC3_DEBIT,GL_GENC3_CREDIT,GL_GENC3_SOLDE,GL_GENC3_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC3_CHOIX_ANNEE,GL_GENC3_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlC = "INSERT INTO tab_gl_genc3 (GL_GENC3_COMPTES,GL_GENC3_DATE,GL_GENC3_JL,GL_GENC3_REF,GL_GENC3_LIBELLE,GL_GENC3_LEFT,GL_GENC3_DEBIT,GL_GENC3_CREDIT,GL_GENC3_SOLDE,GL_GENC3_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC3_CHOIX_ANNEE,GL_GENC3_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlD = "INSERT INTO tab_gl_genc3 (GL_GENC3_COMPTES,GL_GENC3_DATE,GL_GENC3_JL,GL_GENC3_REF,GL_GENC3_LIBELLE,GL_GENC3_LEFT,GL_GENC3_DEBIT,GL_GENC3_CREDIT,GL_GENC3_SOLDE,GL_GENC3_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC3_CHOIX_ANNEE,GL_GENC3_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlE = "INSERT INTO tab_gl_genc3 (GL_GENC3_COMPTES,GL_GENC3_DATE,GL_GENC3_JL,GL_GENC3_REF,GL_GENC3_LIBELLE,GL_GENC3_LEFT,GL_GENC3_DEBIT,GL_GENC3_CREDIT,GL_GENC3_SOLDE,GL_GENC3_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC3_CHOIX_ANNEE,GL_GENC3_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlF = "INSERT INTO tab_gl_genc3 (GL_GENC3_COMPTES,GL_GENC3_DATE,GL_GENC3_JL,GL_GENC3_REF,GL_GENC3_LIBELLE,GL_GENC3_LEFT,GL_GENC3_DEBIT,GL_GENC3_CREDIT,GL_GENC3_SOLDE,GL_GENC3_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC3_CHOIX_ANNEE,GL_GENC3_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlG = "INSERT INTO tab_gl_genc3 (GL_GENC3_COMPTES,GL_GENC3_DATE,GL_GENC3_JL,GL_GENC3_REF,GL_GENC3_LIBELLE,GL_GENC3_LEFT,GL_GENC3_DEBIT,GL_GENC3_CREDIT,GL_GENC3_SOLDE,GL_GENC3_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC3_CHOIX_ANNEE,GL_GENC3_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlH = "INSERT INTO tab_gl_genc3 (GL_GENC3_COMPTES,GL_GENC3_DATE,GL_GENC3_JL,GL_GENC3_REF,GL_GENC3_LIBELLE,GL_GENC3_LEFT,GL_GENC3_DEBIT,GL_GENC3_CREDIT,GL_GENC3_SOLDE,GL_GENC3_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC3_CHOIX_ANNEE,GL_GENC3_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlI = "INSERT INTO tab_gl_genc3 (GL_GENC3_COMPTES,GL_GENC3_DATE,GL_GENC3_JL,GL_GENC3_REF,GL_GENC3_LIBELLE,GL_GENC3_LEFT,GL_GENC3_DEBIT,GL_GENC3_CREDIT,GL_GENC3_SOLDE,GL_GENC3_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC3_CHOIX_ANNEE,GL_GENC3_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
		...
		$sqlK = "INSERT INTO tab_gl_genc3 (GL_GENC3_COMPTES,GL_GENC3_DATE,GL_GENC3_JL,GL_GENC3_REF,GL_GENC3_LIBELLE,GL_GENC3_LEFT,GL_GENC3_DEBIT,GL_GENC3_CREDIT,GL_GENC3_SOLDE,GL_GENC3_CYCLE,MISSION_ID,ENTREPRISE_ID,GL_GENC3_CHOIX_ANNEE,GL_GENC3_DOCUMENT,UTIL_ID) 
		VALUES ('$tableCpt1[$i]','$tableCpt2[$i]','$tableCpt3[$i]','$tableCpt4[$i]','$tableCpt5[$i]','$tableCpt6[$i]',
