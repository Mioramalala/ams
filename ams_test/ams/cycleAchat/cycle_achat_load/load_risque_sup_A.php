...
$reponse = $bdd->query('SELECT POSTE_CYCL E_ID FROM tab_poste_cle INNER JOIN tab_poste_cycle ON tab_poste_cle.POSTE_CLE_ID=tab_poste_cycle.POSTE_CLE_ID');
...
?>	
		<td class="titre" width="100" align="center">
			<select id="risque_A_sup<?php echo $cpt; ?>" disabled >
