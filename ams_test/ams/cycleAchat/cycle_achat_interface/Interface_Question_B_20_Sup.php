...
<div id="int_Question_B_20_Sup">
	<table width="500">
		...
		<tr style="height:10px">
			...
			Oui<input type="radio" id="rad_Question_Oui_B_20_Sup" name="rad_Question" <?php if($donnees['MISSION_QUESTION_B_OUI_NON']=='OUI') echo 'checked';?> />&nbsp;&nbsp;&nbsp;
			Non <input type="radio" id="rad_Question_Non_B_20_Sup" name="rad_Question" <?php if($donnees['MISSION_QUESTION_B_OUI_NON']=='NON') echo 'checked';?> />
			</td>
		</tr>
		<tr style="height:10px">
		...
		<tr>
			<td align="center"><input type="button" value="Enregistrer" class="bouton" id="int_Quest_B_20_Sup_Enreg"/>
			</td>
		</tr>
	</table>
</div>
