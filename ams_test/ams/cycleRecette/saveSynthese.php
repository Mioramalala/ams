<?php
	...
	if(isset($_POST['synthese'])){
		...
		if( $ligne != 0 ){
			$update = $bdd->exec(" UPDATE tab_synthese_rsci SET SYNTHESE = '".$synthese."',UTIL_ID = '".$UTIL_ID."', RISQUE = '".$risque."' WHERE CYCLE = 'tresorerie' AND MISSION_ID =".$_SESSION['idMission']." ");
		
		$req2=" UPDATE tab_synthese_rsci SET SYNTHESE = '".$synthese."',UTIL_ID = '".$UTIL_ID."', RISQUE = '".$risque."' WHERE CYCLE = 'tresorerie' AND MISSION_ID =".$_SESSION['idMission']." ";
