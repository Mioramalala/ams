...
<!--------------------------------------new doc-------------------------------------------------------------->			
	<form method="post" id="form_btnRecImg" enctype="multipart/form-data" action="#entreprise/postDoc.php" style="display:none;" >
...
<!------------------------------------------------------------------------------------------------------------------------------>
	...
	$(function(){
		document.getElementById("form_btnRecImg").addEventListener("submit",function(e){
			e.preventDefault();
		});
		...
		$("#logoname").change(registering);
		function registering(handle){
			var fd=new FormData(document.getElementById("form_btnRecImg"));
			$.ajax(
				{
					type: 'POST',
					success: function(txt){
							jQuery.facebox({
								 ajax: '../alert/engLogoOk.php',
								 onClosed:function(){
