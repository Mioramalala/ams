...
$req="UPDATE tab_conclusion SET UTIL_ID="'.$UTIL_ID.'",CONCLUSION_COMMENTAIRE="'.$commentaire.'", CONCLUSION_RISQUE="'.$risque.'" WHERE MISSION_ID='.$mission_id.' AND ONCLUSION_ID='.$obj_concl_id_f.'";
