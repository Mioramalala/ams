...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_dc8').click(function(){	
	if((document.getElementById("commentaire_Question_dc8").value=="" && document.getElementById("rad_Question_Non_dc_8").checked== true) || (document.getElementById("rad_Question_Oui_dc_8").checked==false && document.getElementById("rad_Question_NA_dc_8").checked==false && document.getElementById("rad_Question_Non_dc_8").checked==false)){
			...
			$('#message_fermeture_question_dc8').hide();
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:302},
							success:function(){
								$.ajax({
									type:'POST',
	...
	$('#valider_Fermeture_Question_dc8').click(function(){
		$('#message_fermeture_question_dc8').hide();
		$('#fancybox_dc').hide();
		openButtObjdc();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_dc8" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_dc8" />
		</td>
	</tr>
</table>
</div>