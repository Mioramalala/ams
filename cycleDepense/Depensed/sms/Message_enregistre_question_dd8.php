...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_dd8').click(function(){	
	if((document.getElementById("commentaire_Question_dd8").value=="" && document.getElementById("rad_Question_Non_dd_8").checked== true) || (document.getElementById("rad_Question_Oui_dd_8").checked==false && document.getElementById("rad_Question_NA_dd_8").checked==false && document.getElementById("rad_Question_Non_dd_8").checked==false)){
			...
			$('#message_fermeture_question_dd8').hide();
		}
		else{
	...
	$('#valider_Fermeture_Question_dd8').click(function(){
		$('#message_fermeture_question_dd8').hide();
		$('#fancybox_dd').hide();
		openButtObjdd();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_dd8" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_dd8" />
		</td>
	</tr>
</table>
</div>