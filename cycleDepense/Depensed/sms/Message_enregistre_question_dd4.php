...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_dd4').click(function(){	
	if((document.getElementById("commentaire_Question_dd4").value=="" && document.getElementById("rad_Question_Non_dd_4").checked==true) || (document.getElementById("rad_Question_Oui_dd_4").checked==false && document.getElementById("rad_Question_NA_dd_4").checked==false && document.getElementById("rad_Question_Non_dd_4").checked==false)){
			...
			$('#message_fermeture_question_dd4').hide();
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:307},
							success:function(){
								$.ajax({
									type:'POST',
	...
	$('#valider_Fermeture_Question_dd4').click(function(){
		$('#message_fermeture_question_dd4').hide();
		$('#fancybox_dd').hide();
		openButtObjdd();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_dd4" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_dd4" />
		</td>
	</tr>
</table>
</div>