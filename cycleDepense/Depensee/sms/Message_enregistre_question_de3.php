...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_de3').click(function(){	
	if((document.getElementById("commentaire_Question_de3").value=="" && document.getElementById("rad_Question_Non_de_3").checked== true) || (document.getElementById("rad_Question_Oui_de_3").checked==false && document.getElementById("rad_Question_NA_de_3").checked==false && document.getElementById("rad_Question_Non_de_3").checked==false)){
			...
			$('#message_fermeture_question_de3').hide();
				...
				success:function(e){
					...
					if(objectif_id==0){					
						...
						$.ajax({
							...
							data:{commentaire:commentaire, qcm:qcm, question_id:314},
							success:function(){
								$.ajax({
									type:'POST',
	...
	$('#valider_Fermeture_Question_de3').click(function(){
		$('#message_fermeture_question_de3').hide();
		$('#fancybox_de').hide();
		openButtObjde();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_de3" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_de3" />
		</td>
	</tr>
</table>
</div>