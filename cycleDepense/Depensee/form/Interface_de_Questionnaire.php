...
$reponse = $bdd->query('SELECT * FROM tab_objectif INNER JOIN tab_question ON tab_objectif.QUESTION_ID=tab_question.QUESTION_ID WHERE MISSION_ID='.$mission_id.' AND CYCLE_ACHAT_ID=25');
$compte=0;
$couleur='#efefef';
