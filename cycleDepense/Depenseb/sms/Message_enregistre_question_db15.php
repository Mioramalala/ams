...
$(function(){
	...
	$('#enregistrer_Fermeture_Question_db15').click(function(){	
	if((document.getElementById("commentaire_Question_db15").value=="" && document.getElementById("rad_Question_Non_db_15").checked== true) || (document.getElementById("rad_Question_Oui_db_15").checked==false && document.getElementById("rad_Question_NA_db_15").checked==false && document.getElementById("rad_Question_Non_db_15").checked==false)){
			...
			$('#message_fermeture_question_db15').hide();
		}
		else{
	...
	$('#valider_Fermeture_Question_db15').click(function(){
		$('#message_fermeture_question_db15').hide();
		$('#fancybox_db').hide();
		openButtObjdb();
	});
...
<table width="500">
	...
	<tr align="center" height="50">
		<td>
			<input type="button" class="bouton" value="Oui" id="enregistrer_Fermeture_Question_db15" />&nbsp;&nbsp;&nbsp;
			<input type="button" class="bouton" value="Non" id="valider_Fermeture_Question_db15" />
		</td>
	</tr>
</table>
</div>