...
$(function(){
	...
	$('#valid_non_db').click(function(){
		$('#mess_vide_depense').hide();
		document.getElementById("validate_da").disabled=false;
		document.getElementById("validate_db").disabled=false;
...
<div id="mess_non_vide_db">
	<table width="500">
		...
		<tr>
			<td align="center">
				<input type="button" value="OK" class="bouton" id="valid_non_db" />
			</td>
		</tr>
	</table>
</div>