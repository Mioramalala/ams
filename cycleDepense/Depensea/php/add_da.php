...
$req='INSERT INTO tab_fonct_a (FONCT_A_LIGNE, FONCT_A_RESULT, MISSION_ID, POSTE_CYCLE_ID, FONCT_A_NOM,UTIL_ID) VALUES ('.$ligne.','.$result.','.$mission_id.','.$poste_id.',"'.$cycleName.'","'.$UTIL_ID.'")';
