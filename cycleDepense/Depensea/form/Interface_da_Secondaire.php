...
<body>
<div id="fond_Sous_Titre" class="menu_Titre"><label class="marge_Titre">Evaluation du contrôle des depenses
</label><input type="text" id="txt_mission_id_int_da" value="<?php echo $mission_id; ?>" style="margin-left:300;width:20px;margin-top:7px;text-align:center;display:none;" readonly /><label class="margin_Code">Code : FC2 </label>
</div>
...
<!--**************************************Affichage de A.************************************************-->
<div id="interface_da" align="center"><?php include 'Interface_da.php'; ?></div>
<!--*****************************************************************************************************-->
</div>
</body>
</html>