...
<html>
	...
	<table width="100%" height="50" bgcolor="#00698d" style="text-align:left;">
		...
		<div id="bt_milahatra">
			...
			<input type ="button" value = "Enregistrer" onclick="enregistrer_commentaire_impot();" style="width:80;"/>
		</div><br/>
	...
	<div id="" style="float:left;width:600px;height:500px;">
		<table border="1" width="570"">
			...
			<?php
				...
				$soldefinaldebit=0;
				$numerodecompte='';
				$reponse=$bdd->query('SELECT IMPORT_ID,IMPORT_COMPTES,IMPORT_INTITULES,IMPORT_DEBIT,IMPORT_CREDIT,IMPORT_SOLDE,IMPORT_CHOIX_ANNEE FROM  tab_importer where IMPORT_COMPTES like "44%" AND MISSION_ID='.$mission_id.' AND IMPORT_CHOIX_ANNEE="N"');
		...
		<!-------------------------------------------------------------------impot 4N----------------------------------------------------------->
			<?php
				...
				$soldefinaldebit6=0;
				$numerodecompte6='';
				$reponse2=$bdd->query('SELECT IMPORT_ID,IMPORT_COMPTES,IMPORT_INTITULES,IMPORT_DEBIT,IMPORT_CREDIT,IMPORT_SOLDE,IMPORT_CHOIX_ANNEE 	FROM tab_importer where IMPORT_COMPTES like "44%" AND IMPORT_COMPTES not like "441%" AND IMPORT_COMPTES not like "442%" AND IMPORT_COMPTES not like "443%" AND IMPORT_COMPTES not like "445%" AND IMPORT_COMPTES not like "447%" AND IMPORT_COMPTES not like "448%" AND MISSION_ID='.$mission_id.' AND IMPORT_CHOIX_ANNEE="N"');
	...
	<div id="" style="float:left;width:200px;height:500px;">
		<table border="1" width="70%">
			...
			<?php
				$reponse1=$bdd->query('SELECT IMPORT_ID,IMPORT_COMPTES,IMPORT_INTITULES,IMPORT_DEBIT,IMPORT_CREDIT,IMPORT_SOLDE,IMPORT_CHOIX_ANNEE FROM  tab_importer where IMPORT_COMPTES like "44%" AND MISSION_ID='.$mission_id.' AND IMPORT_CHOIX_ANNEE="N-1"');
				$com3=0;
				$soldedebit='';
				$soldecredit='';
				$soldedebitN1=0;
	...
	<div id="" style="float:right;width:260px;height:500px;position:absolute;top:-220px;left:750px;" />
		<table border="1">
			...
			<tr height="70" id="idBalGen<?php echo $com5;?>" onclick="makaid(<?php echo $donnees['IMPORT_ID'];?>)" value="<?php echo $donnees['IMPORT_ID'];?>">
				...
				<td width="90">
					<textarea cols="5" rows="1" id="commentimpot<?php echo $com5 ?>"></textarea>
					<img src="../RA/image/add.jpg" id="com5<?php echo $com5; ?>" onclick="addcommentimpot(this.id,<?php echo $numerodecomptefin[$i]; ?>,<?php echo $com5;?>)" width="20" height="20"/>
				</td>
				<td width="90"><input type="button" id="btn<?php echo $com5;?>" onclick="addRenvoieimpot(this.id, <?php echo $com5;?>)" value="ok" /></td>
			</tr>
			
			<div id="id_renvoie_impot" style="position:absolute;top:180px;left:392px;background-color:#ccc;width:300px;height:200px;display:none">
		...
		<tr height="70" id="idBalGen<?php echo $com6;?>" onclick="makaid(<?php echo $donnees4['IMPORT_ID'];?>)" value="<?php echo $donnees4['IMPORT_ID'];?>">
			...
			<td width="90">
					<textarea cols="5" rows="1" id="commentimpot6<?php echo $com6 ?>"></textarea>
					<img src="../RA/image/add.jpg" id="com6<?php echo $com6; ?>" onclick="addcommentimpot(this.id,<?php echo $numerodecomptefin6[$i]; ?>,<?php echo $com6;?>)" width="20" height="20"/>
				</td>
				<td width="90"><input type="button" id="btn<?php echo $com6;?>" onclick="addRenvoieimpot(this.id, <?php echo $com6;?>)" value="ok" /></td>
			</tr>
			
			<div id="id_renvoie_impot" style="position:absolute;top:180px;left:392px;background-color:#ccc;width:300px;height:200px;display:none">
				<form method = "post" enctype="multipart/form-data" action = "RA/impot/importimpot.php?mission_id=<?php echo $mission_id;?>&importid=<?php echo $numerodecomptefin6[$i]; ?>">
					<input type = "file" accept="application/vnd.ms-excel" id = "file_Import_impot" name = "file_Import_impot"/>
					<input type="submit" name="Importerimpot" value="Upload" id = "id_Importerimpot"/>
					<?php
						$reponse2=$bdd->query('select RENVOIE_LIEN from tab_renvoie where MISSION_ID='.$mission_id.' AND RENVOIE_OBJECTIF="impot" AND IMPORT_ID='.$numerodecomptefin6[$i]);					
						$renvoielien='';
						while($donnees2=$reponse2->fetch()){
							$renvoielien=$donnees2['RENVOIE_LIEN'];
						}
...
<div id="centre_impot" align="center">
		...
		<div id="dv_conclusion_impot" data-options="handle:'#dragg_c'" align="center" style="display:none;position:absolute;top:150px;left:350px;width:500px;height:395px;background-color:#05abe1;border:5px solid #ccc;">
			...
			<table width="500" bgcolor="#00698d">
					<td class="td_Titre_Question" align="center"><textarea id="txt_conclusion_impot" cols="40" rows="20" <?php// if($conclusionimpotvente!=0) echo 'disabled'; ?>></textarea>
					</td>
				</tr>
				<tr>
					<td align="center">
						<input type="button" id="bt_valider_conclusion_impot" value="Valider" class="bouton" onclick="conclusion_impottaxe();"  <?php// if($conclusionimpot!=0) echo 'disabled'; ?>>&nbsp;&nbsp;&nbsp;
