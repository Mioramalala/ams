 <?php
		...
		// $reponse=$bdd->query('select BALANCE_GENERAL_CYCLE,BALANCE_GENERAL_COMPTE_CONCERNE, 	BALANCE_GENERAL_COMPTE_CONCERNE2
		// from tab_balance_general 
		// where BALANCE_GENERAL_PCG =2') or die (mysql_error());
		
		// $donnees=$reponse->fetch();
		
		// $bal_gen1=$donnees['BALANCE_GENERAL_COMPTE_CONCERNE'];
		// $bal_gen2=$donnees['BALANCE_GENERAL_COMPTE_CONCERNE2'];
		
		// echo "azertyuio".$bal_gen1;
		// echo "poiuytreza".$bal_gen2;
		//	echo 'import'.$tableCpt1[$i];
		////////////////////////////////////////////////A/////////////////////////////////////////////////////////////
