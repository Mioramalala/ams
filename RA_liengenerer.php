...
//$pseudo_art = $repertoire[2]; 
	//exit();

//$idMission=$_GET['idMission'];
//$_SESSION['idMission']=$idMission;
//$REVUERA_=@$_GET["REVUERA_"];
...
<html>
	<head>
        ...
        <script text="javascript" src="js/jsRA_liengenerer.js"></script>
	...
	<input type="hidden" value="<?php print($REVUERA_); ?>" id="REVUERA_">
    ...
    <input type="hidden"  value="<?php print($choixlien); ?>" id="choixlien">
